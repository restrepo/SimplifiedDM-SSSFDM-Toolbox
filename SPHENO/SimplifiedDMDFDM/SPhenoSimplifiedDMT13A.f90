...
Program SPhenoSimplifiedDMT13A 
 
Use Control
Use InputOutput_SimplifiedDMT13A
Use LoopFunctions
Use RunSM_SimplifiedDMT13A
Use LowEnergy_SimplifiedDMT13A
Use FlavorKit_LFV_SimplifiedDMT13A
Use FlavorKit_QFV_SimplifiedDMT13A
Use FlavorKit_Observables_SimplifiedDMT13A
Use Mathematics
Use Model_Data_SimplifiedDMT13A
Use Tadpoles_SimplifiedDMT13A 
 Use HiggsCS_SimplifiedDMT13A
Use LoopMasses_SimplifiedDMT13A
 
Use BranchingRatios_SimplifiedDMT13A
...
& v,g1,g2,g3,Lam,Yu,Yd,Ye,MDF,mu2,kont)
...
Call CalculateLowEnergyConstraints(g1,g2,g3,Lam,Yu,Yd,Ye,MDF,mu2,v,ae,amu,            & 
...
& Yuinput,Ydinput,Yeinput,MDFinput,mu2input,vinput,ae,amu,atau,EDMe,EDMmu,               & 
...
Complex(dp),Intent(inout) :: Laminput,Yuinput(3,3),Ydinput(3,3),Yeinput(3,3),MDFinput,mu2input
...
& Ydinput,Yeinput,MDFinput,mu2input,vinput,g1,g2,g3,Lam,Yu,Yd,Ye,MDF,mu2,v,              & 
& CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
& Yeinput,MDFinput,mu2input,vinput,g1,g2,g3,Lam,Yu,Yd,Ye,MDF,mu2,v,CKM_MZ,               & 
...
End Program SPhenoSimplifiedDMT13A 
