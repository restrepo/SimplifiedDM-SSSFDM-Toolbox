...
& mudr2,MU12,mul2,mur2,v1,v2,vtl,vtr,vhl,vhr,gTAh,gThh,gTHppmm,gTVZ,gTVZR,               & 
& gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFeFvFv,epsI,deltaM,CheckRealStates,gT,             & 
& gPartial,BR)
...
Real(dp),Intent(inout) :: gFeFecFdFd(3,3,6,6),gFeFecFeFe(3,3,3,3),gFeFecFuFu(3,3,3,3),gFeFeFvFv(3,3,6,6)

Real(dp),Intent(in) :: gTAh(6),gThh(6),gTHppmm(2),gTVZ,gTVZR

Real(dp) :: gFeFecFdFdi(3,6,6),gFeFecFeFei(3,3,3),gFeFecFuFui(3,3,3),gFeFeFvFvi(3,6,6)

Real(dp) :: gTAhtemp(6),gThhtemp(6),gTHppmmtemp(2),gTVZtemp,gTVZRtemp
...
& cplcFuFuVZRR,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,           & 
...
Real(dp),Intent(in) :: MFe(3),MFd(6),MVZ,MVZR,MAh(6),Mhh(6)
...
Real(dp),Intent(in) :: MFe(3),MVZ,MVZR,MHppmm(2),MAh(6),Mhh(6)

Complex(dp),Intent(in) :: cplcFecFeHppmmL(3,3,2),cplcFecFeHppmmR(3,3,2),cplcFeFeAhL(3,3,6),cplcFeFeAhR(3,3,6),  & 
...
Real(dp),Intent(inout) :: gTVZ,gTVZR,gTHppmm(2),gTAh(6),gThh(6)
...
Real(dp),Intent(in) :: MFe(3),MFu(3),MVZ,MVZR,MAh(6),Mhh(6)
...
Real(dp),Intent(in) :: MFe(3),MFv(6),MVZ,MVZR,MAh(6),Mhh(6)

Complex(dp),Intent(in) :: cplcFeFeAhL(3,3,6),cplcFeFeAhR(3,3,6),cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),          & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),cplFvFvAhL(6,6,6),& 
