...
& ratVWLm,ratVWRm,MFd,MFe,MFu,MHpm,MVWLm,MVWRm,MHppmm,gNLO,coup)

Implicit None 
Complex(dp),Intent(in) :: ratFd(6),ratFe(3),ratFu(3),ratHpm(6),ratHppmm(2),ratVWLm,ratVWRm

Real(dp),Intent(in) :: MFd(6),MFe(3),MFu(3),MHpm(6),MVWLm,MVWRm,MHppmm(2)
...
Implicit None 
Complex(dp),Intent(in) :: ratFd(6),ratFu(3)

Real(dp),Intent(in) :: MFd(6),MFu(3)
...
Subroutine CoupHiggsToPhotonSM(mHiggs,MFd,MFe,MFu,MHpm,MVWLm,MVWRm,MHppmm,            & 
& gNLO,coup)
...
& ratHppmm,ratVWLm,ratVWRm,MFd,MFe,MFu,MHpm,MVWLm,MVWRm,MHppmm,gNLO,coup)
...
End Module LoopCouplings_darkLR 
