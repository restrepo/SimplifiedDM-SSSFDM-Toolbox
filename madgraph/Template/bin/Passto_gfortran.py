...
def rm_old_compile_file():
    ...
    os.system('rm -f *.o;rm -f */*.o;rm -f */*/*.o;rm -f */*/*/*.o;')
    os.system('cd lib;rm -f libblocks.a  libgeneric_mw.a  libMWPS.a  libtools.a libdhelas3.a libdsample.a libgeneric.a libmodel.a libpdf.a libdhelas3.so libTF.a libdsample.so libgeneric.so libmodel.so libpdf.so >&/dev/null')
