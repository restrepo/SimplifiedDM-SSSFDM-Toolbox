...
Complex(dp), Private :: UP_1L(6,6)  
Real(dp), Private :: MHpm_1L(6), MHpm2_1L(6)  
Complex(dp), Private :: UC_1L(6,6)  
...
& xiLR,xiR,mudl2,mudr2,MU12,mul2,mur2,kont)

Implicit None 
Real(dp),Intent(inout) :: gBL,g2,gR,g3,alp,RHO2,RHO1,ALP3,ALP1,LAM1,BETA2,LAM3,xiLR,xiR,MU12
...
Real(dp),Intent(inout) :: v1,v2,vhl,vtl,vhr,vtr

Complex(dp) :: cplAhAhcVWLmVWLm(6,6),cplAhAhcVWRmVWRm(6,6),cplAhAhUhh(6,6,6),cplAhAhUhhUhh(6,6,6,6), & 
& cplAhAhUHpmcUHpm(6,6,6,6),cplAhAhUHppmmcUHppmm(6,6,2,2),cplAhAhVZRVZR(6,6),            & 
& cplAhAhVZVZ(6,6),cplAhcUHpmVWLm(6,6),cplAhcUHpmVWRm(6,6),cplAhcVWLmVWRm(6),            & 
& cplAhcVWRmVWLm(6),cplAhhhVZ(6,6),cplAhhhVZR(6,6),cplAhHpmcUHpm(6,6,6),cplAhHpmcVWLm(6,6),& 
& cplAhHpmcVWRm(6,6),cplAhHppmmcUHppmm(6,2,2),cplAhUhhVP(6,6),cplAhUhhVZ(6,6),           & 
& cplAhUhhVZR(6,6),cplcFdFdUAhL(6,6,6),cplcFdFdUAhR(6,6,6),cplcFdFdUhhL(6,6,6),          & 
& cplcFdFdUhhR(6,6,6),cplcFdFdVZL(6,6),cplcFdFdVZR(6,6),cplcFdFdVZRL(6,6),               & 
& cplcFdFdVZRR(6,6),cplcFeFeUAhL(3,3,6),cplcFeFeUAhR(3,3,6),cplcFeFeUhhL(3,3,6),         & 
& cplcFeFeUhhR(3,3,6),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFeVZRL(3,3),               & 
& cplcFeFeVZRR(3,3),cplcFuFdcUHpmL(3,6,6),cplcFuFdcUHpmR(3,6,6),cplcFuFdcVWLmL(3,6),     & 
& cplcFuFdcVWLmR(3,6),cplcFuFdcVWRmL(3,6),cplcFuFdcVWRmR(3,6),cplcFuFuUAhL(3,3,6),       & 
& cplcFuFuUAhR(3,3,6),cplcFuFuUhhL(3,3,6),cplcFuFuUhhR(3,3,6),cplcFuFuVZL(3,3),          & 
& cplcFuFuVZR(3,3),cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3),cplcgPgWLmcVWLm,cplcgPgWLmcVWRm,  & 
& cplcgPgWRmcVWLm,cplcgPgWRmcVWRm,cplcgWLmgWLmUAh(6),cplcgWLmgWLmUhh(6),cplcgWLmgWLmVZ,  & 
& cplcgWLmgWLmVZR,cplcgWLmgWLpUHppmm(2),cplcgWLmgWRmUAh(6),cplcgWLmgWRmUhh(6),           & 
& cplcgWLmgWRpUHppmm(2),cplcgWLmgZpUHpm(6),cplcgWLmgZUHpm(6),cplcgWLpgPcVWLm,            & 
& cplcgWLpgPcVWRm,cplcgWLpgWLmcUHppmm(2),cplcgWLpgWLpUAh(6),cplcgWLpgWLpUhh(6),          & 
& cplcgWLpgWLpVZ,cplcgWLpgWLpVZR,cplcgWLpgWRmcUHppmm(2),cplcgWLpgWRpUAh(6),              & 
& cplcgWLpgWRpUhh(6),cplcgWLpgZcUHpm(6),cplcgWLpgZcVWLm,cplcgWLpgZcVWRm,cplcgWLpgZpcUHpm(6),& 
& cplcgWLpgZpcVWLm,cplcgWLpgZpcVWRm,cplcgWRmgWLmUAh(6),cplcgWRmgWLmUhh(6),               & 
& cplcgWRmgWLmVZ,cplcgWRmgWLmVZR,cplcgWRmgWLpUHppmm(2),cplcgWRmgWRmUAh(6),               & 
& cplcgWRmgWRmUhh(6),cplcgWRmgWRmVZ,cplcgWRmgWRmVZR,cplcgWRmgWRpUHppmm(2),               & 
& cplcgWRmgZpUHpm(6),cplcgWRmgZUHpm(6),cplcgWRpgPcVWLm,cplcgWRpgPcVWRm,cplcgWRpgWLmcUHppmm(2),& 
& cplcgWRpgWLpUAh(6),cplcgWRpgWLpUhh(6),cplcgWRpgWLpVZ,cplcgWRpgWLpVZR,cplcgWRpgWRmcUHppmm(2),& 
& cplcgWRpgWRpUAh(6),cplcgWRpgWRpUhh(6),cplcgWRpgWRpVZ,cplcgWRpgWRpVZR,cplcgWRpgZcUHpm(6),& 
& cplcgWRpgZcVWLm,cplcgWRpgZcVWRm,cplcgWRpgZpcUHpm(6),cplcgWRpgZpcVWLm,cplcgWRpgZpcVWRm, & 
& cplcgZgWLmcUHpm(6),cplcgZgWLmcVWLm,cplcgZgWLmcVWRm,cplcgZgWLpUHpm(6),cplcgZgWRmcUHpm(6),& 
& cplcgZgWRmcVWLm,cplcgZgWRmcVWRm,cplcgZgWRpUHpm(6),cplcgZgZpUhh(6),cplcgZgZUhh(6),      & 
& cplcgZpgWLmcUHpm(6),cplcgZpgWLmcVWLm,cplcgZpgWLmcVWRm,cplcgZpgWLpUHpm(6),              & 
& cplcgZpgWRmcUHpm(6),cplcgZpgWRmcVWLm,cplcgZpgWRmcVWRm,cplcgZpgWRpUHpm(6),              & 
& cplcgZpgZpUhh(6),cplcgZpgZUhh(6),cplcUFdFdAhL(6,6,6),cplcUFdFdAhR(6,6,6),              & 
& cplcUFdFdhhL(6,6,6),cplcUFdFdhhR(6,6,6),cplcUFdFdVGL(6,6),cplcUFdFdVGR(6,6),           & 
& cplcUFdFdVPL(6,6),cplcUFdFdVPR(6,6),cplcUFdFdVZL(6,6),cplcUFdFdVZR(6,6),               & 
& cplcUFdFdVZRL(6,6),cplcUFdFdVZRR(6,6),cplcUFdFuHpmL(6,3,6),cplcUFdFuHpmR(6,3,6),       & 
& cplcUFdFuVWLmL(6,3),cplcUFdFuVWLmR(6,3),cplcUFdFuVWRmL(6,3),cplcUFdFuVWRmR(6,3),       & 
& cplcUFecFeHppmmL(3,3,2),cplcUFecFeHppmmR(3,3,2),cplcUFeFeAhL(3,3,6),cplcUFeFeAhR(3,3,6),& 
...
& cplcUFuFdcHpmL(3,6,6),cplcUFuFdcHpmR(3,6,6),cplcUFuFdcVWLmL(3,6),cplcUFuFdcVWLmR(3,6), & 
& cplcUFuFdcVWRmL(3,6),cplcUFuFdcVWRmR(3,6),cplcUFuFuAhL(3,3,6),cplcUFuFuAhR(3,3,6),     & 
...
& cplcUFuFuVZRL(3,3),cplcUFuFuVZRR(3,3),cplcUHpmVPVWLm(6),cplcUHpmVPVWRm(6),             & 
& cplcUHpmVWLmVZ(6),cplcUHpmVWLmVZR(6),cplcUHpmVWRmVZ(6),cplcUHpmVWRmVZR(6),             & 
...
& cplFeFecUHppmmR(3,3,2),cplFvFvUAhL(6,6,6),cplFvFvUAhR(6,6,6),cplFvFvUhhL(6,6,6),       & 
& cplFvFvUhhR(6,6,6),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplFvFvVZRL(6,6),cplFvFvVZRR(6,6),  & 
& cplhhcUHpmVWLm(6,6),cplhhcUHpmVWRm(6,6),cplhhcVWLmVWLm(6),cplhhcVWLmVWRm(6),           & 
& cplhhcVWRmVWLm(6),cplhhcVWRmVWRm(6),cplhhhhcVWLmVWLm(6,6),cplhhhhcVWRmVWRm(6,6),       & 
& cplhhhhUHpmcUHpm(6,6,6,6),cplhhhhUHppmmcUHppmm(6,6,2,2),cplhhhhVZRVZR(6,6),            & 
& cplhhhhVZVZ(6,6),cplhhHpmcUHpm(6,6,6),cplhhHpmcVWLm(6,6),cplhhHpmcVWRm(6,6),           & 
& cplhhHppmmcUHppmm(6,2,2),cplhhVPVZ(6),cplhhVPVZR(6),cplhhVZRVZR(6),cplhhVZVZ(6),       & 
& cplhhVZVZR(6),cplHpmcHpmcVWLmVWLm(6,6),cplHpmcHpmcVWRmVWRm(6,6),cplHpmcHpmVZ(6,6),     & 
& cplHpmcHpmVZR(6,6),cplHpmcHpmVZRVZR(6,6),cplHpmcHpmVZVZ(6,6),cplHpmcUHpmVP(6,6),       & 
& cplHpmcUHpmVZ(6,6),cplHpmcUHpmVZR(6,6),cplHpmcUHppmmVWLm(6,2),cplHpmcUHppmmVWRm(6,2),  & 
& cplHpmcVWLmVP(6),cplHpmcVWLmVZ(6),cplHpmcVWLmVZR(6),cplHpmcVWRmVP(6),cplHpmcVWRmVZ(6), & 
& cplHpmcVWRmVZR(6),cplHpmHpmcUHppmm(6,6,2),cplHpmUHppmmcHpmcUHppmm(6,2,6,2),            & 
& cplHppmmcHpmcVWLm(2,6),cplHppmmcHpmcVWRm(2,6),cplHppmmcHppmmcVWLmVWLm(2,2),            & 
& cplHppmmcHppmmcVWRmVWRm(2,2),cplHppmmcHppmmVZ(2,2),cplHppmmcHppmmVZR(2,2),             & 
& cplHppmmcHppmmVZRVZR(2,2),cplHppmmcHppmmVZVZ(2,2),cplHppmmcUHpmcHpm(2,6,6),            & 
& cplHppmmcUHpmcVWLm(2,6),cplHppmmcUHpmcVWRm(2,6),cplHppmmcUHppmmVP(2,2),cplHppmmcUHppmmVZ(2,2),& 
& cplHppmmcUHppmmVZR(2,2),cplHppmmcVWLmcVWLm(2),cplHppmmcVWLmcVWRm(2),cplHppmmcVWRmcVWRm(2),& 
& cplUAhAhhh(6,6,6),cplUAhcVWRmVWLm(6),cplUAhhhVP(6,6),cplUAhhhVZ(6,6),cplUAhhhVZR(6,6), & 
& cplUAhHpmcHpm(6,6,6),cplUAhHpmcVWLm(6,6),cplUAhHpmcVWRm(6,6),cplUAhHppmmcHppmm(6,2,2), & 
& cplUAhUAhAhAh(6,6,6,6),cplUAhUAhcVWLmVWLm(6,6),cplUAhUAhcVWRmVWRm(6,6),cplUAhUAhhhhh(6,6,6,6)

Complex(dp) :: cplUAhUAhHpmcHpm(6,6,6,6),cplUAhUAhHppmmcHppmm(6,6,2,2),cplUAhUAhVPVP(6,6),            & 
& cplUAhUAhVZRVZR(6,6),cplUAhUAhVZVZ(6,6),cplUFvFvAhL(6,6,6),cplUFvFvAhR(6,6,6),         & 
& cplUFvFvhhL(6,6,6),cplUFvFvhhR(6,6,6),cplUFvFvVPL(6,6),cplUFvFvVPR(6,6),               & 
& cplUFvFvVZL(6,6),cplUFvFvVZR(6,6),cplUFvFvVZRL(6,6),cplUFvFvVZRR(6,6),cplUhhcVWLmVWLm(6),& 
& cplUhhcVWRmVWLm(6),cplUhhcVWRmVWRm(6),cplUhhhhhh(6,6,6),cplUhhHpmcHpm(6,6,6),          & 
& cplUhhHpmcVWLm(6,6),cplUhhHpmcVWRm(6,6),cplUhhHppmmcHppmm(6,2,2),cplUhhUhhcVWLmVWLm(6,6),& 
& cplUhhUhhcVWRmVWRm(6,6),cplUhhUhhhhhh(6,6,6,6),cplUhhUhhHpmcHpm(6,6,6,6),              & 
& cplUhhUhhHppmmcHppmm(6,6,2,2),cplUhhUhhVPVP(6,6),cplUhhUhhVZRVZR(6,6),cplUhhUhhVZVZ(6,6),& 
& cplUhhVPVZ(6),cplUhhVPVZR(6),cplUhhVZRVZR(6),cplUhhVZVZ(6),cplUhhVZVZR(6),             & 
& cplUHpmcUHpmcVWLmVWLm(6,6),cplUHpmcUHpmcVWRmVWRm(6,6),cplUHpmcUHpmVPVP(6,6),           & 
& cplUHpmcUHpmVZRVZR(6,6),cplUHpmcUHpmVZVZ(6,6),cplUHpmHpmcUHpmcHpm(6,6,6,6),            & 
& cplUHpmHppmmcUHpmcHppmm(6,2,6,2),cplUHppmmcUHppmmcVWLmVWLm(2,2),cplUHppmmcUHppmmcVWRmVWRm(2,2),& 
...
& UV,TW,UC,UCC,ZDR,ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,v1,v2,vhl,vtl,vhr,vtr,gBL,            & 
...
& mudr2,MU12,mul2,mur2,GenerationMixing,kont)
...
Call CouplingsForVectorBosons(gBL,g2,gR,ZZ,ZH,UP,ZDL,ZDR,UV,PhiW,v1,v2,               & 
& vtl,vtr,vhl,vhr,UC,UCC,ZUL,ZUR,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,          & 
...
& cplHpmcVWLmVP,cplHppmmcHpmcVWLm,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,cplcVWLmVPVWLm,  & 
& cplcVWLmVPVWRm,cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplAhAhcVWLmVWLm,cplhhhhcVWLmVWLm,       & 
& cplHpmcHpmcVWLmVWLm,cplHppmmcHppmmcVWLmVWLm,cplcVWLmVPVPVWLm1,cplcVWLmVPVPVWLm2,       & 
...
Call SolveTadpoleEquations(gBL,g2,gR,g3,alp,RHO2,RHO1,rh3,ALP3,ALP1,LAM1,             & 
...
& vhr,(/ ZeroC, ZeroC, ZeroC, ZeroC, ZeroC, ZeroC /))
...
Call CouplingsForLoopMasses(xiLR,xiR,alp,RHO1,rh3,ALP3,ALP1,LAM1,etall,               & 
& etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,betr,BETA2,LAM3,v1,v2,vtl,vtr,             & 
& vhl,vhr,UP,gBL,g2,gR,ZZ,YQ2,yq3,YQ1,ZDL,ZDR,YL1,ZEL,ZER,ZUL,ZUR,YDR,YDL,               & 
& UV,PhiW,ZH,err1,UC,RHO2,UCC,g3,cplAhAhUhh,cplAhUhhVP,cplAhUhhVZ,cplAhUhhVZR,           & 
...
& cplUhhHpmcVWLm,cplUhhHpmcVWRm,cplUhhHppmmcHppmm,cplUhhVPVZ,cplUhhVPVZR,cplUhhcVWLmVWLm,& 
...
& cplUhhUhhcVWRmVWRm,cplUhhUhhVZVZ,cplUhhUhhVZRVZR,cplUAhAhhh,cplcFdFdUAhL,              & 
...
& cplcgWRpgWLpUAh,cplcgWLpgWRpUAh,cplcgWRmgWRmUAh,cplcgWRpgWRpUAh,cplUAhhhVP,            & 
& cplUAhhhVZ,cplUAhhhVZR,cplUAhHpmcHpm,cplUAhHpmcVWLm,cplUAhHpmcVWRm,cplUAhHppmmcHppmm,  & 
& cplUAhcVWRmVWLm,cplUAhUAhAhAh,cplUAhUAhhhhh,cplUAhUAhHpmcHpm,cplUAhUAhHppmmcHppmm,     & 
...
& cplHpmcUHpmVZ,cplHpmcUHpmVZR,cplHppmmcUHpmcHpm,cplHppmmcUHpmcVWLm,cplHppmmcUHpmcVWRm,  & 
& cplcUHpmVPVWLm,cplcUHpmVPVWRm,cplcUHpmVWLmVZ,cplcUHpmVWLmVZR,cplcUHpmVWRmVZ,           & 
& cplcUHpmVWRmVZR,cplAhAhUHpmcUHpm,cplhhhhUHpmcUHpm,cplUHpmHpmcUHpmcHpm,cplUHpmHppmmcUHpmcHppmm,& 
...
Call OneLoopTadpoleshh(v1,v2,vhl,vhr,vtl,vtr,MAh,MAh2,MFd,MFd2,MFe,MFe2,              & 
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,               & 
& MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplAhAhUhh,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,          & 
& cplcFeFeUhhR,cplcFuFuUhhL,cplcFuFuUhhR,cplFvFvUhhL,cplFvFvUhhR,cplcgWLmgWLmUhh,        & 
& cplcgWLpgWLpUhh,cplcgWRmgWRmUhh,cplcgWRpgWRpUhh,cplcgZgZUhh,cplcgZpgZpUhh,             & 
& cplUhhhhhh,cplUhhHpmcHpm,cplUhhHppmmcHppmm,cplUhhcVWLmVWLm,cplUhhcVWRmVWRm,            & 
& cplUhhVZVZ,cplUhhVZRVZR,Tad1Loop(1:6))
...
mul21L = mul2
mur21L = mur2
Call OneLoophh(xiLR,xiR,alp,mudl22L,mudr22L,MU122L,mul22L,mur22L,RHO1,rh3,            & 
& ALP3,ALP1,LAM1,etall,etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,betr,BETA2,           & 
& LAM32L,v1,v2,vtl,vtr,vhl,vhr,MAh,MAh2,MVZ,MVZ2,MVZR,MVZR2,MFd,MFd2,MFe,MFe2,           & 
...
Call OneLoopAh(gBL,g2,gR,xiLR,xiR,alp,mudl21L,mudr21L,MU121L,mul21L,mur21L,           & 
& RHO1,rh3,ALP3,ALP1,LAM1,etall,etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,             & 
& betr,BETA2,LAM31L,v1,v2,vtl,vtr,vhl,vhr,ZZ,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,             & 
& MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,              & 
& MVWRm2,MHppmm,MHppmm2,cplUAhAhhh,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,               & 
...
& cplUAhUAhcVWRmVWRm,cplUAhUAhVZVZ,cplUAhUAhVZRVZR,0.1_dp*delta_mass,MAh_1L,             & 
& MAh2_1L,UP_1L,kont)

Call OneLoopHpm(g2,gR,xiLR,xiR,alp,mudl21L,mudr21L,MU121L,mul21L,mur21L,              & 
& RHO1,rh3,ALP3,ALP1,LAM1,etall,etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,             & 
& betr,err1,BETA2,LAM31L,v1,v2,vtl,vtr,vhl,vhr,PhiW,MHpm,MHpm2,MAh,MAh2,MVWLm,           & 
& MVWLm2,MVWRm,MVWRm2,MFu,MFu2,MFd,MFd2,Mhh,Mhh2,MVZ,MVZ2,MVZR,MVZR2,MHppmm,             & 
...
Call OneLoopHppmm(mudl21L,mudr21L,RHO2,RHO1,rh3,ALP3,ALP1,etall,etalr,etarl,          & 
& etarr,err1,BETA2,v1,v2,vtl,vtr,vhl,vhr,MHppmm,MHppmm2,MAh,MAh2,MFe,MFe2,               & 
& Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplAhHppmmcUHppmm,   & 
& cplFeFecUHppmmL,cplFeFecUHppmmR,cplcgWLpgWLmcUHppmm,cplcgWLmgWLpUHppmm,cplcgWRpgWLmcUHppmm,& 
...
Call OneLoopFd(YQ2,yq3,YQ1,v1,vhl,vhr,MFd,MFd2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,            & 
...
& cplcUFdFuVWLmL,cplcUFdFuVWLmR,cplcUFdFuVWRmL,cplcUFdFuVWRmR,0.1_dp*delta_mass,         & 
...
Subroutine OneLoopTadpoleshh(v1,v2,vhl,vhr,vtl,vtr,MAh,MAh2,MFd,MFd2,MFe,             & 
...
Complex(dp), Intent(in) :: cplAhAhUhh(6,6,6),cplcFdFdUhhL(6,6,6),cplcFdFdUhhR(6,6,6),cplcFeFeUhhL(3,3,6),        & 
& cplcFeFeUhhR(3,3,6),cplcFuFuUhhL(3,3,6),cplcFuFuUhhR(3,3,6),cplFvFvUhhL(6,6,6),        & 
& cplFvFvUhhR(6,6,6),cplcgWLmgWLmUhh(6),cplcgWLpgWLpUhh(6),cplcgWRmgWRmUhh(6),           & 
& cplcgWRpgWRpUhh(6),cplcgZgZUhh(6),cplcgZpgZpUhh(6),cplUhhhhhh(6,6,6),cplUhhHpmcHpm(6,6,6),& 
& cplUhhHppmmcHppmm(6,2,2),cplUhhcVWLmVWLm(6),cplUhhcVWRmVWRm(6),cplUhhVZVZ(6),          & 
& cplUhhVZRVZR(6)

Real(dp), Intent(in) :: v1,v2,vhl,vhr,vtl,vtr
...
Subroutine OneLoophh(xiLR,xiR,alp,mudl2,mudr2,MU12,mul2,mur2,RHO1,rh3,ALP3,           & 
& ALP1,LAM1,etall,etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,betr,BETA2,LAM3,           & 
& v1,v2,vtl,vtr,vhl,vhr,MAh,MAh2,MVZ,MVZ2,MVZR,MVZR2,MFd,MFd2,MFe,MFe2,MFu,              & 
& MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MHppmm,MHppmm2,            & 
& cplAhAhUhh,cplAhUhhVP,cplAhUhhVZ,cplAhUhhVZR,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,   & 
& cplcFeFeUhhR,cplcFuFuUhhL,cplcFuFuUhhR,cplFvFvUhhL,cplFvFvUhhR,cplcgWLmgWLmUhh,        & 
& cplcgWRmgWLmUhh,cplcgWLmgWRmUhh,cplcgWLpgWLpUhh,cplcgWRpgWLpUhh,cplcgWLpgWRpUhh,       & 
& cplcgWRmgWRmUhh,cplcgWRpgWRpUhh,cplcgZgZUhh,cplcgZpgZUhh,cplcgZgZpUhh,cplcgZpgZpUhh,   & 
...
Implicit None 
Real(dp), Intent(in) :: MAh(6),MAh2(6),MVZ,MVZ2,MVZR,MVZR2,MFd(6),MFd2(6),MFe(3),MFe2(3),MFu(3),              & 
& MFu2(3),MFv(6),MFv2(6),Mhh(6),Mhh2(6),MHpm(6),MHpm2(6),MVWLm,MVWLm2,MVWRm,             & 
...
Complex(dp), Intent(in) :: cplAhAhUhh(6,6,6),cplAhUhhVP(6,6),cplAhUhhVZ(6,6),cplAhUhhVZR(6,6),cplcFdFdUhhL(6,6,6),& 
& cplcFdFdUhhR(6,6,6),cplcFeFeUhhL(3,3,6),cplcFeFeUhhR(3,3,6),cplcFuFuUhhL(3,3,6),       & 
& cplcFuFuUhhR(3,3,6),cplFvFvUhhL(6,6,6),cplFvFvUhhR(6,6,6),cplcgWLmgWLmUhh(6),          & 
& cplcgWRmgWLmUhh(6),cplcgWLmgWRmUhh(6),cplcgWLpgWLpUhh(6),cplcgWRpgWLpUhh(6),           & 
& cplcgWLpgWRpUhh(6),cplcgWRmgWRmUhh(6),cplcgWRpgWRpUhh(6),cplcgZgZUhh(6),               & 
& cplcgZpgZUhh(6),cplcgZgZpUhh(6),cplcgZpgZpUhh(6),cplUhhhhhh(6,6,6),cplUhhHpmcHpm(6,6,6),& 
& cplUhhHpmcVWLm(6,6),cplUhhHpmcVWRm(6,6),cplUhhHppmmcHppmm(6,2,2),cplUhhVPVZ(6),        & 
& cplUhhVPVZR(6),cplUhhcVWLmVWLm(6),cplUhhcVWRmVWLm(6),cplUhhcVWRmVWRm(6),               & 
& cplUhhVZVZ(6),cplUhhVZVZR(6),cplUhhVZRVZR(6),cplAhAhUhhUhh(6,6,6,6),cplUhhUhhhhhh(6,6,6,6),& 
& cplUhhUhhHpmcHpm(6,6,6,6),cplUhhUhhHppmmcHppmm(6,6,2,2),cplUhhUhhVPVP(6,6),            & 
& cplUhhUhhcVWLmVWLm(6,6),cplUhhUhhcVWRmVWRm(6,6),cplUhhUhhVZVZ(6,6),cplUhhUhhVZRVZR(6,6)
...
mat2a(1,1) = mat2a(1,1)+(betl*vhl**2)/2._dp
mat2a(1,1) = mat2a(1,1)+(betr*vhr**2)/2._dp
...
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)+betl*v1*vhl
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)+ALP1*v1*vtl
mat2a(1,4) = mat2a(1,4)-(BETA2*v1*vtr)
mat2a(1,5) = 0._dp 
mat2a(1,5) = mat2a(1,5)+betr*v1*vhr
mat2a(1,6) = 0._dp 
mat2a(1,6) = mat2a(1,6)-(BETA2*v1*vtl)
mat2a(1,6) = mat2a(1,6)+ALP1*v1*vtr
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)+MU12
mat2a(2,2) = mat2a(2,2)+LAM1*v1**2
mat2a(2,2) = mat2a(2,2)+2*LAM3*v1**2
mat2a(2,2) = mat2a(2,2)+3*LAM1*v2**2
mat2a(2,2) = mat2a(2,2)+(betl*vhl**2)/2._dp
mat2a(2,2) = mat2a(2,2)+(betr*vhr**2)/2._dp
...
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)+betl*v2*vhl
mat2a(2,3) = mat2a(2,3)-(alp*vhr*vtr)/2._dp
mat2a(2,3) = mat2a(2,3)+(vhr*xiLR)/sqrt(2._dp)
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)+ALP1*v2*vtl
mat2a(2,4) = mat2a(2,4)+ALP3*v2*vtl
mat2a(2,5) = 0._dp 
mat2a(2,5) = mat2a(2,5)+betr*v2*vhr
mat2a(2,5) = mat2a(2,5)-(alp*vhl*vtr)/2._dp
mat2a(2,5) = mat2a(2,5)+(vhl*xiLR)/sqrt(2._dp)
mat2a(2,6) = 0._dp 
mat2a(2,6) = mat2a(2,6)-(alp*vhl*vhr)/2._dp
mat2a(2,6) = mat2a(2,6)+ALP1*v2*vtr
mat2a(2,6) = mat2a(2,6)+ALP3*v2*vtr
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+mul2
mat2a(3,3) = mat2a(3,3)+(betl*v1**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(betl*v2**2)/2._dp
mat2a(3,3) = mat2a(3,3)+3*laml*vhl**2
mat2a(3,3) = mat2a(3,3)+(lamlr*vhr**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(etall*vtl**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(etalr*vtr**2)/2._dp
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)+etall*vhl*vtl
mat2a(3,5) = 0._dp 
mat2a(3,5) = mat2a(3,5)+lamlr*vhl*vhr
mat2a(3,5) = mat2a(3,5)-(alp*v2*vtr)/2._dp
mat2a(3,5) = mat2a(3,5)+(v2*xiLR)/sqrt(2._dp)
mat2a(3,6) = 0._dp 
mat2a(3,6) = mat2a(3,6)-(alp*v2*vhr)/2._dp
mat2a(3,6) = mat2a(3,6)+etalr*vhl*vtr
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)+mudl2
mat2a(4,4) = mat2a(4,4)+(ALP1*v1**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(ALP1*v2**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(ALP3*v2**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(etall*vhl**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(etarl*vhr**2)/2._dp
mat2a(4,4) = mat2a(4,4)+3*RHO1*vtl**2
mat2a(4,4) = mat2a(4,4)+(rh3*vtr**2)/2._dp
mat2a(4,5) = 0._dp 
mat2a(4,5) = mat2a(4,5)+etarl*vhr*vtl
mat2a(4,6) = 0._dp 
mat2a(4,6) = mat2a(4,6)-(BETA2*v1**2)/2._dp
mat2a(4,6) = mat2a(4,6)+rh3*vtl*vtr
mat2a(5,5) = 0._dp 
mat2a(5,5) = mat2a(5,5)+mur2
mat2a(5,5) = mat2a(5,5)+(betr*v1**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(betr*v2**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(lamlr*vhl**2)/2._dp
mat2a(5,5) = mat2a(5,5)+3*lamr*vhr**2
mat2a(5,5) = mat2a(5,5)+(etarl*vtl**2)/2._dp
mat2a(5,5) = mat2a(5,5)-(err2*vtr**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(etarr*vtr**2)/2._dp
mat2a(5,5) = mat2a(5,5)-(sqrt(2._dp)*vtr*xiR)
mat2a(5,6) = 0._dp 
mat2a(5,6) = mat2a(5,6)-(alp*v2*vhl)/2._dp
mat2a(5,6) = mat2a(5,6)-(err2*vhr*vtr)
mat2a(5,6) = mat2a(5,6)+etarr*vhr*vtr
mat2a(5,6) = mat2a(5,6)-(sqrt(2._dp)*vhr*xiR)
mat2a(6,6) = 0._dp 
mat2a(6,6) = mat2a(6,6)+mudr2
mat2a(6,6) = mat2a(6,6)+(ALP1*v1**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(ALP1*v2**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(ALP3*v2**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(etalr*vhl**2)/2._dp
mat2a(6,6) = mat2a(6,6)-(err2*vhr**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(etarr*vhr**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(rh3*vtl**2)/2._dp
mat2a(6,6) = mat2a(6,6)+3*RHO1*vtr**2
...
Subroutine OneLoopAh(gBL,g2,gR,xiLR,xiR,alp,mudl2,mudr2,MU12,mul2,mur2,               & 
& RHO1,rh3,ALP3,ALP1,LAM1,etall,etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,             & 
& betr,BETA2,LAM3,v1,v2,vtl,vtr,vhl,vhr,ZZ,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,               & 
& MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,              & 
& MVWRm2,MHppmm,MHppmm2,cplUAhAhhh,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,               & 
& cplcFeFeUAhR,cplcFuFuUAhL,cplcFuFuUAhR,cplFvFvUAhL,cplFvFvUAhR,cplcgWLmgWLmUAh,        & 
& cplcgWRmgWLmUAh,cplcgWLmgWRmUAh,cplcgWLpgWLpUAh,cplcgWRpgWLpUAh,cplcgWLpgWRpUAh,       & 
...
& cplUAhHpmcVWLm,cplUAhHpmcVWRm,cplUAhHppmmcHppmm,cplUAhcVWRmVWLm,cplUAhUAhAhAh,         & 
& cplUAhUAhhhhh,cplUAhUAhHpmcHpm,cplUAhUAhHppmmcHppmm,cplUAhUAhVPVP,cplUAhUAhcVWLmVWLm,  & 
& cplUAhUAhcVWRmVWRm,cplUAhUAhVZVZ,cplUAhUAhVZRVZR,delta,mass,mass2,RS,kont)

Implicit None 
Real(dp), Intent(in) :: Mhh(6),Mhh2(6),MAh(6),MAh2(6),MFd(6),MFd2(6),MFe(3),MFe2(3),MFu(3),MFu2(3),           & 
& MFv(6),MFv2(6),MVZ,MVZ2,MVZR,MVZR2,MHpm(6),MHpm2(6),MVWLm,MVWLm2,MVWRm,MVWRm2,         & 
& MHppmm(2),MHppmm2(2)
...
Complex(dp), Intent(in) :: cplUAhAhhh(6,6,6),cplcFdFdUAhL(6,6,6),cplcFdFdUAhR(6,6,6),cplcFeFeUAhL(3,3,6),        & 
& cplcFeFeUAhR(3,3,6),cplcFuFuUAhL(3,3,6),cplcFuFuUAhR(3,3,6),cplFvFvUAhL(6,6,6),        & 
& cplFvFvUAhR(6,6,6),cplcgWLmgWLmUAh(6),cplcgWRmgWLmUAh(6),cplcgWLmgWRmUAh(6),           & 
& cplcgWLpgWLpUAh(6),cplcgWRpgWLpUAh(6),cplcgWLpgWRpUAh(6),cplcgWRmgWRmUAh(6),           & 
& cplcgWRpgWRpUAh(6),cplUAhhhVP(6,6),cplUAhhhVZ(6,6),cplUAhhhVZR(6,6),cplUAhHpmcHpm(6,6,6),& 
& cplUAhHpmcVWLm(6,6),cplUAhHpmcVWRm(6,6),cplUAhHppmmcHppmm(6,2,2),cplUAhcVWRmVWLm(6),   & 
& cplUAhUAhAhAh(6,6,6,6),cplUAhUAhhhhh(6,6,6,6),cplUAhUAhHpmcHpm(6,6,6,6),               & 
& cplUAhUAhHppmmcHppmm(6,6,2,2),cplUAhUAhVPVP(6,6),cplUAhUAhcVWLmVWLm(6,6),              & 
& cplUAhUAhcVWRmVWRm(6,6),cplUAhUAhVZVZ(6,6),cplUAhUAhVZRVZR(6,6)
...
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)+(g2*gBL*v1*vhl*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(1,3) = mat2a(1,3)-(gBL*gR*v1*vhl*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(1,3) = mat2a(1,3)+(g2*gBL*v1*vhl*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(1,3) = mat2a(1,3)-(gBL*gR*v1*vhl*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(1,3) = mat2a(1,3)+(g2*gBL*v1*vhl*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(1,3) = mat2a(1,3)-(g2**2*v1*vhl*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,3) = mat2a(1,3)+(g2*gR*v1*vhl*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(1,3) = mat2a(1,3)+(g2*gBL*v1*vhl*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(1,3) = mat2a(1,3)-(g2**2*v1*vhl*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,3) = mat2a(1,3)+(g2*gR*v1*vhl*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(1,3) = mat2a(1,3)-(gBL*gR*v1*vhl*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(1,3) = mat2a(1,3)+(g2*gR*v1*vhl*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(1,3) = mat2a(1,3)-(gBL*gR*v1*vhl*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(1,3) = mat2a(1,3)+(g2*gR*v1*vhl*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)+BETA2*v1*vtr
mat2a(1,4) = mat2a(1,4)+(g2*gBL*v1*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(1,4) = mat2a(1,4)-(gBL*gR*v1*vtl*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(1,4) = mat2a(1,4)+(g2*gBL*v1*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(1,4) = mat2a(1,4)-(gBL*gR*v1*vtl*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(1,4) = mat2a(1,4)+(g2*gBL*v1*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,4) = mat2a(1,4)-(g2**2*v1*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/2._dp
mat2a(1,4) = mat2a(1,4)+(g2*gR*v1*vtl*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,4) = mat2a(1,4)+(g2*gBL*v1*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,4) = mat2a(1,4)-(g2**2*v1*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/2._dp
mat2a(1,4) = mat2a(1,4)+(g2*gR*v1*vtl*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,4) = mat2a(1,4)-(gBL*gR*v1*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,4) = mat2a(1,4)+(g2*gR*v1*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,4) = mat2a(1,4)-(gBL*gR*v1*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,4) = mat2a(1,4)+(g2*gR*v1*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,5) = 0._dp 
mat2a(1,5) = mat2a(1,5)+(g2*gBL*v1*vhr*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(1,5) = mat2a(1,5)-(gBL*gR*v1*vhr*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(1,5) = mat2a(1,5)+(g2*gBL*v1*vhr*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(1,5) = mat2a(1,5)-(gBL*gR*v1*vhr*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(1,5) = mat2a(1,5)+(g2*gBL*v1*vhr*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(1,5) = mat2a(1,5)-(g2*gR*v1*vhr*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(1,5) = mat2a(1,5)+(g2*gBL*v1*vhr*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(1,5) = mat2a(1,5)-(g2*gR*v1*vhr*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(1,5) = mat2a(1,5)-(gBL*gR*v1*vhr*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(1,5) = mat2a(1,5)-(g2*gR*v1*vhr*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(1,5) = mat2a(1,5)+(gR**2*v1*vhr*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,5) = mat2a(1,5)-(gBL*gR*v1*vhr*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(1,5) = mat2a(1,5)-(g2*gR*v1*vhr*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(1,5) = mat2a(1,5)+(gR**2*v1*vhr*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,6) = 0._dp 
mat2a(1,6) = mat2a(1,6)-(BETA2*v1*vtl)
mat2a(1,6) = mat2a(1,6)+(g2*gBL*v1*vtr*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(1,6) = mat2a(1,6)-(gBL*gR*v1*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(1,6) = mat2a(1,6)+(g2*gBL*v1*vtr*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(1,6) = mat2a(1,6)-(gBL*gR*v1*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(1,6) = mat2a(1,6)+(g2*gBL*v1*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,6) = mat2a(1,6)-(g2*gR*v1*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,6) = mat2a(1,6)+(g2*gBL*v1*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,6) = mat2a(1,6)-(g2*gR*v1*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,6) = mat2a(1,6)-(gBL*gR*v1*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,6) = mat2a(1,6)-(g2*gR*v1*vtr*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,6) = mat2a(1,6)+(gR**2*v1*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/2._dp
mat2a(1,6) = mat2a(1,6)-(gBL*gR*v1*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,6) = mat2a(1,6)-(g2*gR*v1*vtr*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,6) = mat2a(1,6)+(gR**2*v1*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/2._dp
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)+MU12
mat2a(2,2) = mat2a(2,2)+LAM1*v1**2
mat2a(2,2) = mat2a(2,2)+2*LAM3*v1**2
...
mat2a(2,3) = mat2a(2,3)-(alp*vhr*vtr)/2._dp
mat2a(2,3) = mat2a(2,3)+(vhr*xiLR)/sqrt(2._dp)
mat2a(2,3) = mat2a(2,3)-(g2*gBL*v2*vhl*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(2,3) = mat2a(2,3)+(gBL*gR*v2*vhl*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(2,3) = mat2a(2,3)-(g2*gBL*v2*vhl*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(2,3) = mat2a(2,3)+(gBL*gR*v2*vhl*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(2,3) = mat2a(2,3)-(g2*gBL*v2*vhl*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(2,3) = mat2a(2,3)+(g2**2*v2*vhl*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(2,3) = mat2a(2,3)-(g2*gR*v2*vhl*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(2,3) = mat2a(2,3)-(g2*gBL*v2*vhl*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(2,3) = mat2a(2,3)+(g2**2*v2*vhl*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(2,3) = mat2a(2,3)-(g2*gR*v2*vhl*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(2,3) = mat2a(2,3)+(gBL*gR*v2*vhl*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(2,3) = mat2a(2,3)-(g2*gR*v2*vhl*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(2,3) = mat2a(2,3)+(gBL*gR*v2*vhl*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(2,3) = mat2a(2,3)-(g2*gR*v2*vhl*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)-(g2*gBL*v2*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(2,4) = mat2a(2,4)+(gBL*gR*v2*vtl*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(2,4) = mat2a(2,4)-(g2*gBL*v2*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(2,4) = mat2a(2,4)+(gBL*gR*v2*vtl*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(2,4) = mat2a(2,4)-(g2*gBL*v2*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(2,4) = mat2a(2,4)+(g2**2*v2*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/2._dp
mat2a(2,4) = mat2a(2,4)-(g2*gR*v2*vtl*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(2,4) = mat2a(2,4)-(g2*gBL*v2*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(2,4) = mat2a(2,4)+(g2**2*v2*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/2._dp
mat2a(2,4) = mat2a(2,4)-(g2*gR*v2*vtl*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(2,4) = mat2a(2,4)+(gBL*gR*v2*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,4) = mat2a(2,4)-(g2*gR*v2*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,4) = mat2a(2,4)+(gBL*gR*v2*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,4) = mat2a(2,4)-(g2*gR*v2*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,5) = 0._dp 
mat2a(2,5) = mat2a(2,5)-(alp*vhl*vtr)/2._dp
mat2a(2,5) = mat2a(2,5)-((vhl*xiLR)/sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)-(g2*gBL*v2*vhr*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(2,5) = mat2a(2,5)+(gBL*gR*v2*vhr*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(2,5) = mat2a(2,5)-(g2*gBL*v2*vhr*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(2,5) = mat2a(2,5)+(gBL*gR*v2*vhr*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(2,5) = mat2a(2,5)-(g2*gBL*v2*vhr*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(2,5) = mat2a(2,5)+(g2*gR*v2*vhr*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(2,5) = mat2a(2,5)-(g2*gBL*v2*vhr*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(2,5) = mat2a(2,5)+(g2*gR*v2*vhr*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(2,5) = mat2a(2,5)+(gBL*gR*v2*vhr*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(2,5) = mat2a(2,5)+(g2*gR*v2*vhr*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(2,5) = mat2a(2,5)-(gR**2*v2*vhr*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,5) = mat2a(2,5)+(gBL*gR*v2*vhr*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(2,5) = mat2a(2,5)+(g2*gR*v2*vhr*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(2,5) = mat2a(2,5)-(gR**2*v2*vhr*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,6) = 0._dp 
mat2a(2,6) = mat2a(2,6)+(alp*vhl*vhr)/2._dp
mat2a(2,6) = mat2a(2,6)-(g2*gBL*v2*vtr*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(2,6) = mat2a(2,6)+(gBL*gR*v2*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(2,6) = mat2a(2,6)-(g2*gBL*v2*vtr*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(2,6) = mat2a(2,6)+(gBL*gR*v2*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(2,6) = mat2a(2,6)-(g2*gBL*v2*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(2,6) = mat2a(2,6)+(g2*gR*v2*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(2,6) = mat2a(2,6)-(g2*gBL*v2*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(2,6) = mat2a(2,6)+(g2*gR*v2*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(2,6) = mat2a(2,6)+(gBL*gR*v2*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,6) = mat2a(2,6)+(g2*gR*v2*vtr*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,6) = mat2a(2,6)-(gR**2*v2*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/2._dp
mat2a(2,6) = mat2a(2,6)+(gBL*gR*v2*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,6) = mat2a(2,6)+(g2*gR*v2*vtr*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,6) = mat2a(2,6)-(gR**2*v2*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/2._dp
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+mul2
mat2a(3,3) = mat2a(3,3)+(betl*v1**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(betl*v2**2)/2._dp
mat2a(3,3) = mat2a(3,3)+laml*vhl**2
mat2a(3,3) = mat2a(3,3)+(lamlr*vhr**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(etall*vtl**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(etalr*vtr**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(gBL**2*vhl**2*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(3,3) = mat2a(3,3)-(g2*gBL*vhl**2*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(3,3) = mat2a(3,3)+(gBL**2*vhl**2*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(3,3) = mat2a(3,3)-(g2*gBL*vhl**2*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(3,3) = mat2a(3,3)-(g2*gBL*vhl**2*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vhl**2*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(3,3) = mat2a(3,3)-(g2*gBL*vhl**2*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vhl**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)+(gBL**2*vhl*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2))/2._dp
mat2a(3,4) = mat2a(3,4)-(g2*gBL*vhl*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/2._dp
mat2a(3,4) = mat2a(3,4)+(gBL**2*vhl*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3))/2._dp
mat2a(3,4) = mat2a(3,4)-(g2*gBL*vhl*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/2._dp
mat2a(3,4) = mat2a(3,4)-(g2*gBL*vhl*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/2._dp
mat2a(3,4) = mat2a(3,4)+(g2**2*vhl*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/2._dp
mat2a(3,4) = mat2a(3,4)-(g2*gBL*vhl*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/2._dp
mat2a(3,4) = mat2a(3,4)+(g2**2*vhl*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/2._dp
mat2a(3,5) = 0._dp 
mat2a(3,5) = mat2a(3,5)+(alp*v2*vtr)/2._dp
mat2a(3,5) = mat2a(3,5)+(v2*xiLR)/sqrt(2._dp)
mat2a(3,5) = mat2a(3,5)+(gBL**2*vhl*vhr*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(3,5) = mat2a(3,5)-(g2*gBL*vhl*vhr*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(3,5) = mat2a(3,5)-(gBL*gR*vhl*vhr*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/8._dp
mat2a(3,5) = mat2a(3,5)+(gBL**2*vhl*vhr*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(3,5) = mat2a(3,5)-(g2*gBL*vhl*vhr*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(3,5) = mat2a(3,5)-(gBL*gR*vhl*vhr*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/8._dp
mat2a(3,5) = mat2a(3,5)-(g2*gBL*vhl*vhr*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(3,5) = mat2a(3,5)+(g2*gR*vhl*vhr*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(3,5) = mat2a(3,5)-(g2*gBL*vhl*vhr*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(3,5) = mat2a(3,5)+(g2*gR*vhl*vhr*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(3,5) = mat2a(3,5)-(gBL*gR*vhl*vhr*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(3,5) = mat2a(3,5)+(g2*gR*vhl*vhr*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(3,5) = mat2a(3,5)-(gBL*gR*vhl*vhr*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(3,5) = mat2a(3,5)+(g2*gR*vhl*vhr*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(3,6) = 0._dp 
mat2a(3,6) = mat2a(3,6)-(alp*v2*vhr)/2._dp
mat2a(3,6) = mat2a(3,6)+(gBL**2*vhl*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2))/2._dp
mat2a(3,6) = mat2a(3,6)-(g2*gBL*vhl*vtr*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(3,6) = mat2a(3,6)-(gBL*gR*vhl*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(3,6) = mat2a(3,6)+(gBL**2*vhl*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3))/2._dp
mat2a(3,6) = mat2a(3,6)-(g2*gBL*vhl*vtr*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(3,6) = mat2a(3,6)-(gBL*gR*vhl*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(3,6) = mat2a(3,6)-(g2*gBL*vhl*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(3,6) = mat2a(3,6)+(g2*gR*vhl*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(3,6) = mat2a(3,6)-(g2*gBL*vhl*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(3,6) = mat2a(3,6)+(g2*gR*vhl*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(3,6) = mat2a(3,6)-(gBL*gR*vhl*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(3,6) = mat2a(3,6)+(g2*gR*vhl*vtr*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(3,6) = mat2a(3,6)-(gBL*gR*vhl*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(3,6) = mat2a(3,6)+(g2*gR*vhl*vtr*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)+mudl2
mat2a(4,4) = mat2a(4,4)+(ALP1*v1**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(ALP1*v2**2)/2._dp
...
mat2a(4,4) = mat2a(4,4)+(etall*vhl**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(etarl*vhr**2)/2._dp
mat2a(4,4) = mat2a(4,4)+RHO1*vtl**2
mat2a(4,4) = mat2a(4,4)+(rh3*vtr**2)/2._dp
mat2a(4,4) = mat2a(4,4)+gBL**2*vtl**2*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2)
mat2a(4,4) = mat2a(4,4)-(g2*gBL*vtl**2*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))
mat2a(4,4) = mat2a(4,4)+gBL**2*vtl**2*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3)
mat2a(4,4) = mat2a(4,4)-(g2*gBL*vtl**2*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))
mat2a(4,4) = mat2a(4,4)-(g2*gBL*vtl**2*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))
mat2a(4,4) = mat2a(4,4)+g2**2*vtl**2*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2)
mat2a(4,4) = mat2a(4,4)-(g2*gBL*vtl**2*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))
mat2a(4,4) = mat2a(4,4)+g2**2*vtl**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3)
mat2a(4,5) = 0._dp 
mat2a(4,5) = mat2a(4,5)+(gBL**2*vhr*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2))/2._dp
mat2a(4,5) = mat2a(4,5)-(g2*gBL*vhr*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(4,5) = mat2a(4,5)-(gBL*gR*vhr*vtl*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(4,5) = mat2a(4,5)+(gBL**2*vhr*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3))/2._dp
mat2a(4,5) = mat2a(4,5)-(g2*gBL*vhr*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(4,5) = mat2a(4,5)-(gBL*gR*vhr*vtl*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(4,5) = mat2a(4,5)-(g2*gBL*vhr*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(4,5) = mat2a(4,5)+(g2*gR*vhr*vtl*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(4,5) = mat2a(4,5)-(g2*gBL*vhr*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(4,5) = mat2a(4,5)+(g2*gR*vhr*vtl*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(4,5) = mat2a(4,5)-(gBL*gR*vhr*vtl*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(4,5) = mat2a(4,5)+(g2*gR*vhr*vtl*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(4,5) = mat2a(4,5)-(gBL*gR*vhr*vtl*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(4,5) = mat2a(4,5)+(g2*gR*vhr*vtl*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(4,6) = 0._dp 
mat2a(4,6) = mat2a(4,6)-(BETA2*v1**2)/2._dp
mat2a(4,6) = mat2a(4,6)+gBL**2*vtl*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2)
mat2a(4,6) = mat2a(4,6)-(g2*gBL*vtl*vtr*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/2._dp
mat2a(4,6) = mat2a(4,6)-(gBL*gR*vtl*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/2._dp
mat2a(4,6) = mat2a(4,6)+gBL**2*vtl*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3)
mat2a(4,6) = mat2a(4,6)-(g2*gBL*vtl*vtr*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/2._dp
mat2a(4,6) = mat2a(4,6)-(gBL*gR*vtl*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/2._dp
mat2a(4,6) = mat2a(4,6)-(g2*gBL*vtl*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/2._dp
mat2a(4,6) = mat2a(4,6)+(g2*gR*vtl*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/2._dp
mat2a(4,6) = mat2a(4,6)-(g2*gBL*vtl*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/2._dp
mat2a(4,6) = mat2a(4,6)+(g2*gR*vtl*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/2._dp
mat2a(4,6) = mat2a(4,6)-(gBL*gR*vtl*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/2._dp
mat2a(4,6) = mat2a(4,6)+(g2*gR*vtl*vtr*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/2._dp
mat2a(4,6) = mat2a(4,6)-(gBL*gR*vtl*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/2._dp
mat2a(4,6) = mat2a(4,6)+(g2*gR*vtl*vtr*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/2._dp
mat2a(5,5) = 0._dp 
mat2a(5,5) = mat2a(5,5)+mur2
mat2a(5,5) = mat2a(5,5)+(betr*v1**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(betr*v2**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(lamlr*vhl**2)/2._dp
mat2a(5,5) = mat2a(5,5)+lamr*vhr**2
mat2a(5,5) = mat2a(5,5)+(etarl*vtl**2)/2._dp
mat2a(5,5) = mat2a(5,5)-(err2*vtr**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(etarr*vtr**2)/2._dp
mat2a(5,5) = mat2a(5,5)+sqrt(2._dp)*vtr*xiR
mat2a(5,5) = mat2a(5,5)+(gBL**2*vhr**2*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(5,5) = mat2a(5,5)-(gBL*gR*vhr**2*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(5,5) = mat2a(5,5)+(gBL**2*vhr**2*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(5,5) = mat2a(5,5)-(gBL*gR*vhr**2*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(5,5) = mat2a(5,5)-(gBL*gR*vhr**2*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(5,5) = mat2a(5,5)+(gR**2*vhr**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(5,5) = mat2a(5,5)-(gBL*gR*vhr**2*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(5,5) = mat2a(5,5)+(gR**2*vhr**2*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(5,6) = 0._dp 
mat2a(5,6) = mat2a(5,6)-(alp*v2*vhl)/2._dp
mat2a(5,6) = mat2a(5,6)-(sqrt(2._dp)*vhr*xiR)
mat2a(5,6) = mat2a(5,6)+(gBL**2*vhr*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2))/2._dp
mat2a(5,6) = mat2a(5,6)-(gBL*gR*vhr*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/2._dp
mat2a(5,6) = mat2a(5,6)+(gBL**2*vhr*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3))/2._dp
mat2a(5,6) = mat2a(5,6)-(gBL*gR*vhr*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/2._dp
mat2a(5,6) = mat2a(5,6)-(gBL*gR*vhr*vtr*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/2._dp
mat2a(5,6) = mat2a(5,6)+(gR**2*vhr*vtr*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/2._dp
mat2a(5,6) = mat2a(5,6)-(gBL*gR*vhr*vtr*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/2._dp
mat2a(5,6) = mat2a(5,6)+(gR**2*vhr*vtr*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/2._dp
mat2a(6,6) = 0._dp 
mat2a(6,6) = mat2a(6,6)+mudr2
mat2a(6,6) = mat2a(6,6)+(ALP1*v1**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(ALP1*v2**2)/2._dp
...
mat2a(6,6) = mat2a(6,6)+(etarr*vhr**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(rh3*vtl**2)/2._dp
mat2a(6,6) = mat2a(6,6)+RHO1*vtr**2
mat2a(6,6) = mat2a(6,6)+gBL**2*vtr**2*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2)
mat2a(6,6) = mat2a(6,6)-(gBL*gR*vtr**2*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))
mat2a(6,6) = mat2a(6,6)+gBL**2*vtr**2*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3)
mat2a(6,6) = mat2a(6,6)-(gBL*gR*vtr**2*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))
mat2a(6,6) = mat2a(6,6)-(gBL*gR*vtr**2*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))
mat2a(6,6) = mat2a(6,6)+gR**2*vtr**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2)
mat2a(6,6) = mat2a(6,6)-(gBL*gR*vtr**2*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))
mat2a(6,6) = mat2a(6,6)+gR**2*vtr**2*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3)
...
Subroutine OneLoopHpm(g2,gR,xiLR,xiR,alp,mudl2,mudr2,MU12,mul2,mur2,RHO1,             & 
& rh3,ALP3,ALP1,LAM1,etall,etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,betr,             & 
& err1,BETA2,LAM3,v1,v2,vtl,vtr,vhl,vhr,PhiW,MHpm,MHpm2,MAh,MAh2,MVWLm,MVWLm2,           & 
& MVWRm,MVWRm2,MFu,MFu2,MFd,MFd2,Mhh,Mhh2,MVZ,MVZ2,MVZR,MVZR2,MHppmm,MHppmm2,            & 
& cplAhHpmcUHpm,cplAhcUHpmVWLm,cplAhcUHpmVWRm,cplcFuFdcUHpmL,cplcFuFdcUHpmR,             & 
& cplcgZgWLmcUHpm,cplcgWLmgZUHpm,cplcgZpgWLmcUHpm,cplcgWLmgZpUHpm,cplcgZgWRmcUHpm,       & 
& cplcgWRmgZUHpm,cplcgZpgWRmcUHpm,cplcgWRmgZpUHpm,cplcgWLpgZcUHpm,cplcgZgWLpUHpm,        & 
& cplcgWRpgZcUHpm,cplcgZgWRpUHpm,cplcgWLpgZpcUHpm,cplcgZpgWLpUHpm,cplcgWRpgZpcUHpm,      & 
...
Implicit None 
Real(dp), Intent(in) :: MHpm(6),MHpm2(6),MAh(6),MAh2(6),MVWLm,MVWLm2,MVWRm,MVWRm2,MFu(3),MFu2(3),             & 
& MFd(6),MFd2(6),Mhh(6),Mhh2(6),MVZ,MVZ2,MVZR,MVZR2,MHppmm(2),MHppmm2(2)
...
Complex(dp), Intent(in) :: cplAhHpmcUHpm(6,6,6),cplAhcUHpmVWLm(6,6),cplAhcUHpmVWRm(6,6),cplcFuFdcUHpmL(3,6,6),   & 
& cplcFuFdcUHpmR(3,6,6),cplcgZgWLmcUHpm(6),cplcgWLmgZUHpm(6),cplcgZpgWLmcUHpm(6),        & 
& cplcgWLmgZpUHpm(6),cplcgZgWRmcUHpm(6),cplcgWRmgZUHpm(6),cplcgZpgWRmcUHpm(6),           & 
& cplcgWRmgZpUHpm(6),cplcgWLpgZcUHpm(6),cplcgZgWLpUHpm(6),cplcgWRpgZcUHpm(6),            & 
& cplcgZgWRpUHpm(6),cplcgWLpgZpcUHpm(6),cplcgZpgWLpUHpm(6),cplcgWRpgZpcUHpm(6),          & 
& cplcgZpgWRpUHpm(6),cplhhHpmcUHpm(6,6,6),cplhhcUHpmVWLm(6,6),cplhhcUHpmVWRm(6,6),       & 
& cplHpmcUHpmVP(6,6),cplHpmcUHpmVZ(6,6),cplHpmcUHpmVZR(6,6),cplHppmmcUHpmcHpm(2,6,6),    & 
& cplHppmmcUHpmcVWLm(2,6),cplHppmmcUHpmcVWRm(2,6),cplcUHpmVPVWLm(6),cplcUHpmVPVWRm(6),   & 
& cplcUHpmVWLmVZ(6),cplcUHpmVWLmVZR(6),cplcUHpmVWRmVZ(6),cplcUHpmVWRmVZR(6),             & 
& cplAhAhUHpmcUHpm(6,6,6,6),cplhhhhUHpmcUHpm(6,6,6,6),cplUHpmHpmcUHpmcHpm(6,6,6,6),      & 
& cplUHpmHppmmcUHpmcHppmm(6,2,6,2),cplUHpmcUHpmVPVP(6,6),cplUHpmcUHpmcVWLmVWLm(6,6),     & 
& cplUHpmcUHpmcVWRmVWRm(6,6),cplUHpmcUHpmVZVZ(6,6),cplUHpmcUHpmVZRVZR(6,6)
...
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)-(g2**2*v1*vhl*Cos(PhiW)**2*RXiWLm)/4._dp
mat2a(1,3) = mat2a(1,3)+(g2*gR*v2*vhl*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(1,3) = mat2a(1,3)-(g2*gR*v2*vhl*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat2a(1,3) = mat2a(1,3)-(g2**2*v1*vhl*RXiWRm*Sin(PhiW)**2)/4._dp
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)+(vhl*xiLR)/sqrt(2._dp)
mat2a(1,4) = mat2a(1,4)+(gR**2*v2*vhr*Cos(PhiW)**2*RXiWRm)/4._dp
mat2a(1,4) = mat2a(1,4)-(g2*gR*v1*vhr*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(1,4) = mat2a(1,4)+(g2*gR*v1*vhr*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat2a(1,4) = mat2a(1,4)+(gR**2*v2*vhr*RXiWLm*Sin(PhiW)**2)/4._dp
mat2a(1,5) = 0._dp 
mat2a(1,5) = mat2a(1,5)+(ALP3*v1*vtl)/(2._dp*sqrt(2._dp))
mat2a(1,5) = mat2a(1,5)+(BETA2*v1*vtr)/sqrt(2._dp)
mat2a(1,5) = mat2a(1,5)-(g2**2*v1*vtl*Cos(PhiW)**2*RXiWLm)/(2._dp*sqrt(2._dp))
mat2a(1,5) = mat2a(1,5)+(g2*gR*v2*vtl*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(1,5) = mat2a(1,5)-(g2*gR*v2*vtl*Cos(PhiW)*RXiWRm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(1,5) = mat2a(1,5)-(g2**2*v1*vtl*RXiWRm*Sin(PhiW)**2)/(2._dp*sqrt(2._dp))
mat2a(1,6) = 0._dp 
mat2a(1,6) = mat2a(1,6)-(alp*vhl*vhr)/(2._dp*sqrt(2._dp))
mat2a(1,6) = mat2a(1,6)+(ALP3*v2*vtr)/(2._dp*sqrt(2._dp))
mat2a(1,6) = mat2a(1,6)+(gR**2*v2*vtr*Cos(PhiW)**2*RXiWRm)/(2._dp*sqrt(2._dp))
mat2a(1,6) = mat2a(1,6)-(g2*gR*v1*vtr*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(1,6) = mat2a(1,6)+(g2*gR*v1*vtr*Cos(PhiW)*RXiWRm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(1,6) = mat2a(1,6)+(gR**2*v2*vtr*RXiWLm*Sin(PhiW)**2)/(2._dp*sqrt(2._dp))
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)+MU12
mat2a(2,2) = mat2a(2,2)+LAM1*v1**2
mat2a(2,2) = mat2a(2,2)+LAM1*v2**2
...
mat2a(2,3) = mat2a(2,3)-(alp*vhr*vtr)/2._dp
mat2a(2,3) = mat2a(2,3)+(vhr*xiLR)/sqrt(2._dp)
mat2a(2,3) = mat2a(2,3)+(g2**2*v2*vhl*Cos(PhiW)**2*RXiWLm)/4._dp
mat2a(2,3) = mat2a(2,3)-(g2*gR*v1*vhl*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(2,3) = mat2a(2,3)+(g2*gR*v1*vhl*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat2a(2,3) = mat2a(2,3)+(g2**2*v2*vhl*RXiWRm*Sin(PhiW)**2)/4._dp
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)-(gR**2*v1*vhr*Cos(PhiW)**2*RXiWRm)/4._dp
mat2a(2,4) = mat2a(2,4)+(g2*gR*v2*vhr*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(2,4) = mat2a(2,4)-(g2*gR*v2*vhr*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat2a(2,4) = mat2a(2,4)-(gR**2*v1*vhr*RXiWLm*Sin(PhiW)**2)/4._dp
mat2a(2,5) = 0._dp 
mat2a(2,5) = mat2a(2,5)+(ALP3*v2*vtl)/(2._dp*sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)+(g2**2*v2*vtl*Cos(PhiW)**2*RXiWLm)/(2._dp*sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)-(g2*gR*v1*vtl*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)+(g2*gR*v1*vtl*Cos(PhiW)*RXiWRm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)+(g2**2*v2*vtl*RXiWRm*Sin(PhiW)**2)/(2._dp*sqrt(2._dp))
mat2a(2,6) = 0._dp 
mat2a(2,6) = mat2a(2,6)+(BETA2*v1*vtl)/sqrt(2._dp)
mat2a(2,6) = mat2a(2,6)+(ALP3*v1*vtr)/(2._dp*sqrt(2._dp))
mat2a(2,6) = mat2a(2,6)-(gR**2*v1*vtr*Cos(PhiW)**2*RXiWRm)/(2._dp*sqrt(2._dp))
mat2a(2,6) = mat2a(2,6)+(g2*gR*v2*vtr*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(2,6) = mat2a(2,6)-(g2*gR*v2*vtr*Cos(PhiW)*RXiWRm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(2,6) = mat2a(2,6)-(gR**2*v1*vtr*RXiWLm*Sin(PhiW)**2)/(2._dp*sqrt(2._dp))
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+mul2
mat2a(3,3) = mat2a(3,3)+(betl*v1**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(betl*v2**2)/2._dp
...
mat2a(3,3) = mat2a(3,3)+(etall*vtl**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(etalr*vtr**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vhl**2*Cos(PhiW)**2*RXiWLm)/4._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vhl**2*RXiWRm*Sin(PhiW)**2)/4._dp
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)+(v1*xiLR)/sqrt(2._dp)
mat2a(3,4) = mat2a(3,4)+(g2*gR*vhl*vhr*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(3,4) = mat2a(3,4)-(g2*gR*vhl*vhr*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat2a(3,5) = 0._dp 
mat2a(3,5) = mat2a(3,5)+(g2**2*vhl*vtl*Cos(PhiW)**2*RXiWLm)/(2._dp*sqrt(2._dp))
mat2a(3,5) = mat2a(3,5)+(g2**2*vhl*vtl*RXiWRm*Sin(PhiW)**2)/(2._dp*sqrt(2._dp))
mat2a(3,6) = 0._dp 
mat2a(3,6) = mat2a(3,6)-(alp*v1*vhr)/(2._dp*sqrt(2._dp))
mat2a(3,6) = mat2a(3,6)+(g2*gR*vhl*vtr*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(3,6) = mat2a(3,6)-(g2*gR*vhl*vtr*Cos(PhiW)*RXiWRm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)+mur2
mat2a(4,4) = mat2a(4,4)+(betr*v1**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(betr*v2**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(lamlr*vhl**2)/2._dp
mat2a(4,4) = mat2a(4,4)+lamr*vhr**2
mat2a(4,4) = mat2a(4,4)+(etarl*vtl**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(err1*vtr**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(etarr*vtr**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(gR**2*vhr**2*Cos(PhiW)**2*RXiWRm)/4._dp
mat2a(4,4) = mat2a(4,4)+(gR**2*vhr**2*RXiWLm*Sin(PhiW)**2)/4._dp
mat2a(4,5) = 0._dp 
mat2a(4,5) = mat2a(4,5)+(g2*gR*vhr*vtl*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(4,5) = mat2a(4,5)-(g2*gR*vhr*vtl*Cos(PhiW)*RXiWRm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(4,6) = 0._dp 
mat2a(4,6) = mat2a(4,6)-(alp*v2*vhl)/(2._dp*sqrt(2._dp))
mat2a(4,6) = mat2a(4,6)-(err1*vhr*vtr)/(2._dp*sqrt(2._dp))
mat2a(4,6) = mat2a(4,6)-(err2*vhr*vtr)/(2._dp*sqrt(2._dp))
mat2a(4,6) = mat2a(4,6)-(vhr*xiR)
mat2a(4,6) = mat2a(4,6)+(gR**2*vhr*vtr*Cos(PhiW)**2*RXiWRm)/(2._dp*sqrt(2._dp))
mat2a(4,6) = mat2a(4,6)+(gR**2*vhr*vtr*RXiWLm*Sin(PhiW)**2)/(2._dp*sqrt(2._dp))
mat2a(5,5) = 0._dp 
mat2a(5,5) = mat2a(5,5)+mudl2
mat2a(5,5) = mat2a(5,5)+(ALP1*v1**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(ALP3*v1**2)/4._dp
mat2a(5,5) = mat2a(5,5)+(ALP1*v2**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(ALP3*v2**2)/4._dp
mat2a(5,5) = mat2a(5,5)+(etall*vhl**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(etarl*vhr**2)/2._dp
mat2a(5,5) = mat2a(5,5)+RHO1*vtl**2
mat2a(5,5) = mat2a(5,5)+(rh3*vtr**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(g2**2*vtl**2*Cos(PhiW)**2*RXiWLm)/2._dp
mat2a(5,5) = mat2a(5,5)+(g2**2*vtl**2*RXiWRm*Sin(PhiW)**2)/2._dp
mat2a(5,6) = 0._dp 
mat2a(5,6) = mat2a(5,6)-(BETA2*v1*v2)/2._dp
mat2a(5,6) = mat2a(5,6)+(g2*gR*vtl*vtr*Cos(PhiW)*RXiWLm*Sin(PhiW))/2._dp
mat2a(5,6) = mat2a(5,6)-(g2*gR*vtl*vtr*Cos(PhiW)*RXiWRm*Sin(PhiW))/2._dp
mat2a(6,6) = 0._dp 
mat2a(6,6) = mat2a(6,6)+mudr2
mat2a(6,6) = mat2a(6,6)+(ALP1*v1**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(ALP3*v1**2)/4._dp
mat2a(6,6) = mat2a(6,6)+(ALP1*v2**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(ALP3*v2**2)/4._dp
mat2a(6,6) = mat2a(6,6)+(etalr*vhl**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(err1*vhr**2)/4._dp
mat2a(6,6) = mat2a(6,6)-(err2*vhr**2)/4._dp
mat2a(6,6) = mat2a(6,6)+(etarr*vhr**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(rh3*vtl**2)/2._dp
mat2a(6,6) = mat2a(6,6)+RHO1*vtr**2
mat2a(6,6) = mat2a(6,6)+(gR**2*vtr**2*Cos(PhiW)**2*RXiWRm)/2._dp
mat2a(6,6) = mat2a(6,6)+(gR**2*vtr**2*RXiWLm*Sin(PhiW)**2)/2._dp
...
Subroutine OneLoopHppmm(mudl2,mudr2,RHO2,RHO1,rh3,ALP3,ALP1,etall,etalr,              & 
& etarl,etarr,err1,BETA2,v1,v2,vtl,vtr,vhl,vhr,MHppmm,MHppmm2,MAh,MAh2,MFe,              & 
& MFe2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplAhHppmmcUHppmm,& 
& cplFeFecUHppmmL,cplFeFecUHppmmR,cplcgWLpgWLmcUHppmm,cplcgWLmgWLpUHppmm,cplcgWRpgWLmcUHppmm,& 
& cplcgWLmgWRpUHppmm,cplcgWLpgWRmcUHppmm,cplcgWRmgWLpUHppmm,cplcgWRpgWRmcUHppmm,         & 
& cplcgWRmgWRpUHppmm,cplhhHppmmcUHppmm,cplHpmHpmcUHppmm,cplHpmcUHppmmVWLm,               & 
& cplHpmcUHppmmVWRm,cplHppmmcUHppmmVP,cplHppmmcUHppmmVZ,cplHppmmcUHppmmVZR,              & 
...
Implicit None 
Real(dp), Intent(in) :: MHppmm(2),MHppmm2(2),MAh(6),MAh2(6),MFe(3),MFe2(3),Mhh(6),Mhh2(6),MHpm(6),            & 
& MHpm2(6),MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2
...
Complex(dp), Intent(in) :: cplAhHppmmcUHppmm(6,2,2),cplFeFecUHppmmL(3,3,2),cplFeFecUHppmmR(3,3,2),               & 
...
& cplhhHppmmcUHppmm(6,2,2),cplHpmHpmcUHppmm(6,6,2),cplHpmcUHppmmVWLm(6,2),               & 
& cplHpmcUHppmmVWRm(6,2),cplHppmmcUHppmmVP(2,2),cplHppmmcUHppmmVZ(2,2),cplHppmmcUHppmmVZR(2,2),& 
& cplcUHppmmVWLmVWLm(2),cplcUHppmmVWLmVWRm(2),cplcUHppmmVWRmVWRm(2),cplAhAhUHppmmcUHppmm(6,6,2,2),& 
& cplhhhhUHppmmcUHppmm(6,6,2,2),cplHpmUHppmmcHpmcUHppmm(6,2,6,2),cplUHppmmHppmmcUHppmmcHppmm(2,2,2,2),& 
...
mat2a(1,1) = mat2a(1,1)+(etall*vhl**2)/2._dp
mat2a(1,1) = mat2a(1,1)+(etarl*vhr**2)/2._dp
...
mat2a(2,2) = mat2a(2,2)+(etalr*vhl**2)/2._dp
mat2a(2,2) = mat2a(2,2)+(err1*vhr**2)/2._dp
mat2a(2,2) = mat2a(2,2)+(etarr*vhr**2)/2._dp
...
Subroutine OneLoopFd(YQ2,yq3,YQ1,v1,vhl,vhr,MFd,MFd2,MAh,MAh2,Mhh,Mhh2,               & 
& MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MFu,MFu2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplcUFdFdAhL,        & 
& cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,cplcUFdFdVGR,cplcUFdFdVPL,         & 
& cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFdVZRL,cplcUFdFdVZRR,cplcUFdFuHpmL,      & 
& cplcUFdFuHpmR,cplcUFdFuVWLmL,cplcUFdFuVWLmR,cplcUFdFuVWRmL,cplcUFdFuVWRmR,             & 
& delta,MFd_1L,MFd2_1L,ZDL_1L,ZDR_1L,ierr)

Implicit None 
Real(dp), Intent(in) :: MFd(6),MFd2(6),MAh(6),MAh2(6),Mhh(6),Mhh2(6),MVZ,MVZ2,MVZR,MVZR2,MHpm(6),             & 
& MHpm2(6),MFu(3),MFu2(3),MVWLm,MVWLm2,MVWRm,MVWRm2

Real(dp), Intent(in) :: v1,vhl,vhr

Complex(dp), Intent(in) :: YQ2(3,3),yq3(3,3),YQ1(3,3)

Complex(dp), Intent(in) :: cplcUFdFdAhL(6,6,6),cplcUFdFdAhR(6,6,6),cplcUFdFdhhL(6,6,6),cplcUFdFdhhR(6,6,6),      & 
& cplcUFdFdVGL(6,6),cplcUFdFdVGR(6,6),cplcUFdFdVPL(6,6),cplcUFdFdVPR(6,6),               & 
& cplcUFdFdVZL(6,6),cplcUFdFdVZR(6,6),cplcUFdFdVZRL(6,6),cplcUFdFdVZRR(6,6),             & 
& cplcUFdFuHpmL(6,3,6),cplcUFdFuHpmR(6,3,6),cplcUFdFuVWLmL(6,3),cplcUFdFuVWLmR(6,3),     & 
& cplcUFdFuVWRmL(6,3),cplcUFdFuVWRmR(6,3)
...
Real(dp), Intent(out) :: MFd_1L(6),MFd2_1L(6) 
 ...
 Complex(dp) :: ZDL_t(6,6), ZDR_t(6,6), sigL(6,6), sigR(6,6), sigS(6,6) 
...
mat1a(1,4) = 0._dp 
mat1a(1,4) = mat1a(1,4)+(vhl*Conjg(YQ2(1,1)))/sqrt(2._dp)
mat1a(1,5) = 0._dp 
mat1a(1,5) = mat1a(1,5)+(vhl*Conjg(YQ2(1,2)))/sqrt(2._dp)
mat1a(1,6) = 0._dp 
mat1a(1,6) = mat1a(1,6)+(vhl*Conjg(YQ2(1,3)))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
...
mat1a(2,4) = 0._dp 
mat1a(2,4) = mat1a(2,4)+(vhl*Conjg(YQ2(2,1)))/sqrt(2._dp)
mat1a(2,5) = 0._dp 
mat1a(2,5) = mat1a(2,5)+(vhl*Conjg(YQ2(2,2)))/sqrt(2._dp)
mat1a(2,6) = 0._dp 
mat1a(2,6) = mat1a(2,6)+(vhl*Conjg(YQ2(2,3)))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
...
mat1a(3,4) = 0._dp 
mat1a(3,4) = mat1a(3,4)+(vhl*Conjg(YQ2(3,1)))/sqrt(2._dp)
mat1a(3,5) = 0._dp 
mat1a(3,5) = mat1a(3,5)+(vhl*Conjg(YQ2(3,2)))/sqrt(2._dp)
mat1a(3,6) = 0._dp 
mat1a(3,6) = mat1a(3,6)+(vhl*Conjg(YQ2(3,3)))/sqrt(2._dp)
mat1a(4,1) = 0._dp 
mat1a(4,1) = mat1a(4,1)+(vhr*Conjg(yq3(1,1)))/sqrt(2._dp)
mat1a(4,2) = 0._dp 
mat1a(4,2) = mat1a(4,2)+(vhr*Conjg(yq3(1,2)))/sqrt(2._dp)
mat1a(4,3) = 0._dp 
mat1a(4,3) = mat1a(4,3)+(vhr*Conjg(yq3(1,3)))/sqrt(2._dp)
mat1a(4,4) = 0._dp 
mat1a(4,5) = 0._dp 
mat1a(4,6) = 0._dp 
mat1a(5,1) = 0._dp 
mat1a(5,1) = mat1a(5,1)+(vhr*Conjg(yq3(2,1)))/sqrt(2._dp)
mat1a(5,2) = 0._dp 
mat1a(5,2) = mat1a(5,2)+(vhr*Conjg(yq3(2,2)))/sqrt(2._dp)
mat1a(5,3) = 0._dp 
mat1a(5,3) = mat1a(5,3)+(vhr*Conjg(yq3(2,3)))/sqrt(2._dp)
mat1a(5,4) = 0._dp 
mat1a(5,5) = 0._dp 
mat1a(5,6) = 0._dp 
mat1a(6,1) = 0._dp 
mat1a(6,1) = mat1a(6,1)+(vhr*Conjg(yq3(3,1)))/sqrt(2._dp)
mat1a(6,2) = 0._dp 
mat1a(6,2) = mat1a(6,2)+(vhr*Conjg(yq3(3,2)))/sqrt(2._dp)
mat1a(6,3) = 0._dp 
mat1a(6,3) = mat1a(6,3)+(vhr*Conjg(yq3(3,3)))/sqrt(2._dp)
mat1a(6,4) = 0._dp 
mat1a(6,5) = 0._dp 
mat1a(6,6) = 0._dp 
...
Implicit None 
Real(dp), Intent(in) :: MFu(3),MFu2(3),MAh(6),MAh2(6),MHpm(6),MHpm2(6),MFd(6),MFd2(6),MVWLm,MVWLm2,           & 
& MVWRm,MVWRm2,Mhh(6),Mhh2(6),MVZ,MVZ2,MVZR,MVZR2

Real(dp), Intent(in) :: v2

Complex(dp), Intent(in) :: YQ1(3,3)

Complex(dp), Intent(in) :: cplcUFuFuAhL(3,3,6),cplcUFuFuAhR(3,3,6),cplcUFuFdcHpmL(3,6,6),cplcUFuFdcHpmR(3,6,6),  & 
& cplcUFuFdcVWLmL(3,6),cplcUFuFdcVWLmR(3,6),cplcUFuFdcVWRmL(3,6),cplcUFuFdcVWRmR(3,6),   & 
& cplcUFuFuhhL(3,3,6),cplcUFuFuhhR(3,3,6),cplcUFuFuVGL(3,3),cplcUFuFuVGR(3,3),           & 
& cplcUFuFuVPL(3,3),cplcUFuFuVPR(3,3),cplcUFuFuVZL(3,3),cplcUFuFuVZR(3,3),               & 
...
Implicit None 
Real(dp), Intent(in) :: MFe(3),MFe2(3),MAh(6),MAh2(6),Mhh(6),Mhh2(6),MVZ,MVZ2,MVZR,MVZR2,MHppmm(2),           & 
& MHppmm2(2)
...
Complex(dp), Intent(in) :: cplcUFeFeAhL(3,3,6),cplcUFeFeAhR(3,3,6),cplcUFeFehhL(3,3,6),cplcUFeFehhR(3,3,6),      & 
...
Implicit None 
Real(dp), Intent(in) :: MFv(6),MFv2(6),MAh(6),MAh2(6),Mhh(6),Mhh2(6),MVZ,MVZ2,MVZR,MVZR2

Real(dp), Intent(in) :: v1,vtl,vtr

Complex(dp), Intent(in) :: YDR(3,3),YL1(3,3),YDL(3,3)

Complex(dp), Intent(in) :: cplUFvFvAhL(6,6,6),cplUFvFvAhR(6,6,6),cplUFvFvhhL(6,6,6),cplUFvFvhhR(6,6,6),          & 
...
Subroutine OneLoopVZ(gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,Mhh,Mhh2,MAh,MAh2,            & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,              & 
& MVWLm2,MVWRm,MVWRm2,MHppmm,MHppmm2,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,      & 
& cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplcgWLmgWLmVZ,              & 
& cplcgWRmgWLmVZ,cplcgWLpgWLpVZ,cplcgWRpgWLpVZ,cplcgWRmgWRmVZ,cplcgWRpgWRpVZ,            & 
& cplhhVPVZ,cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVZ,cplHpmcVWLmVZ,cplHpmcVWRmVZ,               & 
& cplHppmmcHppmmVZ,cplcVWLmVWLmVZ,cplcVWRmVWLmVZ,cplcVWRmVWRmVZ,cplAhAhVZVZ,             & 
...
Complex(dp), Intent(in) :: cplAhhhVZ(6,6),cplcFdFdVZL(6,6),cplcFdFdVZR(6,6),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),   & 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplcgWLmgWLmVZ,      & 
& cplcgWRmgWLmVZ,cplcgWLpgWLpVZ,cplcgWRpgWLpVZ,cplcgWRmgWRmVZ,cplcgWRpgWRpVZ,            & 
& cplhhVPVZ(6),cplhhVZVZ(6),cplhhVZVZR(6),cplHpmcHpmVZ(6,6),cplHpmcVWLmVZ(6),            & 
& cplHpmcVWRmVZ(6),cplHppmmcHppmmVZ(2,2),cplcVWLmVWLmVZ,cplcVWRmVWLmVZ,cplcVWRmVWRmVZ,   & 
& cplAhAhVZVZ(6,6),cplhhhhVZVZ(6,6),cplHpmcHpmVZVZ(6,6),cplHppmmcHppmmVZVZ(2,2),         & 
...
Subroutine OneLoopVZR(gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,Mhh,Mhh2,MAh,MAh2,           & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,              & 
& MVWLm2,MVWRm,MVWRm2,MHppmm,MHppmm2,cplAhhhVZR,cplcFdFdVZRL,cplcFdFdVZRR,               & 
...
& cplcgWRpgWRpVZR,cplhhVPVZR,cplhhVZVZR,cplhhVZRVZR,cplHpmcHpmVZR,cplHpmcVWLmVZR,        & 
& cplHpmcVWRmVZR,cplHppmmcHppmmVZR,cplcVWLmVWLmVZR,cplcVWRmVWLmVZR,cplcVWRmVWRmVZR,      & 
& cplAhAhVZRVZR,cplhhhhVZRVZR,cplHpmcHpmVZRVZR,cplHppmmcHppmmVZRVZR,cplcVWLmVWLmVZRVZR1, & 
...
Complex(dp), Intent(in) :: cplAhhhVZR(6,6),cplcFdFdVZRL(6,6),cplcFdFdVZRR(6,6),cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),& 
...
& cplhhVPVZR(6),cplhhVZVZR(6),cplhhVZRVZR(6),cplHpmcHpmVZR(6,6),cplHpmcVWLmVZR(6),       & 
& cplHpmcVWRmVZR(6),cplHppmmcHppmmVZR(2,2),cplcVWLmVWLmVZR,cplcVWRmVWLmVZR,              & 
& cplcVWRmVWRmVZR,cplAhAhVZRVZR(6,6),cplhhhhVZRVZR(6,6),cplHpmcHpmVZRVZR(6,6),           & 
...
Subroutine OneLoopVWLm(g2,gR,v1,v2,vtl,vtr,vhl,vhr,PhiW,MHpm,MHpm2,MAh,               & 
& MAh2,MVWRm,MVWRm2,MFu,MFu2,MFd,MFd2,Mhh,Mhh2,MVWLm,MVWLm2,MVZ,MVZ2,MVZR,               & 
& MVZR2,MHppmm,MHppmm2,cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFuFdcVWLmL,cplcFuFdcVWLmR,       & 
& cplcgWLpgPcVWLm,cplcgWRpgPcVWLm,cplcgPgWLmcVWLm,cplcgZgWLmcVWLm,cplcgZpgWLmcVWLm,      & 
& cplcgPgWRmcVWLm,cplcgZgWRmcVWLm,cplcgZpgWRmcVWLm,cplcgWLpgZcVWLm,cplcgWRpgZcVWLm,      & 
& cplcgWLpgZpcVWLm,cplcgWRpgZpcVWLm,cplhhHpmcVWLm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,         & 
& cplHpmcVWLmVP,cplHpmcVWLmVZ,cplHpmcVWLmVZR,cplHppmmcHpmcVWLm,cplHppmmcVWLmcVWLm,       & 
& cplHppmmcVWLmcVWRm,cplcVWLmVPVWLm,cplcVWLmVPVWRm,cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,       & 
& cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplAhAhcVWLmVWLm,cplhhhhcVWLmVWLm,cplHpmcHpmcVWLmVWLm,  & 
& cplHppmmcHppmmcVWLmVWLm,cplcVWLmVPVPVWLm3,cplcVWLmVPVPVWLm1,cplcVWLmVPVPVWLm2,         & 
...
Real(dp), Intent(in) :: MHpm(6),MHpm2(6),MAh(6),MAh2(6),MVWRm,MVWRm2,MFu(3),MFu2(3),MFd(6),MFd2(6),           & 
& Mhh(6),Mhh2(6),MVWLm,MVWLm2,MVZ,MVZ2,MVZR,MVZR2,MHppmm(2),MHppmm2(2)

Real(dp), Intent(in) :: g2,gR,v1,v2,vtl,vtr,vhl,vhr,PhiW

Complex(dp), Intent(in) :: cplAhHpmcVWLm(6,6),cplAhcVWLmVWRm(6),cplcFuFdcVWLmL(3,6),cplcFuFdcVWLmR(3,6),         & 
& cplcgWLpgPcVWLm,cplcgWRpgPcVWLm,cplcgPgWLmcVWLm,cplcgZgWLmcVWLm,cplcgZpgWLmcVWLm,      & 
& cplcgPgWRmcVWLm,cplcgZgWRmcVWLm,cplcgZpgWRmcVWLm,cplcgWLpgZcVWLm,cplcgWRpgZcVWLm,      & 
& cplcgWLpgZpcVWLm,cplcgWRpgZpcVWLm,cplhhHpmcVWLm(6,6),cplhhcVWLmVWLm(6),cplhhcVWLmVWRm(6),& 
& cplHpmcVWLmVP(6),cplHpmcVWLmVZ(6),cplHpmcVWLmVZR(6),cplHppmmcHpmcVWLm(2,6),            & 
& cplHppmmcVWLmcVWLm(2),cplHppmmcVWLmcVWRm(2),cplcVWLmVPVWLm,cplcVWLmVPVWRm,             & 
& cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplAhAhcVWLmVWLm(6,6),   & 
& cplhhhhcVWLmVWLm(6,6),cplHpmcHpmcVWLmVWLm(6,6),cplHppmmcHppmmcVWLmVWLm(2,2),           & 
...
Subroutine OneLoopVWRm(g2,gR,v1,v2,vtl,vtr,vhl,vhr,PhiW,MHpm,MHpm2,MAh,               & 
& MAh2,MVWLm,MVWLm2,MFu,MFu2,MFd,MFd2,Mhh,Mhh2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,               & 
...
& cplHpmcVWRmVP,cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplHppmmcHpmcVWRm,cplHppmmcVWLmcVWRm,       & 
& cplHppmmcVWRmcVWRm,cplcVWRmVPVWLm,cplcVWRmVPVWRm,cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,       & 
& cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplAhAhcVWRmVWRm,cplhhhhcVWRmVWRm,cplHpmcHpmcVWRmVWRm,  & 
& cplHppmmcHppmmcVWRmVWRm,cplcVWRmVPVPVWRm3,cplcVWRmVPVPVWRm1,cplcVWRmVPVPVWRm2,         & 
...
Real(dp), Intent(in) :: MHpm(6),MHpm2(6),MAh(6),MAh2(6),MVWLm,MVWLm2,MFu(3),MFu2(3),MFd(6),MFd2(6),           & 
& Mhh(6),Mhh2(6),MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,MHppmm(2),MHppmm2(2)

Real(dp), Intent(in) :: g2,gR,v1,v2,vtl,vtr,vhl,vhr,PhiW

Complex(dp), Intent(in) :: cplAhHpmcVWRm(6,6),cplAhcVWRmVWLm(6),cplcFuFdcVWRmL(3,6),cplcFuFdcVWRmR(3,6),         & 
& cplcgWLpgPcVWRm,cplcgWRpgPcVWRm,cplcgPgWLmcVWRm,cplcgZgWLmcVWRm,cplcgZpgWLmcVWRm,      & 
& cplcgPgWRmcVWRm,cplcgZgWRmcVWRm,cplcgZpgWRmcVWRm,cplcgWLpgZcVWRm,cplcgWRpgZcVWRm,      & 
& cplcgWLpgZpcVWRm,cplcgWRpgZpcVWRm,cplhhHpmcVWRm(6,6),cplhhcVWRmVWLm(6),cplhhcVWRmVWRm(6),& 
& cplHpmcVWRmVP(6),cplHpmcVWRmVZ(6),cplHpmcVWRmVZR(6),cplHppmmcHpmcVWRm(2,6),            & 
& cplHppmmcVWLmcVWRm(2),cplHppmmcVWRmcVWRm(2),cplcVWRmVPVWLm,cplcVWRmVPVWRm,             & 
& cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplAhAhcVWRmVWRm(6,6),   & 
& cplhhhhcVWRmVWRm(6,6),cplHpmcHpmcVWRmVWRm(6,6),cplHppmmcHppmmcVWRmVWRm(2,2),           & 
