...
& gTAh,gThh,gTHm,gTVWm,gTVZ,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,gFuFdcFeFv,gFuFuFvFv,       & 
...
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,              & 
& cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,        & 
& cplcFuFdHmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,               & 
& cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,deltaM)
...
gFuFdcFeFvi = 0._dp 
Call FuToFdcFeFv(i_run,MFd,MFe,MFv,MVWm,MHm,MFu,cplcFeFvcHmL,cplcFeFvcHmR,            & 
...
& NVSss,NVVss,gTVWmtemp,gTHmtemp,deltaM,epsI,check,gFuFdcFeFvi)
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MVZ,MVWm,MHm(3),MAh(2),Mhh(2)
...
coup(2) = Conjg(cplcFuFdHmL(iIN,gt3,i1)) 
coup(1) = Conjg(cplcFuFdHmR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFdFucHmL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFdFucHmR(gt2,gt1,i1))
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFuFuVZL(iIN,gt1) 
coup2(2) = cplcFuFuVZR(iIN,gt1) 
coup2(3) = Conjg(cplcFuFdHmL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplcFuFdHmR(iIN,gt3,i2))  
coup2(5) = cplcFdFdVZL(gt2,gt3) 
coup2(6) = cplcFdFdVZR(gt2,gt3) 
coup2(7) = Conjg(cplcFdFucHmL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFdFucHmR(gt2,gt1,i2)) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: VZ,Hm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: conj[VWm],Hm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFuFdHmL(iIN,gt3,i1) 
coup2(2) = cplcFuFdHmR(iIN,gt3,i1) 
coup2(3) = Conjg(cplcFuFdHmL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplcFuFdHmR(iIN,gt3,i2))  
coup2(5) = cplcFdFucHmL(gt2,gt1,i1) 
coup2(6) = cplcFdFucHmR(gt2,gt1,i1) 
coup2(7) = Conjg(cplcFdFucHmL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFdFucHmR(gt2,gt1,i2)) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hm,Hm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hm,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hm,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FuToFdcFeFv(iIN,MFd,MFe,MFv,MVWm,MHm,MFu,cplcFeFvcHmL,cplcFeFvcHmR,        & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,cplcFuFdHmR,         & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MFv(3),MVWm,MHm(3),MFu(3)
...
coup(2) = Conjg(cplcFuFdHmL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcFuFdHmR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFeFvcHmL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFeFvcHmR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: Hm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcFuFdHmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFuFdHmR(iIN,gt1,i2))  
coup2(5) = cplcFeFvVWmL(gt2,gt3) 
coup2(6) = cplcFeFvVWmR(gt2,gt3) 
coup2(7) = Conjg(cplcFeFvcHmL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFeFvcHmR(gt2,gt3,i2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: conj[VWm],Hm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFuFdHmL(iIN,gt1,i1) 
coup2(2) = cplcFuFdHmR(iIN,gt1,i1) 
coup2(3) = Conjg(cplcFuFdHmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFuFdHmR(iIN,gt1,i2))  
coup2(5) = cplcFeFvcHmL(gt2,gt3,i1) 
coup2(6) = cplcFeFvcHmR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFeFvcHmL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFeFvcHmR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: Hm,Hm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
