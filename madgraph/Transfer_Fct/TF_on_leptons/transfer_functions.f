...
C
      ...
      include 'TF_param.inc'     
        ...
        prov1=(p_elec_e_1+p_elec_e_2*dsqrt(pexp(0))+p_elec_e_3*pexp(0))    !biais
        prov2=(p_elec_e_4+p_elec_e_5*dsqrt(pexp(0))+p_elec_e_6*pexp(0))    !sigma
c
c       secondly we define the transfer function
c
        tf_e_e=1d0/dsqrt(2d0*pi)/prov2*exp(-(p(0)-pexp(0)-
     &prov1)**2/2d0/prov2**2)         !first gaussian
...
C
      ...
      include 'TF_param.inc'     
        ...
        prov1=(p_muon_e_1+p_muon_e_2*dsqrt(pexp(0))+p_muon_e_3*pexp(0))    !biais
        prov2=(p_muon_e_4+p_muon_e_5*dsqrt(pexp(0))+p_muon_e_6*pexp(0))    !sigma
c
c       secondly we define the transfer function
c
        tf_e_m=1d0/dsqrt(2d0*pi)/prov2*exp(-(p(0)-pexp(0)-
     &prov1)**2/2d0/prov2**2)         !first gaussian
...
C
      ...
      include 'TF_param.inc'     
        ...
        prov1=(p_tau_e_1+p_tau_e_2*dsqrt(pexp(0))+p_tau_e_3*pexp(0))    !biais
        prov2=(p_tau_e_4+p_tau_e_5*dsqrt(pexp(0))+p_tau_e_6*pexp(0))    !sigma
c
c       secondly we define the transfer function
c
        tf_e_t=1d0/dsqrt(2d0*pi)/prov2*exp(-(p(0)-pexp(0)-
     &prov1)**2/2d0/prov2**2)         !first gaussian
...
C
      ...
      include 'TF_param.inc'     
        ...
        sigma_e_e=(p_elec_e_4+p_elec_e_5*dsqrt(pexp(0))+p_elec_e_6*pexp(0))
...
C
      ...
      include 'TF_param.inc'     
        ...
        sigma_e_m=(p_muon_e_4+p_muon_e_5*dsqrt(pexp(0))+p_muon_e_6*pexp(0))
...
C
      ...
      include 'TF_param.inc'     
        ...
        sigma_e_t=5d0*(p_tau_e_4+p_tau_e_5*dsqrt(pexp(0))+p_tau_e_6*pexp(0))
