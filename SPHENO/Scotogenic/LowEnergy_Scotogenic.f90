...
Subroutine Gminus2(Ifermion,MAh,MAh2,MChi,MChi2,Metp,Metp2,MFe,MFe2,MFv,              & 
& MFv2,Mhh,Mhh2,MHp,MHp2,cplcFeFeAhL,cplcFeFeAhR,cplChiFeetpL,cplChiFeetpR,              & 
& cplcFeChicetpL,cplcFeChicetpR,cpletpcetpVP,cplFvFeHpL,cplFvFeHpR,cplcFeFehhL,          & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFvcHpL,cplcFeFvcHpR,cplHpcHpVP,a_mu)

Real(dp),Intent(in)  :: MAh,MAh2,MChi(3),MChi2(3),Metp,Metp2,MFe(3),MFe2(3),MFv(3),MFv2(3),Mhh,               & 
& Mhh2,MHp,MHp2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplChiFeetpL(3,3),cplChiFeetpR(3,3),cplcFeChicetpL(3,3),& 
& cplcFeChicetpR(3,3),cpletpcetpVP,cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplcFeFehhL(3,3),     & 
& cplcFeFehhR(3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),& 
& cplHpcHpVP
...
chargefactor = 1 
Do i1= 1,3
  If ((MChi2(i1).gt.mz2).Or.(Metp2.gt.mz2).Or.(Metp2.gt.mz2)) Then
coup1L = cplcFeChicetpL(gt1,i1)
coup1R = cplcFeChicetpR(gt1,i1)
coup2L = cplChiFeetpL(i1,gt2)
coup2R = cplChiFeetpR(i1,gt2)
ratio = Metp2/MChi2(i1)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
Subroutine LeptonEDM(Ifermion,MAh,MAh2,MChi,MChi2,Metp,Metp2,MFe,MFe2,MFv,            & 
& MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplChiFeetpL,       & 
& cplChiFeetpR,cplcFeChicetpL,cplcFeChicetpR,cpletpcetpVP,cplFvFeHpL,cplFvFeHpR,         & 
...
Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplChiFeetpL(3,3),cplChiFeetpR(3,3),cplcFeChicetpL(3,3),& 
& cplcFeChicetpR(3,3),cpletpcetpVP,cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3),     & 
& cplFvFeVWpR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),  & 
...
& MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhcVWpVWp,       & 
& cplAhAhVZVZ,cplAhhhVZ,cplAhHpcVWp,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,               & 
& cplcFdFucVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFuFuVZL,         & 
...
End Function C1C2 
End Module LowEnergy_Scotogenic 
