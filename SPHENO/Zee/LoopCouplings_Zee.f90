...
Implicit None 
Complex(dp),Intent(in) :: ratFd(3),ratFe(3),ratFu(3),ratHm(3),ratVWm

Real(dp),Intent(in) :: MFd(3),MFe(3),MFu(3),MVWm,MHm(3)
...
Subroutine CoupHiggsToPhotonSM(mHiggs,MFd,MFe,MFu,MVWm,MHm,gNLO,coup)
...
Subroutine CoupPseudoHiggsToPhotonSM(mHiggs,MFd,MFe,MFu,MVWm,MHm,gNLO,coup)
