...
! ------------------------------------------------------------------------------  
! File created at 17:16 on 20.5.2016   
! ----------------------------------------------------------------------  
...
Use RunSM_Zee
Use LowEnergy_Zee
Use FlavorKit_LFV_Zee
Use FlavorKit_QFV_Zee
Use FlavorKit_Observables_Zee
Use Mathematics
Use Model_Data_Zee
Use Tadpoles_Zee 
 Use HiggsCS_Zee
...
& ZZ,alphaH,betaH,vd,vu,g1,g2,g3,Lam6,Lam5,Lam7,Lam10,Lam1,Lam4,Lam3,Lam2,               & 
& Lam8,Lam9,Lamh,epsU,Yu,Yd,Ye,epsD,epsE,Yh,Mu,M12,M112,M222,Mh,kont)
...
Call CalculateLowEnergyConstraints(g1,g2,g3,Lam6,Lam5,Lam7,Lam10,Lam1,Lam4,           & 
& Lam3,Lam2,Lam8,Lam9,Lamh,epsU,Yu,Yd,Ye,epsD,epsE,Yh,Mu,M12,M112,M222,Mh,               & 
& vd,vu,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,BrDmunu,               & 
...
& Lam5input,Lam7input,Lam10input,Lam1input,Lam4input,Lam3input,Lam2input,Lam8input,      & 
& Lam9input,Lamhinput,epsUinput,Yuinput,Ydinput,Yeinput,epsDinput,epsEinput,             & 
& Yhinput,Muinput,M12input,M112input,M222input,Mhinput,vdinput,vuinput,ae,               & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,Lam6input,Lam5input,Lam7input,Lam10input,Muinput,             & 
& M12input,vdinput,vuinput

Complex(dp),Intent(inout) :: Lam1input,Lam4input,Lam3input,Lam2input,Lam8input,Lam9input,Lamhinput,epsUinput(3,3), & 
...
Complex(dp) :: cplAhAhcVWmVWm(2,2),cplAhAhhh(2,2,2),cplAhAhVZVZ(2,2),cplAhcHmcVWm(2,3),              & 
& cplAhhhVZ(2,2),cplAhHmcHm(2,3,3),cplAhHmVWm(2,3),cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),& 
...
& cplcFdFucHmR(3,3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFeFeAhL(3,3,2),            & 
...
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),             & 
...
& cplcHmcVWmVP(3),cplcHmcVWmVZ(3),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,& 
...
& cplFvFeHmL(3,3,3),cplFvFeHmR(3,3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplhhcHmcVWm(2,3), & 
& cplhhcVWmVWm(2),cplhhhhcVWmVWm(2,2),cplhhhhhh(2,2,2),cplhhhhVZVZ(2,2),cplhhHmcHm(2,3,3),& 
& cplhhHmVWm(2,3),cplhhVZVZ(2),cplHmcHmcVWmVWm(3,3),cplHmcHmVP(3,3),cplHmcHmVZ(3,3),     & 
& cplHmcHmVZVZ(3,3),cplHmVPVWm(3),cplHmVWmVZ(3),cplVGVGVG
...
& Lam7input,Lam10input,Lam1input,Lam4input,Lam3input,Lam2input,Lam8input,Lam9input,      & 
& Lamhinput,epsUinput,Yuinput,Ydinput,Yeinput,epsDinput,epsEinput,Yhinput,               & 
& Muinput,M12input,M112input,M222input,Mhinput,vdinput,vuinput,g1,g2,g3,Lam6,            & 
& Lam5,Lam7,Lam10,Lam1,Lam4,Lam3,Lam2,Lam8,Lam9,Lamh,epsU,Yu,Yd,Ye,epsD,epsE,            & 
& Yh,Mu,M12,M112,M222,Mh,vd,vu,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHm(1)=MVWm
MHm2(1)=MVWm2
Call AllCouplings(Lam6,Lam5,Lam7,Lam1,Lam4,Lam3,Lam2,vd,vu,ZH,ZA,Mu,ZP,               & 
& Lam10,Lam8,Lam9,g1,g2,TW,g3,Yd,epsD,ZDL,ZDR,Ye,epsE,ZEL,ZER,epsU,Yu,ZUL,               & 
& ZUR,Yh,UV,cplAhAhhh,cplAhHmcHm,cplhhhhhh,cplhhHmcHm,cplAhhhVZ,cplAhHmVWm,              & 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhcHmcVWm,        & 
& cplAhhhVZ,cplAhHmcHm,cplAhHmVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,       & 
...
& cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVP,cplcHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,           & 
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,BOddllSLL(gt1,gt2,gt3,gt4),BOddllSRR(gt1,gt2,gt3,gt4)            & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,PSOddllSLL(gt1,gt2,gt3,gt4),PSOddllSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,PVOddllSLL(gt1,gt2,gt3,gt4),PVOddllSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,TSOddllSLL(gt1,gt2,gt3,gt4),TSOddllSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,TVOddllSLL(gt1,gt2,gt3,gt4),TVOddllSRR(gt1,gt2,gt3,gt4)          & 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVZ,cplcFdFdAhL,         & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHmL,              & 
& cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,           & 
& cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,        & 
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,BOddvvVRR(gt1,gt2,gt3,gt4),BOddvvVLL(gt1,gt2,gt3,gt4),BOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVZ,cplcFdFdAhL,    & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHmL,              & 
& cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,           & 
& cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,        & 
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,PSOddvvVRR(gt1,gt2,gt3,gt4),PSOddvvVLL(gt1,gt2,gt3,gt4),PSOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,PVOddvvVRR(gt1,gt2,gt3,gt4),PVOddvvVLL(gt1,gt2,gt3,gt4),PVOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,TSOddvvVRR(gt1,gt2,gt3,gt4),TSOddvvVLL(gt1,gt2,gt3,gt4),TSOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,TVOddvvVRR(gt1,gt2,gt3,gt4),TVOddvvVLL(gt1,gt2,gt3,gt4),TVOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhcHmcVWm,cplAhhhVZ,cplAhHmcHm,     & 
& cplAhHmVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,    & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHmL,cplcFdFucHmR,             & 
...
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVP,cplcHmcVWmVZ,             & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,              & 
& cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,BO4dSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVP,cplcHmcVWmVZ,             & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,              & 
& cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,TSO4dSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVP,cplcHmcVWmVZ,             & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,              & 
& cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,TVO4dSLL(gt1,gt2,gt3,gt4)& 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhcHmcVWm,cplAhhhVZ,cplAhHmcHm,              & 
& cplAhHmVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,    & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHmL,cplcFdFucHmR,             & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,cplcFuFdHmR,         & 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhcHmcVWm,cplAhHmcHm,       & 
& cplAhHmVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,    & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHmL,cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,           & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,           & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,cplcFuFdHmR,cplcFuFuAhL,cplcFuFuAhR,           & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcHmcVWmVP,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,           & 
& cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmVWm,      & 
& cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,TSOdulvSLL(gt1,gt2,gt3,gt4),               & 
...
& cplcHmcVWmVP,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,           & 
& cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmVWm,      & 
& cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,TVOdulvSLL(gt1,gt2,gt3,gt4),               & 
...
& cplcFdFucHmL,cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFdHmL,cplcFuFdHmR,cplcFuFuVPL,cplcFuFuVPR,cplcHmcVWmVP,cplcVWmVPVWm,             & 
& cplHmcHmVP,cplHmVPVWm,OA2qSL(gt1,gt2),OA2qSR(gt1,gt2),OA2qVL(gt1,gt2),OA2qVR(gt1,gt2))
...
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFdFucHmL,cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFdHmL,cplcFuFdHmR,cplcFuFuVGL,cplcFuFuVGR,OG2qSL(gt1,gt2),OG2qSR(gt1,gt2))
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFdFdAhL,cplcFdFdAhR,              & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHmL,cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,           & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,cplcFuFdHmR,cplcFuFuhhL,cplcFuFuhhR,           & 
& cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,OH2qSL(gt1,gt2,gt3)& 
& ,OH2qSR(gt1,gt2,gt3))
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,BOddllSLLSM(gt1,gt2,gt3,gt4),BOddllSRRSM(gt1,gt2,gt3,gt4)        & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,PSOddllSLLSM(gt1,gt2,gt3,gt4),PSOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,PVOddllSLLSM(gt1,gt2,gt3,gt4),PVOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,TSOddllSLLSM(gt1,gt2,gt3,gt4),TSOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,TVOddllSLLSM(gt1,gt2,gt3,gt4),TVOddllSRRSM(gt1,gt2,gt3,gt4)      & 
...
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,BOddvvVRRSM(gt1,gt2,gt3,gt4),BOddvvVLLSM(gt1,gt2,gt3,gt4),BOddvvVRLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,PSOddvvVRRSM(gt1,gt2,gt3,gt4),PSOddvvVLLSM(gt1,gt2,gt3,gt4),PSOddvvVRLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,PVOddvvVRRSM(gt1,gt2,gt3,gt4),PVOddvvVLLSM(gt1,gt2,gt3,gt4),PVOddvvVRLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,TSOddvvVRRSM(gt1,gt2,gt3,gt4),TSOddvvVLLSM(gt1,gt2,gt3,gt4),TSOddvvVRLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdHmR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,TVOddvvVRRSM(gt1,gt2,gt3,gt4),TVOddvvVLLSM(gt1,gt2,gt3,gt4),TVOddvvVRLSM(gt1,gt2,gt3,gt4)& 
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhcHmcVWm,cplAhhhVZ,cplAhHmcHm,         & 
& cplAhHmVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,    & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHmL,cplcFdFucHmR,             & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,cplcFuFdHmR,         & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVP,cplcHmcVWmVZ,             & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,              & 
& cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,BO4dSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVP,cplcHmcVWmVZ,             & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,              & 
& cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,TSO4dSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcHmcVWmVP,cplcHmcVWmVZ,             & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,              & 
& cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,TVO4dSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcHmcVWmVP,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,           & 
& cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmVWm,      & 
& cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,TSOdulvSLLSM(gt1,gt2,gt3,gt4)              & 
...
& cplcHmcVWmVP,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,           & 
& cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmVWm,      & 
& cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,TVOdulvSLLSM(gt1,gt2,gt3,gt4)              & 
...
& cplcFdFucHmL,cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFdHmL,cplcFuFdHmR,cplcFuFuVPL,cplcFuFuVPR,cplcHmcVWmVP,cplcVWmVPVWm,             & 
& cplHmcHmVP,cplHmVPVWm,OA2qSLSM(gt1,gt2),OA2qSRSM(gt1,gt2),OA2qVLSM(gt1,gt2)            & 
& ,OA2qVRSM(gt1,gt2))
...
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFdFucHmL,cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFdHmL,cplcFuFdHmR,cplcFuFuVGL,cplcFuFuVGR,OG2qSLSM(gt1,gt2),OG2qSRSM(gt1,gt2))
...
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFucHmL,cplcFdFucHmR,cplcFdFuVWmL,cplcFdFuVWmR,           & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,cplcFuFdHmR,cplcFuFuhhL,cplcFuFuhhR,           & 
& cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,OH2qSLSM(gt1,gt2,gt3)& 
...
& Muinput,M12input,M112input,M222input,Mhinput,vdinput,vuinput,g1,g2,g3,Lam6,            & 
& Lam5,Lam7,Lam10,Lam1,Lam4,Lam3,Lam2,Lam8,Lam9,Lamh,epsU,Yu,Yd,Ye,epsD,epsE,            & 
& Yh,Mu,M12,M112,M222,Mh,vd,vu,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,BOllddSLL(gt1,gt2,gt3,gt4),BOllddSRR(gt1,gt2,gt3,gt4)            & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,PSOllddSLL(gt1,gt2,gt3,gt4),PSOllddSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,PVOllddSLL(gt1,gt2,gt3,gt4),PVOllddSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,TSOllddSLL(gt1,gt2,gt3,gt4),TSOllddSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,TVOllddSLL(gt1,gt2,gt3,gt4),TVOllddSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,BOlluuSLL(gt1,gt2,gt3,gt4),BOlluuSRR(gt1,gt2,gt3,gt4)            & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,PSOlluuSLL(gt1,gt2,gt3,gt4),PSOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,PVOlluuSLL(gt1,gt2,gt3,gt4),PVOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,TSOlluuSLL(gt1,gt2,gt3,gt4),TSOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,    & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,          & 
& cplHmVPVWm,cplHmVWmVZ,TVOlluuSLL(gt1,gt2,gt3,gt4),TVOlluuSRR(gt1,gt2,gt3,gt4)          & 
...
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhcHmcVWm,cplAhhhVZ,cplAhHmcHm,     & 
& cplAhHmVWm,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,    & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,           & 
& cplcHmcVWmVP,cplcHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplFvFecVWmL,cplFvFecVWmR,         & 
& cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,       & 
& cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,cplHmVWmVZ,           & 
...
& MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhcHmcVWm,cplAhhhVZ,           & 
& cplAhHmcHm,cplAhHmVWm,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,     & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,cplcFeFvcHmR,cplcFeFvVWmL,            & 
& cplcFeFvVWmR,cplcHmcVWmVP,cplcHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplFvFecVWmL,         & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,    & 
& cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,            & 
& cplHmVWmVZ,BO4lSLLcross(gt1,gt2,gt3,gt4),BO4lSRRcross(gt1,gt2,gt3,gt4),BO4lSRLcross(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,    & 
& cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,            & 
& cplHmVWmVZ,PSO4lSLLcross(gt1,gt2,gt3,gt4),PSO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,    & 
& cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,            & 
& cplHmVWmVZ,PVO4lSLLcross(gt1,gt2,gt3,gt4),PVO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,    & 
& cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,            & 
& cplHmVWmVZ,TSO4lSLLcross(gt1,gt2,gt3,gt4),TSO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,    & 
& cplhhhhhh,cplhhHmcHm,cplhhHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmVPVWm,            & 
& cplHmVWmVZ,TVO4lSLLcross(gt1,gt2,gt3,gt4),TVO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,     & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,cplcFeFvcHmR,             & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcHmcVWmVP,cplcVWmVPVWm,cplFvFecVWmL,cplFvFecVWmR,         & 
& cplFvFeHmL,cplFvFeHmR,cplHmcHmVP,cplHmVPVWm,OA2lSL(gt1,gt2),OA2lSR(gt1,gt2)            & 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHmL,cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplFvFecVWmL,cplFvFecVWmR,         & 
& cplFvFeHmL,cplFvFeHmR,cplhhcHmcVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmVWm,       & 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,            & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,              & 
& cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcHmcVWmVZ,cplcVWmVWmVZ,cplFvFecVWmL,         & 
& cplFvFecVWmR,cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmVWmVZ,OZ2lSL(gt1,gt2),OZ2lSR(gt1,gt2),OZ2lVL(gt1,gt2),OZ2lVR(gt1,gt2))
...
Call Gminus2(1,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplFvFeHmL,cplFvFeHmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,     & 
& cplcFeFvcHmL,cplcFeFvcHmR,cplHmcHmVP,ae)

Call Gminus2(2,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplFvFeHmL,cplFvFeHmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,     & 
& cplcFeFvcHmL,cplcFeFvcHmR,cplHmcHmVP,amu)

Call Gminus2(3,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplFvFeHmL,cplFvFeHmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,     & 
& cplcFeFvcHmL,cplcFeFvcHmR,cplHmcHmVP,atau)


! *****  Lepton EDM ***** 

Call LeptonEDM(1,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,             & 
& MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHmL,cplFvFeHmR,cplFvFecVWmL,cplFvFecVWmR,      & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFeFvcHmL,cplcFeFvcHmR,cplHmcHmVP,cplcVWmVPVWm,EDMe)

Call LeptonEDM(2,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,             & 
& MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHmL,cplFvFeHmR,cplFvFecVWmL,cplFvFecVWmR,      & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFeFvcHmL,cplcFeFvcHmR,cplHmcHmVP,cplcVWmVPVWm,EDMmu)

Call LeptonEDM(3,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,             & 
& MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHmL,cplFvFeHmR,cplFvFecVWmL,cplFvFecVWmR,      & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFeFvcHmL,cplcFeFvcHmR,cplHmcHmVP,cplcVWmVPVWm,EDMtau)
...
Call DeltaRho(MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,              & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhcHmcVWm,cplAhhhVZ,            & 
...
& cplcgWpCgZcVWm,cplcgZgWmcVWm,cplcHmcVWmVP,cplcHmcVWmVZ,cplcVWmcVWmVWmVWm1,             & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFvVZL,cplFvFvVZR,cplhhcHmcVWm,cplhhcVWmVWm,             & 
& cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhVZVZ,cplHmcHmcVWmVWm,cplHmcHmVZ,cplHmcHmVZVZ,          & 
& cplHmVWmVZ,dRho)
