...
Module InputOutput_SMHighScale 
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - SM/HighScale Spectrum + Decays + Flavor Observables"
...
If (HighScaleModel.Eq."LOW") Then 
 Write(io_L,110)  1,0, " Renormalization Scale input"
Else  
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,7:141)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,7:141)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,7:141)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.SMHighScale",status="unknown")
...
End Module InputOutput_SMHighScale 
