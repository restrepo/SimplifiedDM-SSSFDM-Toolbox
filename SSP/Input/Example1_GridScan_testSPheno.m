...
LoadSettings="DefaultSettings.m.SPheno";

(* Several scans can be done in a row. Give each one a name... *)
RunScans = {ScanM0spheno,ScanM12spheno,ScanM0M12spheno};
...
DEFINITION[ScanM0spheno][MINPAR]={
...
DEFINITION[ScanM12spheno][MINPAR]={
  {{1}, {Value->2*MINPAR[2]}},
...
DEFINITION[ScanM0M12spheno][MINPAR]={
  {{1}, {Min->0,Max->1000, Steps->10,Distribution->LINEAR}},
  {{2}, {Min->0,Max->1000, Steps->10,Distribution->LINEAR}},
  {{3}, {Value->10}},
  {{4}, {Value->1}},
...
DEFINITION[ScanM12spheno][Plots]={
...
DEFINITION[ScanM0M12spheno][Plots]={
