...
{\tt photon/posi/pbarFluxTab} routines. Until one keeps default setting  {\tt CDM1=CDM2=NULL} these routines will use {\tt Mcdm} parameter to calculate number density of {\tt DM} particles. 
