...
Module Model_Data_SimplifiedDMT13A 
...
Complex(dp) :: LamIN,YuIN(3,3),YdIN(3,3),YeIN(3,3),MDFIN,mu2IN

Real(dp) :: g1MZ,g2MZ,g3MZ

Complex(dp) :: LamMZ,YuMZ(3,3),YdMZ(3,3),YeMZ(3,3),MDFMZ,mu2MZ

Real(dp) :: g1GUT,g2GUT,g3GUT

Complex(dp) :: LamGUT,YuGUT(3,3),YdGUT(3,3),YeGUT(3,3),MDFGUT,mu2GUT
...
Real(dp) :: gPFu(3,153),gTFu(3),BRFu(3,153),gPhh(1,34),gThh,BRhh(1,34),gPNv0(1,20),               & 
...
End Module Model_Data_SimplifiedDMT13A