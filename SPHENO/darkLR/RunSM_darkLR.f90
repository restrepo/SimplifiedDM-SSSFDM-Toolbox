...
Contains 
 ...
 Subroutine RunSM_and_SUSY_RGEs(Qout,gBLinput,g2input,gRinput,g3input,alpinput,        & 
...
& MU12,mul2,mur2,v1,v2,vtl,vtr,vhl,vhr,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(161), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG161(gBLinput,g2input,gRinput,g3input,alpinput,RHO2input,            & 
...
& v1input,v2input,vtlinput,vtrinput,vhlinput,vhrinput,g1D)

Call GToParameters161(g1D,gBL,g2,gR,g3,alp,RHO2,RHO1,rh3,ALP3,ALP1,LAM1,              & 
