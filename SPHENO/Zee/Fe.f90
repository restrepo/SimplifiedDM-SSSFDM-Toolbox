...
& gTAh,gThh,gTHm,gTVWm,gTVZ,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFeFvFv,gFeFvcFuFd,       & 
...
Real(dp) :: gFeFecFdFdi(3,3,3),gFeFecFeFei(3,3,3),gFeFecFuFui(3,3,3),gFeFeFvFvi(3,3,3),           & 
& gFeFvcFuFdi(3,3,3)
...
& cplcFeFeVZR,cplcFeFvcHmL,cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcVWmL,         & 
...
gFeFeFvFvi = 0._dp 
Call FeToFeFvFv(i_run,MFe,MFv,MVZ,MVWm,MHm,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHmL,      & 
& cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFeHmL,           & 
& cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,      & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,               & 
& NVSss,NVSst,NVVss,NVVst,gTVZtemp,gTVWmtemp,gTHmtemp,deltaM,epsI,check,gFeFeFvFvi)

gFeFeFvFv(i_run,:,:,:) = gFeFeFvFvi 
gT(i_run) = gT(i_run) + Sum(gFeFeFvFvi) 
 
gFeFvcFuFdi = 0._dp 
Call FeToFvcFuFd(i_run,MFv,MFu,MFd,MVWm,MHm,MFe,cplcFeFvcHmL,cplcFeFvcHmR,            & 
...
Subroutine FeToFeFvFv(iIN,MFe,MFv,MVZ,MVWm,MHm,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHmL,cplcFeFvcHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplFvFecVWmL,cplFvFecVWmR,         & 
& cplFvFeHmL,cplFvFeHmR,cplFvFvVZL,cplFvFvVZR,IntegralSs,IntegralSSss,IntegralSSst,      & 
& IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,NVVst,gTVZ,gTVWm,gTHm,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MFv(3),MVZ,MVWm,MHm(3)

Complex(dp),Intent(in) :: cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvcHmL(3,3,3),cplcFeFvcHmR(3,3,3),            & 
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplFvFecVWmL(3,3),cplFvFecVWmR(3,3),               & 
& cplFvFeHmL(3,3,3),cplFvFeHmR(3,3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3)
...
Real(dp),Intent(inout) :: gTVZ,gTVWm,gTHm(3)
...
coup(2) = Conjg(cplcFeFvcHmL(iIN,gt2,i1)) 
coup(1) = Conjg(cplcFeFvcHmR(iIN,gt2,i1)) 
coup(4) = Conjg(cplFvFeHmL(gt3,gt1,i1)) 
coup(3) = Conjg(cplFvFeHmR(gt3,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt3.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup(2) = Conjg(cplcFeFvcHmL(iIN,gt3,i1)) 
coup(1) = Conjg(cplcFeFvcHmR(iIN,gt3,i1)) 
coup(4) = Conjg(cplFvFeHmL(gt2,gt1,i1)) 
coup(3) = Conjg(cplFvFeHmR(gt2,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt3.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplcFeFvcHmL(iIN,gt3,i1) 
coup2(2) = cplcFeFvcHmR(iIN,gt3,i1) 
coup2(3) = Conjg(cplcFeFvcHmL(iIN,gt2,i1)) 
coup2(4) = Conjg(cplcFeFvcHmR(iIN,gt2,i1))  
coup2(5) = cplFvFeHmL(gt2,gt1,i1) 
coup2(6) = cplFvFeHmR(gt2,gt1,i1) 
coup2(7) = Conjg(cplFvFeHmL(gt3,gt1,i1)) 
coup2(8) = Conjg(cplFvFeHmR(gt3,gt1,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fv Fv Propagator: conj[Hm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFeFeVZL(iIN,gt1) 
coup2(2) = cplcFeFeVZR(iIN,gt1) 
coup2(3) = Conjg(cplcFeFvcHmL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplcFeFvcHmR(iIN,gt2,i2))  
coup2(5) = cplFvFvVZL(gt2,gt3) 
coup2(6) = cplFvFvVZR(gt2,gt3) 
coup2(7) = Conjg(cplFvFeHmL(gt3,gt1,i2)) 
coup2(8) = Conjg(cplFvFeHmR(gt3,gt1,i2)) 
coupT = coup2(2) 
coup2(2) = coup2(1) 
coup2(1) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
coup2(1) = cplcFeFeVZL(iIN,gt1) 
coup2(2) = cplcFeFeVZR(iIN,gt1) 
coup2(3) = Conjg(cplcFeFvcHmL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplcFeFvcHmR(iIN,gt3,i2))  
coup2(5) = cplFvFvVZL(gt2,gt3) 
coup2(6) = cplFvFvVZR(gt2,gt3) 
coup2(7) = Conjg(cplFvFeHmL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplFvFeHmR(gt2,gt1,i2)) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fv Fv Propagator: VZ,conj[Hm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fv Fv Propagator: VWm,conj[Hm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFeFvcHmL(iIN,gt2,i1) 
coup2(2) = cplcFeFvcHmR(iIN,gt2,i1) 
coup2(3) = Conjg(cplcFeFvcHmL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplcFeFvcHmR(iIN,gt2,i2))  
coup2(5) = cplFvFeHmL(gt3,gt1,i1) 
coup2(6) = cplFvFeHmR(gt3,gt1,i1) 
coup2(7) = Conjg(cplFvFeHmL(gt3,gt1,i2)) 
coup2(8) = Conjg(cplFvFeHmR(gt3,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fe Fv Fv Propagator: conj[Hm],conj[Hm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FeToFvcFuFd(iIN,MFv,MFu,MFd,MVWm,MHm,MFe,cplcFeFvcHmL,cplcFeFvcHmR,        & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFdHmL,cplcFuFdHmR,         & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFv(3),MFu(3),MFd(3),MVWm,MHm(3),MFe(3)

Complex(dp),Intent(in) :: cplcFeFvcHmL(3,3,3),cplcFeFvcHmR(3,3,3),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),          & 
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFdHmL(3,3,3),cplcFuFdHmR(3,3,3)
...
coup(2) = Conjg(cplcFeFvcHmL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcFeFvcHmR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFuFdHmL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFuFdHmR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFu Fd Propagator: conj[Hm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcFeFvcHmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFeFvcHmR(iIN,gt1,i2))  
coup2(5) = cplcFuFdcVWmL(gt2,gt3) 
coup2(6) = cplcFuFdcVWmR(gt2,gt3) 
coup2(7) = Conjg(cplcFuFdHmL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFuFdHmR(gt2,gt3,i2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFu Fd Propagator: VWm,conj[Hm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFeFvcHmL(iIN,gt1,i1) 
coup2(2) = cplcFeFvcHmR(iIN,gt1,i1) 
coup2(3) = Conjg(cplcFeFvcHmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFeFvcHmR(iIN,gt1,i2))  
coup2(5) = cplcFuFdHmL(gt2,gt3,i1) 
coup2(6) = cplcFuFdHmR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFuFdHmL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFuFdHmR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fe->Fv cFu Fd Propagator: conj[Hm],conj[Hm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
