...
Module SusyDecays_Scotogenic
 
Use Control 
Use DecayFunctions 
Use LoopCouplings_Scotogenic 
Use CouplingsForDecays_Scotogenic 
...
Subroutine FuTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,            & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)

Implicit None 
 
Real(dp),Intent(in) :: g1,g2,g3,lam5,v,MAh,MAh2,MChi(3),MChi2(3),MetI,MetI2,Metp,Metp2,MetR,MetR2,           & 
& MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(3),MFv2(3),Mhh,Mhh2,MHp,              & 
& MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZZ(2,2)

Complex(dp),Intent(in) :: lam1,lam2,lam4,lam3,Yn(3,3),Yu(3,3),Yd(3,3),Ye(3,3),Mn(3,3),mH2,mEt2,ZDR(3,3),        & 
& ZER(3,3),ZUR(3,3),ZDL(3,3),ZEL(3,3),ZUL(3,3),UV(3,3),ZW(2,2),ZX(3,3)
...
Call CouplingsFor_Fu_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,        & 
...
Subroutine FeTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,            & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
Complex(dp) :: cplcFeChicetpL(3,3),cplcFeChicetpR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),            & 
...
m_in = MFe(i1) 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_Fe_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplcFeChicetpL,cplcFeChicetpR,cplcFeFehhL,    & 
...
m1out = MChi(gt1)
m2out = Metp
coupL = cplcFeChicetpL(i1,gt1)
coupR = cplcFeChicetpR(i1,gt1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Subroutine FdTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,            & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
m_in = MFd(i1) 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_Fd_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,          & 
...
Subroutine FvTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,            & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
Complex(dp) :: cplChiFvetIL(3,3),cplChiFvetIR(3,3),cplChiFvetRL(3,3),cplChiFvetRR(3,3),              & 
...
m_in = MFv(i1) 
If (m_in.Eq.0._dp) Cycle 
Call CouplingsFor_Fv_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplChiFvetIL,cplChiFvetIR,cplChiFvetRL,       & 
& cplChiFvetRR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,deltaM)
...
m1out = MChi(gt1)
m2out = MetI
coupL = cplChiFvetIL(gt1,i1)
coupR = cplChiFvetIR(gt1,i1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = MChi(gt1)
m2out = MetR
coupL = cplChiFvetRL(gt1,i1)
coupR = cplChiFvetRR(gt1,i1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
Subroutine VZTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,            & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
i1=1 
m_in = MVZ 
Call CouplingsFor_VZ_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cpletIetRVZ,cpletpcetpVZ,cplcFdFdVZL,         & 
& cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,     & 
& cplhhVZVZ,cplcVWpVWpVZ,deltaM)
...
Subroutine VWpTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
i1=1 
m_in = MVWp 
Call CouplingsFor_VWp_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,               & 
& Metp,Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,           & 
& MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,              & 
& lam2,lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cpletIetpcVWp,cpletpetRcVWp,             & 
...
Subroutine hhTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,            & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
i1=1 
m_in = Mhh 
Call CouplingsFor_hh_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,         & 
& cplHiggsWWvirt,cpletIetIhh,cpletphhcetp,cpletRetRhh,cplcFdFdhhL,cplcFdFdhhR,           & 
& cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplhhhhhh,cplhhcVWpVWp,cplhhVZVZ,deltaM)
...
Subroutine etRTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
Complex(dp) :: cplChiFvetRL(3,3),cplChiFvetRR(3,3),cpletIetRVZ,cpletpetRcVWp,cpletRetRhh
...
i1=1 
m_in = MetR 
Call CouplingsFor_etR_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,               & 
& Metp,Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,           & 
& MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,              & 
& lam2,lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplChiFvetRL,cplChiFvetRR,               & 
& cpletIetRVZ,cpletpetRcVWp,cpletRetRhh,deltaM)
...
m1out = MFv(gt1)
m2out = MChi(gt2)
coupL = cplChiFvetRL(gt2,gt1)
coupR = cplChiFvetRR(gt2,gt1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
Subroutine etITwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
Complex(dp) :: cplChiFvetIL(3,3),cplChiFvetIR(3,3),cpletIetIhh,cpletIetpcVWp,cpletIetRVZ
...
& Metp,Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,           & 
& MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,              & 
& lam2,lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplChiFvetIL,cplChiFvetIR,               & 
& cpletIetIhh,cpletIetpcVWp,cpletIetRVZ,deltaM)
...
m1out = MFv(gt1)
m2out = MChi(gt2)
coupL = cplChiFvetIL(gt2,gt1)
coupR = cplChiFvetIR(gt2,gt1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
Subroutine etpTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
Complex(dp) :: cplcFeChicetpL(3,3),cplcFeChicetpR(3,3),cpletIcetpVWp,cpletphhcetp,cpletpcetpVZ,      & 
& cpletRcetpVWp
...
i1=1 
m_in = Metp 
Call CouplingsFor_etp_decays_2B(m_in,i1,MAh,MAh2,MChi,MChi2,MetI,MetI2,               & 
& Metp,Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,           & 
& MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,              & 
& lam2,lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplcFeChicetpL,cplcFeChicetpR,           & 
& cpletIcetpVWp,cpletphhcetp,cpletpcetpVZ,cpletRcetpVWp,deltaM)
...
m1out = MFe(gt1)
m2out = MChi(gt2)
coupL = cplcFeChicetpL(gt1,gt2)
coupR = cplcFeChicetpR(gt1,gt2)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
Subroutine ChiTwoBodyDecay(i_in,deltaM,MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,           & 
& Metp2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,           & 
& MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,lam2,              & 
& lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,gPartial,gT,BR)
...
Complex(dp) :: cplChiFvetIL(3,3),cplChiFvetIR(3,3),cplChiFeetpL(3,3),cplChiFeetpR(3,3),              & 
...
& MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,g1,g2,g3,lam1,              & 
& lam2,lam4,lam3,lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,v,cplChiFvetIL,cplChiFvetIR,               & 
& cplChiFeetpL,cplChiFeetpR,cplChiFvetRL,cplChiFvetRR,deltaM)
...
m1out = MFv(gt1)
m2out = MetI
coupL = cplChiFvetIL(i1,gt1)
coupR = cplChiFvetIR(i1,gt1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = MFe(gt1)
m2out = Metp
coupL = cplChiFeetpL(i1,gt1)
coupR = cplChiFeetpR(i1,gt1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 2*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = MFv(gt1)
m2out = MetR
coupL = cplChiFvetRL(i1,gt1)
coupR = cplChiFvetRR(i1,gt1)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
End Module SusyDecays_Scotogenic 
