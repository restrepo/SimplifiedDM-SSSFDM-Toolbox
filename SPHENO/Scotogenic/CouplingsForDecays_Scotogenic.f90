...
& MFd,MFe,MFu,MHp,MVWp,rq,rsq,coup)

cplHiggsPP = coup*Alpha 
CoupHPP = coup 
Call CoupHiggsToPhotonSM(m_in,Metp,MFd,MFe,MFu,MHp,MVWp,rq,coup)

ratioPP = Abs(cplHiggsPP/(coup*Alpha))**2 
rq = rsq 
Call CoupHiggsToGluon(m_in,i1,ratFd,ratFu,MFd,MFu,rq,rsq,coup)

cplHiggsGG = coup*AlphaS_MZ 
CoupHGG = coup 
Call CoupHiggsToGluonSM(m_in,MFd,MFu,rq,coup)

coup = coup*Sqrt(1._dp + 12._dp*oo48pi2*(95._dp/4._dp - 7._dp/6._dp*NFlav(m_in)) *g3**2) 
cplHiggsGG = cplHiggsGG*Sqrt(1._dp + 12._dp*oo48pi2*(95._dp/4._dp - 7._dp/6._dp*NFlav(m_in)) *g3**2) 
ratioGG = Abs(cplHiggsGG/(coup*AlphaS_MZ))**2 
!----------------------------------------------------
