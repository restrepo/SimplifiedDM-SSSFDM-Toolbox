...
*/
  ...
  GG=sqrt(4*M_PI*parton_alpha(Q_ren));
  return  sqme22(nsub22,GG,pvect,&err)*convStrFun2(x0,Q_fact,pc1_,pc2_,ppFlag);  
}
...
double hCollider(double Pcm, int pp, double Qren, char * name1,char *name2)
{ 
