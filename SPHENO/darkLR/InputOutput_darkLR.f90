...
InputValueforYL1= .True. 
   ...
   Else If (read_line(7:11).Eq."YQ3IN") Then 
InputValueforyq3= .True. 
    Call ReadMatrixC(99,3,3,yq3IN,0, "yq3IN",kont)

 
   Else If (read_line(7:13).Eq."IMYQ3IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMyq3") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,yq3IN,1, "yq3IN",kont)
...
InputValueforYQ1= .True. 
   ...
   Else If (read_line(7:14).Eq."DARKLRIN") Then 
    Call Read_DARKLRIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."LRINPUTIN") Then 
    Call Read_LRINPUTIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."MUPARSIN") Then 
    Call Read_MUPARSIN(99,0,i_model,set_mod_par,kont) 
...
If (i_par.Eq.1) Then 
If (i_c.Eq.0) gRinput= Cmplx(wert,Aimag(gRinput),dp) 
If (i_c.Eq.1) gRinput= Cmplx(Real(gRinput,dp),wert,dp) 
Else If (i_par.Eq.2) Then 
If (i_c.Eq.0) vtRinput= Cmplx(wert,Aimag(vtRinput),dp) 
If (i_c.Eq.1) vtRinput= Cmplx(Real(vtRinput,dp),wert,dp) 
Else If (i_par.Eq.3) Then 
If (i_c.Eq.0) vHRinput= Cmplx(wert,Aimag(vHRinput),dp) 
If (i_c.Eq.1) vHRinput= Cmplx(Real(vHRinput,dp),wert,dp) 
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) vHLinput= Cmplx(wert,Aimag(vHLinput),dp) 
If (i_c.Eq.1) vHLinput= Cmplx(Real(vHLinput,dp),wert,dp) 
Else If (i_par.Eq.5) Then 
If (i_c.Eq.0) vtLinput= Cmplx(wert,Aimag(vtLinput),dp) 
If (i_c.Eq.1) vtLinput= Cmplx(Real(vtLinput,dp),wert,dp) 
Else If (i_par.Eq.6) Then 
If (i_c.Eq.0) TanBeta= Cmplx(wert,Aimag(TanBeta),dp) 
If (i_c.Eq.1) TanBeta= Cmplx(Real(TanBeta,dp),wert,dp) 
...
If (i_c.Eq.0) rho3INPUT= Cmplx(wert,Aimag(rho3INPUT),dp) 
If (i_c.Eq.1) rho3INPUT= Cmplx(Real(rho3INPUT,dp),wert,dp) 
...
If (i_c.Eq.0) beta2INPUT= Cmplx(wert,Aimag(beta2INPUT),dp) 
If (i_c.Eq.1) beta2INPUT= Cmplx(Real(beta2INPUT,dp),wert,dp) 
Else If (i_par.Eq.17) Then 
If (i_c.Eq.0) etaLLINPUT= Cmplx(wert,Aimag(etaLLINPUT),dp) 
If (i_c.Eq.1) etaLLINPUT= Cmplx(Real(etaLLINPUT,dp),wert,dp) 
Else If (i_par.Eq.18) Then 
If (i_c.Eq.0) etaLRINPUT= Cmplx(wert,Aimag(etaLRINPUT),dp) 
If (i_c.Eq.1) etaLRINPUT= Cmplx(Real(etaLRINPUT,dp),wert,dp) 
Else If (i_par.Eq.19) Then 
If (i_c.Eq.0) etaRLINPUT= Cmplx(wert,Aimag(etaRLINPUT),dp) 
If (i_c.Eq.1) etaRLINPUT= Cmplx(Real(etaRLINPUT,dp),wert,dp) 
Else If (i_par.Eq.20) Then 
If (i_c.Eq.0) etaRRINPUT= Cmplx(wert,Aimag(etaRRINPUT),dp) 
If (i_c.Eq.1) etaRRINPUT= Cmplx(Real(etaRRINPUT,dp),wert,dp) 
Else If (i_par.Eq.21) Then 
If (i_c.Eq.0) etaRR1INPUT= Cmplx(wert,Aimag(etaRR1INPUT),dp) 
If (i_c.Eq.1) etaRR1INPUT= Cmplx(Real(etaRR1INPUT,dp),wert,dp) 
Else If (i_par.Eq.22) Then 
If (i_c.Eq.0) etaRR2INPUT= Cmplx(wert,Aimag(etaRR2INPUT),dp) 
If (i_c.Eq.1) etaRR2INPUT= Cmplx(Real(etaRR2INPUT,dp),wert,dp) 
Else If (i_par.Eq.23) Then 
If (i_c.Eq.0) lamLINPUT= Cmplx(wert,Aimag(lamLINPUT),dp) 
If (i_c.Eq.1) lamLINPUT= Cmplx(Real(lamLINPUT,dp),wert,dp) 
Else If (i_par.Eq.24) Then 
If (i_c.Eq.0) lamRINPUT= Cmplx(wert,Aimag(lamRINPUT),dp) 
If (i_c.Eq.1) lamRINPUT= Cmplx(Real(lamRINPUT,dp),wert,dp) 
Else If (i_par.Eq.25) Then 
If (i_c.Eq.0) lamLRINPUT= Cmplx(wert,Aimag(lamLRINPUT),dp) 
If (i_c.Eq.1) lamLRINPUT= Cmplx(Real(lamLRINPUT,dp),wert,dp) 
Else If (i_par.Eq.26) Then 
If (i_c.Eq.0) betaLINPUT= Cmplx(wert,Aimag(betaLINPUT),dp) 
If (i_c.Eq.1) betaLINPUT= Cmplx(Real(betaLINPUT,dp),wert,dp) 
Else If (i_par.Eq.27) Then 
If (i_c.Eq.0) betaRINPUT= Cmplx(wert,Aimag(betaRINPUT),dp) 
If (i_c.Eq.1) betaRINPUT= Cmplx(Real(betaRINPUT,dp),wert,dp) 
Else If (i_par.Eq.28) Then 
If (i_c.Eq.0) alpINPUT= Cmplx(wert,Aimag(alpINPUT),dp) 
If (i_c.Eq.1) alpINPUT= Cmplx(Real(alpINPUT,dp),wert,dp) 
Else If (i_par.Eq.29) Then 
If (i_c.Eq.0) xiRINPUT= Cmplx(wert,Aimag(xiRINPUT),dp) 
If (i_c.Eq.1) xiRINPUT= Cmplx(Real(xiRINPUT,dp),wert,dp) 
Else If (i_par.Eq.30) Then 
If (i_c.Eq.0) xiLRINPUT= Cmplx(wert,Aimag(xiLRINPUT),dp) 
If (i_c.Eq.1) xiLRINPUT= Cmplx(Real(xiLRINPUT,dp),wert,dp) 
Else
...
Complex(dp) :: PDGAh(6),PDGFd(6),PDGFe(3),PDGFu(3),PDGFv(6),PDGgG,PDGgP,PDGgWLm,PDGgWLmC,            & 
& PDGgWRm,PDGgWRmC,PDGgZ,PDGgZR,PDGhh(6),PDGHpm(6),PDGHppmm(2),PDGVG,PDGVP,              & 
& PDGVWLm,PDGVWRm,PDGVZ,PDGVZR

Character(len=30),Dimension(6):: NameParticleAh
...
Character(len=30),Dimension(6):: NameParticlehh
Character(len=30),Dimension(6):: NameParticleHpm
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - darkLR Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 1, Real(gRinput,dp) ,"# gRinput"
Write(io_L,101) 2, Real(vtRinput,dp) ,"# vtRinput"
Write(io_L,101) 3, Real(vHRinput,dp) ,"# vHRinput"
Write(io_L,101) 4, Real(vHLinput,dp) ,"# vHLinput"
Write(io_L,101) 5, Real(vtLinput,dp) ,"# vtLinput"
Write(io_L,101) 6, Real(TanBeta,dp) ,"# TanBeta"
Write(io_L,101) 10, Real(lam1INPUT,dp) ,"# lam1INPUT"
Write(io_L,101) 11, Real(rho1INPUT,dp) ,"# rho1INPUT"
Write(io_L,101) 12, Real(rho2INPUT,dp) ,"# rho2INPUT"
Write(io_L,101) 13, Real(rho3INPUT,dp) ,"# rho3INPUT"
Write(io_L,101) 14, Real(alp1INPUT,dp) ,"# alp1INPUT"
Write(io_L,101) 15, Real(alp3INPUT,dp) ,"# alp3INPUT"
Write(io_L,101) 16, Real(beta2INPUT,dp) ,"# beta2INPUT"
Write(io_L,101) 17, Real(etaLLINPUT,dp) ,"# etaLLINPUT"
Write(io_L,101) 18, Real(etaLRINPUT,dp) ,"# etaLRINPUT"
Write(io_L,101) 19, Real(etaRLINPUT,dp) ,"# etaRLINPUT"
Write(io_L,101) 20, Real(etaRRINPUT,dp) ,"# etaRRINPUT"
Write(io_L,101) 21, Real(etaRR1INPUT,dp) ,"# etaRR1INPUT"
Write(io_L,101) 22, Real(etaRR2INPUT,dp) ,"# etaRR2INPUT"
Write(io_L,101) 23, Real(lamLINPUT,dp) ,"# lamLINPUT"
Write(io_L,101) 24, Real(lamRINPUT,dp) ,"# lamRINPUT"
Write(io_L,101) 25, Real(lamLRINPUT,dp) ,"# lamLRINPUT"
Write(io_L,101) 26, Real(betaLINPUT,dp) ,"# betaLINPUT"
Write(io_L,101) 27, Real(betaRINPUT,dp) ,"# betaRINPUT"
Write(io_L,101) 28, Real(alpINPUT,dp) ,"# alpINPUT"
Write(io_L,101) 29, Real(xiRINPUT,dp) ,"# xiRINPUT"
Write(io_L,101) 30, Real(xiLRINPUT,dp) ,"# xiLRINPUT"
WriteNextBlock = .False. 
If (Abs(Aimag(gRinput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(vtRinput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(vHRinput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(vHLinput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(vtLinput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(TanBeta)).gt.0._dp) WriteNextBlock = .True. 
...
If (Abs(Aimag(rho3INPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(alp1INPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(alp3INPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(beta2INPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(etaLLINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(etaLRINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(etaRLINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(etaRRINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(etaRR1INPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(etaRR2INPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(lamLINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(lamRINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(lamLRINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(betaLINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(betaRINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(alpINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(xiRINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(xiLRINPUT)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,100) "Block IMMINPAR  # Input parameters"
If (Abs(Aimag(gRinput)).gt.0._dp) Then 
Write(io_L,101) 1, Aimag(gRinput) ,"# gRinput"
End if 
If (Abs(Aimag(vtRinput)).gt.0._dp) Then 
Write(io_L,101) 2, Aimag(vtRinput) ,"# vtRinput"
End if 
If (Abs(Aimag(vHRinput)).gt.0._dp) Then 
Write(io_L,101) 3, Aimag(vHRinput) ,"# vHRinput"
End if 
If (Abs(Aimag(vHLinput)).gt.0._dp) Then 
Write(io_L,101) 4, Aimag(vHLinput) ,"# vHLinput"
End if 
If (Abs(Aimag(vtLinput)).gt.0._dp) Then 
Write(io_L,101) 5, Aimag(vtLinput) ,"# vtLinput"
End if 
If (Abs(Aimag(TanBeta)).gt.0._dp) Then 
Write(io_L,101) 6, Aimag(TanBeta) ,"# TanBeta"
End if 
If (Abs(Aimag(lam1INPUT)).gt.0._dp) Then 
Write(io_L,101) 10, Aimag(lam1INPUT) ,"# lam1INPUT"
End if 
If (Abs(Aimag(rho1INPUT)).gt.0._dp) Then 
Write(io_L,101) 11, Aimag(rho1INPUT) ,"# rho1INPUT"
End if 
If (Abs(Aimag(rho2INPUT)).gt.0._dp) Then 
Write(io_L,101) 12, Aimag(rho2INPUT) ,"# rho2INPUT"
End if 
If (Abs(Aimag(rho3INPUT)).gt.0._dp) Then 
Write(io_L,101) 13, Aimag(rho3INPUT) ,"# rho3INPUT"
End if 
If (Abs(Aimag(alp1INPUT)).gt.0._dp) Then 
Write(io_L,101) 14, Aimag(alp1INPUT) ,"# alp1INPUT"
End if 
If (Abs(Aimag(alp3INPUT)).gt.0._dp) Then 
Write(io_L,101) 15, Aimag(alp3INPUT) ,"# alp3INPUT"
End if 
If (Abs(Aimag(beta2INPUT)).gt.0._dp) Then 
Write(io_L,101) 16, Aimag(beta2INPUT) ,"# beta2INPUT"
End if 
If (Abs(Aimag(etaLLINPUT)).gt.0._dp) Then 
Write(io_L,101) 17, Aimag(etaLLINPUT) ,"# etaLLINPUT"
End if 
If (Abs(Aimag(etaLRINPUT)).gt.0._dp) Then 
Write(io_L,101) 18, Aimag(etaLRINPUT) ,"# etaLRINPUT"
End if 
If (Abs(Aimag(etaRLINPUT)).gt.0._dp) Then 
Write(io_L,101) 19, Aimag(etaRLINPUT) ,"# etaRLINPUT"
End if 
If (Abs(Aimag(etaRRINPUT)).gt.0._dp) Then 
Write(io_L,101) 20, Aimag(etaRRINPUT) ,"# etaRRINPUT"
End if 
If (Abs(Aimag(etaRR1INPUT)).gt.0._dp) Then 
Write(io_L,101) 21, Aimag(etaRR1INPUT) ,"# etaRR1INPUT"
End if 
If (Abs(Aimag(etaRR2INPUT)).gt.0._dp) Then 
Write(io_L,101) 22, Aimag(etaRR2INPUT) ,"# etaRR2INPUT"
End if 
If (Abs(Aimag(lamLINPUT)).gt.0._dp) Then 
Write(io_L,101) 23, Aimag(lamLINPUT) ,"# lamLINPUT"
End if 
If (Abs(Aimag(lamRINPUT)).gt.0._dp) Then 
Write(io_L,101) 24, Aimag(lamRINPUT) ,"# lamRINPUT"
End if 
If (Abs(Aimag(lamLRINPUT)).gt.0._dp) Then 
Write(io_L,101) 25, Aimag(lamLRINPUT) ,"# lamLRINPUT"
End if 
If (Abs(Aimag(betaLINPUT)).gt.0._dp) Then 
Write(io_L,101) 26, Aimag(betaLINPUT) ,"# betaLINPUT"
End if 
If (Abs(Aimag(betaRINPUT)).gt.0._dp) Then 
Write(io_L,101) 27, Aimag(betaRINPUT) ,"# betaRINPUT"
End if 
If (Abs(Aimag(alpINPUT)).gt.0._dp) Then 
Write(io_L,101) 28, Aimag(alpINPUT) ,"# alpINPUT"
End if 
If (Abs(Aimag(xiRINPUT)).gt.0._dp) Then 
Write(io_L,101) 29, Aimag(xiRINPUT) ,"# xiRINPUT"
End if 
If (Abs(Aimag(xiLRINPUT)).gt.0._dp) Then 
Write(io_L,101) 30, Aimag(xiLRINPUT) ,"# xiLRINPUT"
End if 
End if 
...
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block DARKLR Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Real(alp,dp), "# alp" 
Write(io_L,104) 4,Real(rh3,dp), "# rh3" 
If (Abs(Aimag(rh3)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 17,Real(etall,dp), "# etall" 
If (Abs(Aimag(etall)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 16,Real(etalr,dp), "# etalr" 
If (Abs(Aimag(etalr)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 6,Real(laml,dp), "# laml" 
If (Abs(Aimag(laml)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 8,Real(lamlr,dp), "# lamlr" 
If (Abs(Aimag(lamlr)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 10,Real(betl,dp), "# betl" 
If (Abs(Aimag(betl)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 18,Real(err2,dp), "# err2" 
If (Abs(Aimag(err2)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 20,Real(etarl,dp), "# etarl" 
If (Abs(Aimag(etarl)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 22,Real(etarr,dp), "# etarr" 
If (Abs(Aimag(etarr)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 12,Real(lamr,dp), "# lamr" 
If (Abs(Aimag(lamr)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 14,Real(betr,dp), "# betr" 
If (Abs(Aimag(betr)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 24,Real(err1,dp), "# err1" 
If (Abs(Aimag(err1)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 5,Real(xiLR,dp), "# xiLR" 
Write(io_L,104) 3,Real(xiR,dp), "# xiR" 
Write(io_L,104) 30,Real(vhl,dp), "# vhl" 
Write(io_L,104) 26,Real(vtl,dp), "# vtl" 
Write(io_L,104) 32,Real(vhr,dp), "# vhr" 
Write(io_L,104) 28,Real(vtr,dp), "# vtr" 
Write(io_L,104) 30,Real(vhl,dp), "# vhl" 
Write(io_L,104) 26,Real(vtl,dp), "# vtl" 
Write(io_L,104) 32,Real(vhr,dp), "# vhr" 
Write(io_L,104) 28,Real(vtr,dp), "# vtr" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMDARKLR Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 4,Aimag(rh3), "# rh3" 
Write(io_L,104) 17,Aimag(etall), "# etall" 
Write(io_L,104) 16,Aimag(etalr), "# etalr" 
Write(io_L,104) 6,Aimag(laml), "# laml" 
Write(io_L,104) 8,Aimag(lamlr), "# lamlr" 
Write(io_L,104) 10,Aimag(betl), "# betl" 
Write(io_L,104) 18,Aimag(err2), "# err2" 
Write(io_L,104) 20,Aimag(etarl), "# etarl" 
Write(io_L,104) 22,Aimag(etarr), "# etarr" 
Write(io_L,104) 12,Aimag(lamr), "# lamr" 
Write(io_L,104) 14,Aimag(betr), "# betr" 
Write(io_L,104) 24,Aimag(err1), "# err1" 
End if 
WriteNextBlock = .false. 
...
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block MUPARS Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Real(mudl2,dp), "# mudl2" 
If (Abs(Aimag(mudl2)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 4,Real(mudr2,dp), "# mudr2" 
If (Abs(Aimag(mudr2)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 1,Real(MU12,dp), "# MU12" 
Write(io_L,104) 6,Real(mul2,dp), "# mul2" 
If (Abs(Aimag(mul2)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 8,Real(mur2,dp), "# mur2" 
If (Abs(Aimag(mur2)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMMUPARS Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Aimag(mudl2), "# mudl2" 
Write(io_L,104) 4,Aimag(mudr2), "# mudr2" 
Write(io_L,104) 6,Aimag(mul2), "# mul2" 
Write(io_L,104) 8,Aimag(mur2), "# mur2" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block VEV Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(v1,dp), "# v1" 
Write(io_L,104) 2,Real(v2,dp), "# v2" 
If(WriteNextBlock) Then 
...
Write(io_L,104) 4,Real(LAM3Tree,dp), "# LAM3" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block TREEIMLRINPUT Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block TREEMUPARS Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Real(mudl2Tree,dp), "# mudl2" 
If (Abs(Aimag(mudl2Tree)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 4,Real(mudr2Tree,dp), "# mudr2" 
If (Abs(Aimag(mudr2Tree)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 1,Real(MU12Tree,dp), "# MU12" 
Write(io_L,104) 6,Real(mul2Tree,dp), "# mul2" 
If (Abs(Aimag(mul2Tree)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 8,Real(mur2Tree,dp), "# mur2" 
If (Abs(Aimag(mur2Tree)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block TREEIMMUPARS Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Aimag(mudl2Tree), "# mudl2" 
Write(io_L,104) 4,Aimag(mudr2Tree), "# mudr2" 
Write(io_L,104) 6,Aimag(mul2Tree), "# mul2" 
Write(io_L,104) 8,Aimag(mur2Tree), "# mur2" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block LOOPLRINPUT Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 4,Real(LAM31L,dp), "# LAM3" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block LOOPIMLRINPUT Q=",Q,"# (Renormalization Scale)" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block LOOPMUPARS Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Real(mudl21L,dp), "# mudl2" 
If (Abs(Aimag(mudl21L)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 4,Real(mudr21L,dp), "# mudr2" 
If (Abs(Aimag(mudr21L)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 1,Real(MU121L,dp), "# MU12" 
Write(io_L,104) 6,Real(mul21L,dp), "# mul2" 
If (Abs(Aimag(mul21L)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 8,Real(mur21L,dp), "# mur2" 
If (Abs(Aimag(mur21L)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block LOOPIMMUPARS Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Aimag(mudl21L), "# mudl2" 
Write(io_L,104) 4,Aimag(mudr21L), "# mudr2" 
Write(io_L,104) 6,Aimag(mul21L), "# mul2" 
Write(io_L,104) 8,Aimag(mur21L), "# mur2" 
End if 
Else 
WriteNextBlock = .false. 
Write(io_L,106) "Block TREELRINPUT Q=",Q,"# (Renormalization Scale)" 
...
Write(io_L,106) "Block YQ3 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(yq3(1,1),dp), "# Real(yq3(1,1),dp)" 
Write(io_L,107)1,2,Real(yq3(1,2),dp), "# Real(yq3(1,2),dp)" 
Write(io_L,107)1,3,Real(yq3(1,3),dp), "# Real(yq3(1,3),dp)" 
Write(io_L,107)2,1,Real(yq3(2,1),dp), "# Real(yq3(2,1),dp)" 
Write(io_L,107)2,2,Real(yq3(2,2),dp), "# Real(yq3(2,2),dp)" 
Write(io_L,107)2,3,Real(yq3(2,3),dp), "# Real(yq3(2,3),dp)" 
Write(io_L,107)3,1,Real(yq3(3,1),dp), "# Real(yq3(3,1),dp)" 
Write(io_L,107)3,2,Real(yq3(3,2),dp), "# Real(yq3(3,2),dp)" 
Write(io_L,107)3,3,Real(yq3(3,3),dp), "# Real(yq3(3,3),dp)" 
If (MaxVal(Abs(AImag(yq3))).gt.0._dp) Then 
Write(io_L,106) "Block IMYQ3 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(yq3(1,1)), "# Aimag(yq3(1,1))" 
Write(io_L,107)1,2,Aimag(yq3(1,2)), "# Aimag(yq3(1,2))" 
Write(io_L,107)1,3,Aimag(yq3(1,3)), "# Aimag(yq3(1,3))" 
Write(io_L,107)2,1,Aimag(yq3(2,1)), "# Aimag(yq3(2,1))" 
Write(io_L,107)2,2,Aimag(yq3(2,2)), "# Aimag(yq3(2,2))" 
Write(io_L,107)2,3,Aimag(yq3(2,3)), "# Aimag(yq3(2,3))" 
Write(io_L,107)3,1,Aimag(yq3(3,1)), "# Aimag(yq3(3,1))" 
Write(io_L,107)3,2,Aimag(yq3(3,2)), "# Aimag(yq3(3,2))" 
Write(io_L,107)3,3,Aimag(yq3(3,3)), "# Aimag(yq3(3,3))" 
End If 
...
If (MaxVal(Abs(AImag(YDL))).gt.0._dp) Then 
...
Write(io_L,106) "Block DARKLRGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 2,Real(alpGUT,dp), "# alp" 
Write(io_L,104) 4,Real(rh3GUT,dp), "# rh3" 
Write(io_L,104) 17,Real(etallGUT,dp), "# etall" 
Write(io_L,104) 16,Real(etalrGUT,dp), "# etalr" 
Write(io_L,104) 6,Real(lamlGUT,dp), "# laml" 
Write(io_L,104) 8,Real(lamlrGUT,dp), "# lamlr" 
Write(io_L,104) 10,Real(betlGUT,dp), "# betl" 
Write(io_L,104) 18,Real(err2GUT,dp), "# err2" 
Write(io_L,104) 20,Real(etarlGUT,dp), "# etarl" 
Write(io_L,104) 22,Real(etarrGUT,dp), "# etarr" 
Write(io_L,104) 12,Real(lamrGUT,dp), "# lamr" 
Write(io_L,104) 14,Real(betrGUT,dp), "# betr" 
Write(io_L,104) 24,Real(err1GUT,dp), "# err1" 
Write(io_L,104) 5,Real(xiLRGUT,dp), "# xiLR" 
Write(io_L,104) 3,Real(xiRGUT,dp), "# xiR" 
...
Write(io_L,106) "Block MUPARSGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 2,Real(mudl2GUT,dp), "# mudl2" 
Write(io_L,104) 4,Real(mudr2GUT,dp), "# mudr2" 
Write(io_L,104) 1,Real(MU12GUT,dp), "# MU12" 
Write(io_L,104) 6,Real(mul2GUT,dp), "# mul2" 
Write(io_L,104) 8,Real(mur2GUT,dp), "# mur2" 
...
Write(io_L,106) "Block yq3GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(yq3GUT(1,1),dp), "# Real(yq3GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(yq3GUT(1,2),dp), "# Real(yq3GUT(1,2),dp)" 
Write(io_L,107)1,3,Real(yq3GUT(1,3),dp), "# Real(yq3GUT(1,3),dp)" 
Write(io_L,107)2,1,Real(yq3GUT(2,1),dp), "# Real(yq3GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(yq3GUT(2,2),dp), "# Real(yq3GUT(2,2),dp)" 
Write(io_L,107)2,3,Real(yq3GUT(2,3),dp), "# Real(yq3GUT(2,3),dp)" 
Write(io_L,107)3,1,Real(yq3GUT(3,1),dp), "# Real(yq3GUT(3,1),dp)" 
Write(io_L,107)3,2,Real(yq3GUT(3,2),dp), "# Real(yq3GUT(3,2),dp)" 
Write(io_L,107)3,3,Real(yq3GUT(3,3),dp), "# Real(yq3GUT(3,3),dp)" 
If (MaxVal(Abs(AImag(yq3GUT))).gt.0._dp) Then 
Write(io_L,106) "Block IMyq3GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(yq3GUT(1,1)), "# Aimag(yq3GUT(1,1))" 
Write(io_L,107)1,2,Aimag(yq3GUT(1,2)), "# Aimag(yq3GUT(1,2))" 
Write(io_L,107)1,3,Aimag(yq3GUT(1,3)), "# Aimag(yq3GUT(1,3))" 
Write(io_L,107)2,1,Aimag(yq3GUT(2,1)), "# Aimag(yq3GUT(2,1))" 
Write(io_L,107)2,2,Aimag(yq3GUT(2,2)), "# Aimag(yq3GUT(2,2))" 
Write(io_L,107)2,3,Aimag(yq3GUT(2,3)), "# Aimag(yq3GUT(2,3))" 
Write(io_L,107)3,1,Aimag(yq3GUT(3,1)), "# Aimag(yq3GUT(3,1))" 
Write(io_L,107)3,2,Aimag(yq3GUT(3,2)), "# Aimag(yq3GUT(3,2))" 
Write(io_L,107)3,3,Aimag(yq3GUT(3,3)), "# Aimag(yq3GUT(3,3))" 
End If 
...
If (MaxVal(Abs(AImag(YDLGUT))).gt.0._dp) Then 
...
Write(io_L,107)1,5,UP(1,5), "# UP(1,5)" 
Write(io_L,107)1,6,UP(1,6), "# UP(1,6)" 
...
Write(io_L,107)2,5,UP(2,5), "# UP(2,5)" 
Write(io_L,107)2,6,UP(2,6), "# UP(2,6)" 
...
Write(io_L,107)3,5,UP(3,5), "# UP(3,5)" 
Write(io_L,107)3,6,UP(3,6), "# UP(3,6)" 
...
Write(io_L,107)4,5,UP(4,5), "# UP(4,5)" 
Write(io_L,107)4,6,UP(4,6), "# UP(4,6)" 
Write(io_L,107)5,1,UP(5,1), "# UP(5,1)" 
Write(io_L,107)5,2,UP(5,2), "# UP(5,2)" 
Write(io_L,107)5,3,UP(5,3), "# UP(5,3)" 
Write(io_L,107)5,4,UP(5,4), "# UP(5,4)" 
Write(io_L,107)5,5,UP(5,5), "# UP(5,5)" 
Write(io_L,107)5,6,UP(5,6), "# UP(5,6)" 
Write(io_L,107)6,1,UP(6,1), "# UP(6,1)" 
Write(io_L,107)6,2,UP(6,2), "# UP(6,2)" 
Write(io_L,107)6,3,UP(6,3), "# UP(6,3)" 
Write(io_L,107)6,4,UP(6,4), "# UP(6,4)" 
Write(io_L,107)6,5,UP(6,5), "# UP(6,5)" 
Write(io_L,107)6,6,UP(6,6), "# UP(6,6)" 
...
Write(io_L,107)1,5,UC(1,5), "# UC(1,5)" 
Write(io_L,107)1,6,UC(1,6), "# UC(1,6)" 
...
Write(io_L,107)2,5,UC(2,5), "# UC(2,5)" 
Write(io_L,107)2,6,UC(2,6), "# UC(2,6)" 
...
Write(io_L,107)3,5,UC(3,5), "# UC(3,5)" 
Write(io_L,107)3,6,UC(3,6), "# UC(3,6)" 
...
Write(io_L,107)4,5,UC(4,5), "# UC(4,5)" 
Write(io_L,107)4,6,UC(4,6), "# UC(4,6)" 
Write(io_L,107)5,1,UC(5,1), "# UC(5,1)" 
Write(io_L,107)5,2,UC(5,2), "# UC(5,2)" 
Write(io_L,107)5,3,UC(5,3), "# UC(5,3)" 
Write(io_L,107)5,4,UC(5,4), "# UC(5,4)" 
Write(io_L,107)5,5,UC(5,5), "# UC(5,5)" 
Write(io_L,107)5,6,UC(5,6), "# UC(5,6)" 
Write(io_L,107)6,1,UC(6,1), "# UC(6,1)" 
Write(io_L,107)6,2,UC(6,2), "# UC(6,2)" 
Write(io_L,107)6,3,UC(6,3), "# UC(6,3)" 
Write(io_L,107)6,4,UC(6,4), "# UC(6,4)" 
Write(io_L,107)6,5,UC(6,5), "# UC(6,5)" 
Write(io_L,107)6,6,UC(6,6), "# UC(6,6)" 
...
Write(io_L,1101) rHB_S_S_Fd(4,3),rHB_S_P_Fd(4,3), 3 ,6000029,5,5, " # h_4 b b coupling " 
Write(io_L,1101) rHB_S_S_Fd(4,2),rHB_S_P_Fd(4,2), 3 ,6000029,3,3, " # h_4 s s coupling " 
Write(io_L,1101) rHB_S_S_Fu(4,3),rHB_S_P_Fu(4,3), 3 ,6000029,6,6, " # h_4 t t coupling  " 
Write(io_L,1101) rHB_S_S_Fu(4,2),rHB_S_P_Fu(4,2),3 ,6000029,4,4, " # h_4 c c coupling " 
Write(io_L,1101) rHB_S_S_Fe(4,3),rHB_S_P_Fe(4,3), 3 ,6000029,15,15, " # h_4 tau tau coupling " 
Write(io_L,1101) rHB_S_S_Fe(4,2),rHB_S_P_Fe(4,2), 3 ,6000029,13,13, " # h_4 mu mu coupling  " 
Write(io_L,1101) rHB_S_S_Fd(5,3),rHB_S_P_Fd(5,3), 3 ,6000030,5,5, " # h_5 b b coupling " 
Write(io_L,1101) rHB_S_S_Fd(5,2),rHB_S_P_Fd(5,2), 3 ,6000030,3,3, " # h_5 s s coupling " 
Write(io_L,1101) rHB_S_S_Fu(5,3),rHB_S_P_Fu(5,3), 3 ,6000030,6,6, " # h_5 t t coupling  " 
Write(io_L,1101) rHB_S_S_Fu(5,2),rHB_S_P_Fu(5,2),3 ,6000030,4,4, " # h_5 c c coupling " 
Write(io_L,1101) rHB_S_S_Fe(5,3),rHB_S_P_Fe(5,3), 3 ,6000030,15,15, " # h_5 tau tau coupling " 
Write(io_L,1101) rHB_S_S_Fe(5,2),rHB_S_P_Fe(5,2), 3 ,6000030,13,13, " # h_5 mu mu coupling  " 
Write(io_L,1101) rHB_S_S_Fd(6,3),rHB_S_P_Fd(6,3), 3 ,6000031,5,5, " # h_6 b b coupling " 
Write(io_L,1101) rHB_S_S_Fd(6,2),rHB_S_P_Fd(6,2), 3 ,6000031,3,3, " # h_6 s s coupling " 
Write(io_L,1101) rHB_S_S_Fu(6,3),rHB_S_P_Fu(6,3), 3 ,6000031,6,6, " # h_6 t t coupling  " 
Write(io_L,1101) rHB_S_S_Fu(6,2),rHB_S_P_Fu(6,2),3 ,6000031,4,4, " # h_6 c c coupling " 
Write(io_L,1101) rHB_S_S_Fe(6,3),rHB_S_P_Fe(6,3), 3 ,6000031,15,15, " # h_6 tau tau coupling " 
Write(io_L,1101) rHB_S_S_Fe(6,2),rHB_S_P_Fe(6,2), 3 ,6000031,13,13, " # h_6 mu mu coupling  " 
...
Write(io_L,1101) rHB_P_S_Fd(4,3),rHB_P_P_Fd(4,3), 3 ,6000021,5,5, " # A_4 b b coupling " 
Write(io_L,1101) rHB_P_S_Fd(4,2),rHB_P_P_Fd(4,2), 3 ,6000021,3,3, " # A_4 s s coupling " 
Write(io_L,1101) rHB_P_S_Fu(4,3),rHB_P_P_Fu(4,3), 3 ,6000021,6,6, " # A_4 t t coupling "  
Write(io_L,1101) rHB_P_S_Fu(4,2),rHB_P_P_Fu(4,2), 3 ,6000021,4,4, " # A_4 c c coupling " 
Write(io_L,1101) rHB_P_S_Fe(4,3),rHB_P_P_Fe(4,3), 3 ,6000021,15,15, " # A_4 tau tau coupling " 
Write(io_L,1101) rHB_P_S_Fe(4,2),rHB_P_P_Fe(4,2), 3 ,6000021,13,13, " # A_4 mu mu coupling " 
Write(io_L,1101) rHB_P_S_Fd(5,3),rHB_P_P_Fd(5,3), 3 ,6000022,5,5, " # A_5 b b coupling " 
Write(io_L,1101) rHB_P_S_Fd(5,2),rHB_P_P_Fd(5,2), 3 ,6000022,3,3, " # A_5 s s coupling " 
Write(io_L,1101) rHB_P_S_Fu(5,3),rHB_P_P_Fu(5,3), 3 ,6000022,6,6, " # A_5 t t coupling "  
Write(io_L,1101) rHB_P_S_Fu(5,2),rHB_P_P_Fu(5,2), 3 ,6000022,4,4, " # A_5 c c coupling " 
Write(io_L,1101) rHB_P_S_Fe(5,3),rHB_P_P_Fe(5,3), 3 ,6000022,15,15, " # A_5 tau tau coupling " 
Write(io_L,1101) rHB_P_S_Fe(5,2),rHB_P_P_Fe(5,2), 3 ,6000022,13,13, " # A_5 mu mu coupling " 
Write(io_L,1101) rHB_P_S_Fd(6,3),rHB_P_P_Fd(6,3), 3 ,6000023,5,5, " # A_6 b b coupling " 
Write(io_L,1101) rHB_P_S_Fd(6,2),rHB_P_P_Fd(6,2), 3 ,6000023,3,3, " # A_6 s s coupling " 
Write(io_L,1101) rHB_P_S_Fu(6,3),rHB_P_P_Fu(6,3), 3 ,6000023,6,6, " # A_6 t t coupling "  
Write(io_L,1101) rHB_P_S_Fu(6,2),rHB_P_P_Fu(6,2), 3 ,6000023,4,4, " # A_6 c c coupling " 
Write(io_L,1101) rHB_P_S_Fe(6,3),rHB_P_P_Fe(6,3), 3 ,6000023,15,15, " # A_6 tau tau coupling " 
Write(io_L,1101) rHB_P_S_Fe(6,2),rHB_P_P_Fe(6,2), 3 ,6000023,13,13, " # A_6 mu mu coupling " 
...
Write(io_L,1102) rHB_S_VWLm(4),3 ,6000029,24,24, " # h_4 W W coupling " 
Write(io_L,1102) rHB_S_VZ(4),3 ,6000029,23,23, " # h_4 Z Z coupling  " 
Write(io_L,1102) 0._dp ,3 ,6000029,23,22, " # h_4 Z gamma coupling " 
Write(io_L,1102) Real(ratioPP(4),dp),3 ,6000029,22,22, " # h_4 gamma gamma coupling " 
Write(io_L,1102) Real(ratioGG(4),dp),3 ,6000029,21,21, " # h_4 g g coupling " 
Write(io_L,1103) 0._dp,4 ,6000029,21,21,23, " # h_4 g g Z coupling " 
Write(io_L,1102) rHB_S_VWLm(5),3 ,6000030,24,24, " # h_5 W W coupling " 
Write(io_L,1102) rHB_S_VZ(5),3 ,6000030,23,23, " # h_5 Z Z coupling  " 
Write(io_L,1102) 0._dp ,3 ,6000030,23,22, " # h_5 Z gamma coupling " 
Write(io_L,1102) Real(ratioPP(5),dp),3 ,6000030,22,22, " # h_5 gamma gamma coupling " 
Write(io_L,1102) Real(ratioGG(5),dp),3 ,6000030,21,21, " # h_5 g g coupling " 
Write(io_L,1103) 0._dp,4 ,6000030,21,21,23, " # h_5 g g Z coupling " 
Write(io_L,1102) rHB_S_VWLm(6),3 ,6000031,24,24, " # h_6 W W coupling " 
Write(io_L,1102) rHB_S_VZ(6),3 ,6000031,23,23, " # h_6 Z Z coupling  " 
Write(io_L,1102) 0._dp ,3 ,6000031,23,22, " # h_6 Z gamma coupling " 
Write(io_L,1102) Real(ratioPP(6),dp),3 ,6000031,22,22, " # h_6 gamma gamma coupling " 
Write(io_L,1102) Real(ratioGG(6),dp),3 ,6000031,21,21, " # h_6 g g coupling " 
Write(io_L,1103) 0._dp,4 ,6000031,21,21,23, " # h_6 g g Z coupling " 
...
Write(io_L,1102) rHB_P_VWLm(4),3 ,6000021,24,24, " # A_4 W W coupling " 
Write(io_L,1102) rHB_P_VZ(4),3 ,6000021,23,23, " # A_4 Z Z coupling " 
Write(io_L,1102) 0._dp ,3 ,6000021,23,22, " # A_4 Z gamma coupling " 
Write(io_L,1102) Real(ratioPPP(4),dp),3 ,6000021,22,22, " # A_4 gamma gamma coupling " 
Write(io_L,1102) Real(ratioPGG(4),dp),3 ,6000021,21,21, " # A_4 g g coupling " 
Write(io_L,1103) 0._dp,4 ,6000021,21,21,23, " # A_4 g g Z coupling " 
Write(io_L,1102) rHB_P_VWLm(5),3 ,6000022,24,24, " # A_5 W W coupling " 
Write(io_L,1102) rHB_P_VZ(5),3 ,6000022,23,23, " # A_5 Z Z coupling " 
Write(io_L,1102) 0._dp ,3 ,6000022,23,22, " # A_5 Z gamma coupling " 
Write(io_L,1102) Real(ratioPPP(5),dp),3 ,6000022,22,22, " # A_5 gamma gamma coupling " 
Write(io_L,1102) Real(ratioPGG(5),dp),3 ,6000022,21,21, " # A_5 g g coupling " 
Write(io_L,1103) 0._dp,4 ,6000022,21,21,23, " # A_5 g g Z coupling " 
Write(io_L,1102) rHB_P_VWLm(6),3 ,6000023,24,24, " # A_6 W W coupling " 
Write(io_L,1102) rHB_P_VZ(6),3 ,6000023,23,23, " # A_6 Z Z coupling " 
Write(io_L,1102) 0._dp ,3 ,6000023,23,22, " # A_6 Z gamma coupling " 
Write(io_L,1102) Real(ratioPPP(6),dp),3 ,6000023,22,22, " # A_6 gamma gamma coupling " 
Write(io_L,1102) Real(ratioPGG(6),dp),3 ,6000023,21,21, " # A_6 g g coupling " 
Write(io_L,1103) 0._dp,4 ,6000023,21,21,23, " # A_6 g g Z coupling " 
...
Write(io_L,1102) Real(CPL_H_H_Z(1,4), dp),3 ,25,6000029,23, " # h_1 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(1,5), dp),3 ,25,6000030,23, " # h_1 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(1,6), dp),3 ,25,6000031,23, " # h_1 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_A_H_Z(3,1), dp),3 ,25,36,23, " # h_1 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(4,1), dp),3 ,25,6000021,23, " # h_1 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(5,1), dp),3 ,25,6000022,23, " # h_1 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(6,1), dp),3 ,25,6000023,23, " # h_1 A_6 Z coupling " 
...
Write(io_L,1102) Real(CPL_H_H_Z(2,4), dp),3 ,35,6000029,23, " # h_2 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(2,5), dp),3 ,35,6000030,23, " # h_2 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(2,6), dp),3 ,35,6000031,23, " # h_2 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_A_H_Z(3,2), dp),3 ,35,36,23, " # h_2 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(4,2), dp),3 ,35,6000021,23, " # h_2 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(5,2), dp),3 ,35,6000022,23, " # h_2 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(6,2), dp),3 ,35,6000023,23, " # h_2 A_6 Z coupling " 
...
Write(io_L,1102) Real(CPL_H_H_Z(3,4), dp),3 ,335,6000029,23, " # h_3 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(3,5), dp),3 ,335,6000030,23, " # h_3 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(3,6), dp),3 ,335,6000031,23, " # h_3 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_A_H_Z(3,3), dp),3 ,335,36,23, " # h_3 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(4,3), dp),3 ,335,6000021,23, " # h_3 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(5,3), dp),3 ,335,6000022,23, " # h_3 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(6,3), dp),3 ,335,6000023,23, " # h_3 A_6 Z coupling " 
Write(io_L,1102) Real(CPL_H_H_Z(4,1), dp),3 ,6000029,25,23, " # h_4 h_1 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,2), dp),3 ,6000029,35,23, " # h_4 h_2 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,3), dp),3 ,6000029,335,23, " # h_4 h_3 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,4), dp),3 ,6000029,6000029,23, " # h_4 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,5), dp),3 ,6000029,6000030,23, " # h_4 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,6), dp),3 ,6000029,6000031,23, " # h_4 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_A_H_Z(3,4), dp),3 ,6000029,36,23, " # h_4 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(4,4), dp),3 ,6000029,6000021,23, " # h_4 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(5,4), dp),3 ,6000029,6000022,23, " # h_4 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(6,4), dp),3 ,6000029,6000023,23, " # h_4 A_6 Z coupling " 
Write(io_L,1102) Real(CPL_H_H_Z(5,1), dp),3 ,6000030,25,23, " # h_5 h_1 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,2), dp),3 ,6000030,35,23, " # h_5 h_2 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,3), dp),3 ,6000030,335,23, " # h_5 h_3 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,4), dp),3 ,6000030,6000029,23, " # h_5 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,5), dp),3 ,6000030,6000030,23, " # h_5 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,6), dp),3 ,6000030,6000031,23, " # h_5 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_A_H_Z(3,5), dp),3 ,6000030,36,23, " # h_5 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(4,5), dp),3 ,6000030,6000021,23, " # h_5 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(5,5), dp),3 ,6000030,6000022,23, " # h_5 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(6,5), dp),3 ,6000030,6000023,23, " # h_5 A_6 Z coupling " 
Write(io_L,1102) Real(CPL_H_H_Z(6,1), dp),3 ,6000031,25,23, " # h_6 h_1 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,2), dp),3 ,6000031,35,23, " # h_6 h_2 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,3), dp),3 ,6000031,335,23, " # h_6 h_3 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,4), dp),3 ,6000031,6000029,23, " # h_6 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,5), dp),3 ,6000031,6000030,23, " # h_6 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,6), dp),3 ,6000031,6000031,23, " # h_6 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_A_H_Z(3,6), dp),3 ,6000031,36,23, " # h_6 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(4,6), dp),3 ,6000031,6000021,23, " # h_6 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(5,6), dp),3 ,6000031,6000022,23, " # h_6 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_H_Z(6,6), dp),3 ,6000031,6000023,23, " # h_6 A_6 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(3,3), dp),3 ,36,36,23, " # A_3 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(4,3), dp),3 ,36,6000021,23, " # A_3 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(5,3), dp),3 ,36,6000022,23, " # A_3 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(6,3), dp),3 ,36,6000023,23, " # A_3 A_6 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(3,4), dp),3 ,6000021,36,23, " # A_4 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(4,4), dp),3 ,6000021,6000021,23, " # A_4 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(5,4), dp),3 ,6000021,6000022,23, " # A_4 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(6,4), dp),3 ,6000021,6000023,23, " # A_4 A_6 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(3,5), dp),3 ,6000022,36,23, " # A_5 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(4,5), dp),3 ,6000022,6000021,23, " # A_5 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(5,5), dp),3 ,6000022,6000022,23, " # A_5 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(6,5), dp),3 ,6000022,6000023,23, " # A_5 A_6 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(3,6), dp),3 ,6000023,36,23, " # A_6 A_3 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(4,6), dp),3 ,6000023,6000021,23, " # A_6 A_4 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(5,6), dp),3 ,6000023,6000022,23, " # A_6 A_5 Z coupling " 
Write(io_L,1102) Real(CPL_A_A_Z(6,6), dp),3 ,6000023,6000023,23, " # A_6 A_6 Z coupling " 
End If 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,73:342)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,73:342)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,73:342)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,6
...
If (Maxval(BRFe(1,43:312)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,6
...
If (Maxval(BRFe(2,43:312)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,6
...
If (Maxval(BRFe(3,43:312)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,91:630)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,91:630)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,91:630)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRFd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(4))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRFd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(4))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVWRm 
Write(io_L,201) BRFd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(4))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFd(4,91:630)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRFd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(5))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRFd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(5))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVWRm 
Write(io_L,201) BRFd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(5))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFd(5,91:630)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
Write(io_L,201) BRFd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(6))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRFd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(6))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGHpm(gt2) 
Write(io_L,201) BRFd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(6))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleHpm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRFd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(6))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVWRm 
Write(io_L,201) BRFd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFd(6))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFd(6,91:630)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWLm)//"_virt "//")"
End if 
icount = icount +1 
Do gt1= 3, 6
  Do gt2= gt1, 6
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
If (((gTFv(gt1).le.WidthToBeInvisible).and.(gTFv(gt2).le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
...
Write(io_L,201) BRhh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
Write(io_L,201) BRhh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRhh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
Write(io_L,201) BRhh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVWLm)//" "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
If (BRhh(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVWLm 
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRhh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVWLm)//" "//Trim(NameParticleVWRm)//"^* "//")"
Write(io_L,201) BRhh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVWRm)//" "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
If (BRhh(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZ 
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
If (BRhh(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZR 
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVZR)//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWLm)//"_virt "//")"
End if 
icount = icount +1 
Do gt1= 3, 6
  Do gt2= gt1, 6
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
If (((gTFv(gt1).le.WidthToBeInvisible).and.(gTFv(gt2).le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
...
Write(io_L,201) BRhh(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
Write(io_L,201) BRhh(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRhh(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
Write(io_L,201) BRhh(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVWLm)//" "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
If (BRhh(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVWLm 
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRhh(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVWLm)//" "//Trim(NameParticleVWRm)//"^* "//")"
Write(io_L,201) BRhh(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVWRm)//" "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
If (BRhh(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZ 
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
If (BRhh(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZR 
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVZR)//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(1,73:612)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(2,73:612)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(3,73:612)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(4,73:612)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(5,73:612)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(6,73:612)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,6
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 6
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 6
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 6
...
CurrentPDG2(2) = -PDGHppmm(gt2) 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleHppmm(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVWRm 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(5,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRHpm(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWLm 
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
If (BRHpm(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWRm 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleVWRm)//"^* "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRHpm(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWRm 
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//"^* -> "//Trim(NameParticleVWRm)//"^* "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 6
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 6
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 6
...
CurrentPDG2(2) = -PDGHppmm(gt2) 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleHppmm(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVWRm 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(6,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRHpm(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWLm 
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
If (BRHpm(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWRm 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleVWRm)//"^* "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRHpm(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWRm 
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//"^* -> "//Trim(NameParticleVWRm)//"^* "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
If (((gTFv(gt1).le.WidthToBeInvisible).and.(gTFv(gt2).le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 6
...
Write(io_L,201) BRAh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
Write(io_L,201) BRAh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRAh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
Write(io_L,201) BRAh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRAh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleVWLm)//" "//Trim(NameParticleVWRm)//"^* "//")"
Write(io_L,201) BRAh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRAh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRAh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
If (((gTFv(gt1).le.WidthToBeInvisible).and.(gTFv(gt2).le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRAh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 6
...
Write(io_L,201) BRAh(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
Write(io_L,201) BRAh(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRAh(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
Write(io_L,201) BRAh(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRAh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRAh(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleVWLm)//" "//Trim(NameParticleVWRm)//"^* "//")"
Write(io_L,201) BRAh(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(6))//" -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.darkLR",status="unknown")
...
Write(123,*) "RHO2= ",RHO2
Write(123,*) "RHO1= ",RHO1
Write(123,*) "rh3_r = ",Real(rh3,dp) 
Write(123,*) "rh3_i = ",AImag(rh3) 
Write(123,*) "ALP3= ",ALP3
Write(123,*) "ALP1= ",ALP1
Write(123,*) "LAM1= ",LAM1
Write(123,*) "etall_r = ",Real(etall,dp) 
Write(123,*) "etall_i = ",AImag(etall) 
Write(123,*) "etalr_r = ",Real(etalr,dp) 
Write(123,*) "etalr_i = ",AImag(etalr) 
Write(123,*) "laml_r = ",Real(laml,dp) 
Write(123,*) "laml_i = ",AImag(laml) 
Write(123,*) "lamlr_r = ",Real(lamlr,dp) 
Write(123,*) "lamlr_i = ",AImag(lamlr) 
Write(123,*) "betl_r = ",Real(betl,dp) 
Write(123,*) "betl_i = ",AImag(betl) 
Write(123,*) "err2_r = ",Real(err2,dp) 
Write(123,*) "err2_i = ",AImag(err2) 
Write(123,*) "etarl_r = ",Real(etarl,dp) 
Write(123,*) "etarl_i = ",AImag(etarl) 
Write(123,*) "etarr_r = ",Real(etarr,dp) 
Write(123,*) "etarr_i = ",AImag(etarr) 
Write(123,*) "lamr_r = ",Real(lamr,dp) 
Write(123,*) "lamr_i = ",AImag(lamr) 
Write(123,*) "betr_r = ",Real(betr,dp) 
Write(123,*) "betr_i = ",AImag(betr) 
Write(123,*) "err1_r = ",Real(err1,dp) 
Write(123,*) "err1_i = ",AImag(err1) 
...
Write(123,*) "yq311_r= ",Real(yq3(1,1),dp)
Write(123,*) "yq312_r= ",Real(yq3(1,2),dp)
Write(123,*) "yq313_r= ",Real(yq3(1,3),dp)
Write(123,*) "yq321_r= ",Real(yq3(2,1),dp)
Write(123,*) "yq322_r= ",Real(yq3(2,2),dp)
Write(123,*) "yq323_r= ",Real(yq3(2,3),dp)
Write(123,*) "yq331_r= ",Real(yq3(3,1),dp)
Write(123,*) "yq332_r= ",Real(yq3(3,2),dp)
Write(123,*) "yq333_r= ",Real(yq3(3,3),dp)
Write(123,*) "yq311_i= ",AImag(yq3(1,1))
Write(123,*) "yq312_i= ",AImag(yq3(1,2))
Write(123,*) "yq313_i= ",AImag(yq3(1,3))
Write(123,*) "yq321_i= ",AImag(yq3(2,1))
Write(123,*) "yq322_i= ",AImag(yq3(2,2))
Write(123,*) "yq323_i= ",AImag(yq3(2,3))
Write(123,*) "yq331_i= ",AImag(yq3(3,1))
Write(123,*) "yq332_i= ",AImag(yq3(3,2))
Write(123,*) "yq333_i= ",AImag(yq3(3,3))
...
Write(123,*) "Mhh5= ", Abs(Mhh(5)) 
Write(123,*) "Mhh6= ", Abs(Mhh(6)) 
...
Write(123,*) "Whh5 = ",gThh(5)
Write(123,*) "Whh6 = ",gThh(6)
...
Write(123,*) "UP15= ",UP(1,5)
Write(123,*) "UP16= ",UP(1,6)
Write(123,*) "UP21= ",UP(2,1)
Write(123,*) "UP22= ",UP(2,2)
Write(123,*) "UP23= ",UP(2,3)
Write(123,*) "UP24= ",UP(2,4)
Write(123,*) "UP25= ",UP(2,5)
Write(123,*) "UP26= ",UP(2,6)
Write(123,*) "UP31= ",UP(3,1)
Write(123,*) "UP32= ",UP(3,2)
Write(123,*) "UP33= ",UP(3,3)
Write(123,*) "UP34= ",UP(3,4)
Write(123,*) "UP35= ",UP(3,5)
Write(123,*) "UP36= ",UP(3,6)
Write(123,*) "UP41= ",UP(4,1)
Write(123,*) "UP42= ",UP(4,2)
Write(123,*) "UP43= ",UP(4,3)
Write(123,*) "UP44= ",UP(4,4)
Write(123,*) "UP45= ",UP(4,5)
Write(123,*) "UP46= ",UP(4,6)
Write(123,*) "UP51= ",UP(5,1)
Write(123,*) "UP52= ",UP(5,2)
Write(123,*) "UP53= ",UP(5,3)
Write(123,*) "UP54= ",UP(5,4)
Write(123,*) "UP55= ",UP(5,5)
Write(123,*) "UP56= ",UP(5,6)
Write(123,*) "UP61= ",UP(6,1)
Write(123,*) "UP62= ",UP(6,2)
Write(123,*) "UP63= ",UP(6,3)
Write(123,*) "UP64= ",UP(6,4)
Write(123,*) "UP65= ",UP(6,5)
Write(123,*) "UP66= ",UP(6,6)
Write(123,*) "UC11= ",UC(1,1)
Write(123,*) "UC12= ",UC(1,2)
Write(123,*) "UC13= ",UC(1,3)
Write(123,*) "UC14= ",UC(1,4)
Write(123,*) "UC15= ",UC(1,5)
Write(123,*) "UC16= ",UC(1,6)
Write(123,*) "UC21= ",UC(2,1)
Write(123,*) "UC22= ",UC(2,2)
Write(123,*) "UC23= ",UC(2,3)
Write(123,*) "UC24= ",UC(2,4)
Write(123,*) "UC25= ",UC(2,5)
Write(123,*) "UC26= ",UC(2,6)
Write(123,*) "UC31= ",UC(3,1)
Write(123,*) "UC32= ",UC(3,2)
Write(123,*) "UC33= ",UC(3,3)
Write(123,*) "UC34= ",UC(3,4)
Write(123,*) "UC35= ",UC(3,5)
Write(123,*) "UC36= ",UC(3,6)
Write(123,*) "UC41= ",UC(4,1)
Write(123,*) "UC42= ",UC(4,2)
Write(123,*) "UC43= ",UC(4,3)
Write(123,*) "UC44= ",UC(4,4)
Write(123,*) "UC45= ",UC(4,5)
Write(123,*) "UC46= ",UC(4,6)
Write(123,*) "UC51= ",UC(5,1)
Write(123,*) "UC52= ",UC(5,2)
Write(123,*) "UC53= ",UC(5,3)
Write(123,*) "UC54= ",UC(5,4)
Write(123,*) "UC55= ",UC(5,5)
Write(123,*) "UC56= ",UC(5,6)
Write(123,*) "UC61= ",UC(6,1)
Write(123,*) "UC62= ",UC(6,2)
Write(123,*) "UC63= ",UC(6,3)
Write(123,*) "UC64= ",UC(6,4)
Write(123,*) "UC65= ",UC(6,5)
Write(123,*) "UC66= ",UC(6,6)
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fe(5,2)
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fe(6,2)
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fe(3,2)
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fe(4,2)
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fe(5,2)
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fe(6,2)
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fe(5,2)
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fe(6,2)
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fe(3,2)
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fe(4,2)
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fe(5,2)
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fe(6,2)
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fe(5,3)
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fe(6,3)
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fe(3,3)
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fe(4,3)
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fe(5,3)
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fe(6,3)
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fe(5,3)
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fe(6,3)
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fe(3,3)
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fe(4,3)
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fe(5,3)
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fe(6,3)
...
Write(89,"(3e16.8)",advance="No") rHB_S_VWLm(5)
Write(89,"(3e16.8)",advance="No") rHB_S_VWLm(6)
Write(89,"(3e16.8)",advance="No") rHB_P_VWLm(3)
Write(89,"(3e16.8)",advance="No") rHB_P_VWLm(4)
Write(89,"(3e16.8)",advance="No") rHB_P_VWLm(5)
Write(89,"(3e16.8)",advance="No") rHB_P_VWLm(6)
...
Subroutine Read_DARKLRIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.2) Then 
alpIN= wert 
InputValueforalp= .True. 
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) rh3IN= Cmplx(wert,Aimag(rh3IN),dp) 
If (i_c.Eq.1) rh3IN= Cmplx(Real(rh3IN,dp),wert,dp) 
InputValueforrh3= .True. 
Else If (i_par.Eq.17) Then 
If (i_c.Eq.0) etallIN= Cmplx(wert,Aimag(etallIN),dp) 
If (i_c.Eq.1) etallIN= Cmplx(Real(etallIN,dp),wert,dp) 
InputValueforetall= .True. 
Else If (i_par.Eq.16) Then 
If (i_c.Eq.0) etalrIN= Cmplx(wert,Aimag(etalrIN),dp) 
If (i_c.Eq.1) etalrIN= Cmplx(Real(etalrIN,dp),wert,dp) 
InputValueforetalr= .True. 
Else If (i_par.Eq.6) Then 
If (i_c.Eq.0) lamlIN= Cmplx(wert,Aimag(lamlIN),dp) 
If (i_c.Eq.1) lamlIN= Cmplx(Real(lamlIN,dp),wert,dp) 
InputValueforlaml= .True. 
Else If (i_par.Eq.8) Then 
If (i_c.Eq.0) lamlrIN= Cmplx(wert,Aimag(lamlrIN),dp) 
If (i_c.Eq.1) lamlrIN= Cmplx(Real(lamlrIN,dp),wert,dp) 
InputValueforlamlr= .True. 
Else If (i_par.Eq.10) Then 
If (i_c.Eq.0) betlIN= Cmplx(wert,Aimag(betlIN),dp) 
If (i_c.Eq.1) betlIN= Cmplx(Real(betlIN,dp),wert,dp) 
InputValueforbetl= .True. 
Else If (i_par.Eq.18) Then 
If (i_c.Eq.0) err2IN= Cmplx(wert,Aimag(err2IN),dp) 
If (i_c.Eq.1) err2IN= Cmplx(Real(err2IN,dp),wert,dp) 
InputValueforerr2= .True. 
Else If (i_par.Eq.20) Then 
If (i_c.Eq.0) etarlIN= Cmplx(wert,Aimag(etarlIN),dp) 
If (i_c.Eq.1) etarlIN= Cmplx(Real(etarlIN,dp),wert,dp) 
InputValueforetarl= .True. 
Else If (i_par.Eq.22) Then 
If (i_c.Eq.0) etarrIN= Cmplx(wert,Aimag(etarrIN),dp) 
If (i_c.Eq.1) etarrIN= Cmplx(Real(etarrIN,dp),wert,dp) 
InputValueforetarr= .True. 
Else If (i_par.Eq.12) Then 
If (i_c.Eq.0) lamrIN= Cmplx(wert,Aimag(lamrIN),dp) 
If (i_c.Eq.1) lamrIN= Cmplx(Real(lamrIN,dp),wert,dp) 
InputValueforlamr= .True. 
Else If (i_par.Eq.14) Then 
If (i_c.Eq.0) betrIN= Cmplx(wert,Aimag(betrIN),dp) 
If (i_c.Eq.1) betrIN= Cmplx(Real(betrIN,dp),wert,dp) 
InputValueforbetr= .True. 
Else If (i_par.Eq.24) Then 
If (i_c.Eq.0) err1IN= Cmplx(wert,Aimag(err1IN),dp) 
If (i_c.Eq.1) err1IN= Cmplx(Real(err1IN,dp),wert,dp) 
InputValueforerr1= .True. 
Else If (i_par.Eq.5) Then 
xiLRIN= wert 
InputValueforxiLR= .True. 
Else If (i_par.Eq.3) Then 
xiRIN= wert 
InputValueforxiR= .True. 
Else If (i_par.Eq.30) Then 
vhlIN= wert 
Else If (i_par.Eq.26) Then 
vtlIN= wert 
...
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block DARKLRIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMDARKLRIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block DARKLRIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMDARKLRIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_DARKLRIN 
...
Subroutine Read_MUPARSIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.2) Then 
If (i_c.Eq.0) mudl2IN= Cmplx(wert,Aimag(mudl2IN),dp) 
If (i_c.Eq.1) mudl2IN= Cmplx(Real(mudl2IN,dp),wert,dp) 
InputValueformudl2= .True. 
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) mudr2IN= Cmplx(wert,Aimag(mudr2IN),dp) 
If (i_c.Eq.1) mudr2IN= Cmplx(Real(mudr2IN,dp),wert,dp) 
InputValueformudr2= .True. 
Else If (i_par.Eq.1) Then 
MU12IN= wert 
InputValueforMU12= .True. 
Else If (i_par.Eq.6) Then 
If (i_c.Eq.0) mul2IN= Cmplx(wert,Aimag(mul2IN),dp) 
If (i_c.Eq.1) mul2IN= Cmplx(Real(mul2IN,dp),wert,dp) 
InputValueformul2= .True. 
Else If (i_par.Eq.8) Then 
If (i_c.Eq.0) mur2IN= Cmplx(wert,Aimag(mur2IN),dp) 
If (i_c.Eq.1) mur2IN= Cmplx(Real(mur2IN,dp),wert,dp) 
InputValueformur2= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MUPARSIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMUPARSIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MUPARSIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMUPARSIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MUPARSIN 
