...
WriteString[file,"! 'PreSARAH' output has been generated  at 11:14 on 4.11.2014 \n"]; 
WriteString[file,"! ---------------------------------------------------------------- \n \n"]; 
...
V, (* Vector penguins *) 
 Switch[top,  (* Check topology *) 
  1, 
	 	 ...
	 	 WriteStringFLB[file,"  TVO4lVRR=TVO4lVRR+ -157.91367041742973*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVRR= & "<> StringReplace["-16 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVLL=TVO4lVLL+ -157.91367041742973*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVLL= & "<> StringReplace["-16 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVRL=TVO4lVRL+ -157.91367041742973*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVRL= & "<> StringReplace["-16 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVLR=TVO4lVLR+ -157.91367041742973*coup1L*coup2R*IMP2\n" ];
...
,
  2, 
	 	 ...
	 	 WriteStringFLB[file,"  TVO4lSRR=TVO4lSRR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lSRR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lSRL=TVO4lSRL+ -315.82734083485946*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lSRL= & "<> StringReplace["-32 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lSLR=TVO4lSLR+ -315.82734083485946*coup1R*coup2R*IMP2\n" ];
	 	 ...
	 	 WriteStringFLB[file,"  TVO4lVRL=TVO4lVRL+ -157.91367041742973*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lVRL= & "<> StringReplace["-16 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lVLR=TVO4lVLR+ -157.91367041742973*coup1R*coup2L*IMP2\n" ];
...
,
  3, 
	 	 ...
	 	 WriteStringFLB[file,"  TVO4lSRR=TVO4lSRR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lSRR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lSRL=TVO4lSRL+ 315.82734083485946*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVO4lSRL= & "<> StringReplace["32 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVO4lSLR=TVO4lSLR+ 315.82734083485946*coup1L*coup2R*IMP2\n" ];
