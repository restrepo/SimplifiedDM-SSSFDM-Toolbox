...
c
 ...
 25   format( 1x,a,f10.5,' GeV^3 ,    ',a,f10.5,' GeV^3 ')
 26   format( 1x,a,f10.5,' GeV^5 ,    ',a,f10.5,' GeV^5 ')
      ...
      write(6,*)
      write(6,*) 'Long distance matrix elements:'
      write(6,*) '------------------------------'
      write(6,*)
      write(6,25) '<O(1S0[1])>  = ',ldme_1S01,' <O(1S0[8])>  =',ldme_1S08
      write(6,25) '<O(3S1[1])>  = ',ldme_3S11,' <O(3S1[8])>  =',ldme_3S18
      write(6,26) '<O(1P1[1])>  = ',ldme_1P11,' <O(1P1[8])>  =',ldme_1P18
      write(6,26) '<O(3P0[1])>  = ',ldme_3P01,' <O(3P0[8])>  =',ldme_3P08
      write(6,26) '<O(3P1[1])>  = ',ldme_3P11,' <O(3P1[8])>  =',ldme_3P18
      write(6,26) '<O(3P2[1])>  = ',ldme_3P21,' <O(3P2[8])>  =',ldme_3P28
      write(6,*)
