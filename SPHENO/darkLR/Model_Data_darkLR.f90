...
Complex(dp) :: CG1(2, 3, 2) 
 Real(dp) :: gBL,g2,gR,g3,alp,RHO2,RHO1,ALP3,ALP1,LAM1,BETA2,LAM3,xiLR,xiR,MU12
...
Real(dp) :: gBLIN,g2IN,gRIN,g3IN,alpIN,RHO2IN,RHO1IN,ALP3IN,ALP1IN,LAM1IN,BETA2IN,LAM3IN,         & 
& xiLRIN,xiRIN,MU12IN

Complex(dp) :: rh3IN,etallIN,etalrIN,lamlIN,lamlrIN,betlIN,err2IN,etarlIN,etarrIN,lamrIN,            & 
& betrIN,err1IN,YQ2IN(3,3),YDRIN(3,3),YL1IN(3,3),yq3IN(3,3),YDLIN(3,3),YQ1IN(3,3),       & 
& mudl2IN,mudr2IN,mul2IN,mur2IN

Real(dp) :: gBLMZ,g2MZ,gRMZ,g3MZ,alpMZ,RHO2MZ,RHO1MZ,ALP3MZ,ALP1MZ,LAM1MZ,BETA2MZ,LAM3MZ,         & 
& xiLRMZ,xiRMZ,MU12MZ

Complex(dp) :: rh3MZ,etallMZ,etalrMZ,lamlMZ,lamlrMZ,betlMZ,err2MZ,etarlMZ,etarrMZ,lamrMZ,            & 
& betrMZ,err1MZ,YQ2MZ(3,3),YDRMZ(3,3),YL1MZ(3,3),yq3MZ(3,3),YDLMZ(3,3),YQ1MZ(3,3),       & 
& mudl2MZ,mudr2MZ,mul2MZ,mur2MZ

Real(dp) :: gBLGUT,g2GUT,gRGUT,g3GUT,alpGUT,RHO2GUT,RHO1GUT,ALP3GUT,ALP1GUT,LAM1GUT,              & 
& BETA2GUT,LAM3GUT,xiLRGUT,xiRGUT,MU12GUT

Complex(dp) :: rh3GUT,etallGUT,etalrGUT,lamlGUT,lamlrGUT,betlGUT,err2GUT,etarlGUT,etarrGUT,          & 
& lamrGUT,betrGUT,err1GUT,YQ2GUT(3,3),YDRGUT(3,3),YL1GUT(3,3),yq3GUT(3,3),               & 
& YDLGUT(3,3),YQ1GUT(3,3),mudl2GUT,mudr2GUT,mul2GUT,mur2GUT
...
Real(dp) :: v1,v2,vhl,vtl,vhr,vtr

Real(dp) :: v1IN,v2IN,vhlIN,vtlIN,vhrIN,vtrIN

Real(dp) :: v1Fix,v2Fix,vhlFix,vtlFix,vhrFix,vtrFix

Real(dp) :: gPFu(3,342),gTFu(3),BRFu(3,342),gPFe(3,312),gTFe(3),BRFe(3,312),gPFd(6,630),          & 
...
Real(dp) :: ratioFd(6,6),ratioFe(6,3),ratioFu(6,3),ratioHpm(6,6),ratioHppmm(6,2),ratioVWLm(6),    & 
& ratioVWRm(6)

Complex(dp) :: ratioGG(6),ratioPP(6)

Real(dp) :: ratioPFd(6,6),ratioPFe(6,3),ratioPFu(6,3),ratioPHpm(6,6),ratioPHppmm(6,2),            & 
& ratioPVWLm(6),ratioPVWRm(6)

Complex(dp) :: ratioPGG(6),ratioPPP(6)

Real(dp) :: gForTadpoles(161)
...
Logical, save :: InputValueforalp =.False. 
...
Logical, save :: InputValueforetall =.False. 
Logical, save :: InputValueforetalr =.False. 
Logical, save :: InputValueforlaml =.False. 
Logical, save :: InputValueforlamlr =.False. 
Logical, save :: InputValueforbetl =.False. 
Logical, save :: InputValueforerr2 =.False. 
Logical, save :: InputValueforetarl =.False. 
Logical, save :: InputValueforetarr =.False. 
Logical, save :: InputValueforlamr =.False. 
Logical, save :: InputValueforbetr =.False. 
Logical, save :: InputValueforerr1 =.False. 
...
Logical, save :: InputValueforyq3 =.False. 
Logical, save :: InputValueforYDL =.False. 
Logical, save :: InputValueforYQ1 =.False. 
Logical, save :: InputValueforxiLR =.False. 
Logical, save :: InputValueforxiR =.False. 
Logical, save :: InputValueformudl2 =.False. 
Logical, save :: InputValueformudr2 =.False. 
Logical, save :: InputValueforMU12 =.False. 
Logical, save :: InputValueformul2 =.False. 
Logical, save :: InputValueformur2 =.False. 
Logical, save :: InputValueforvhl =.False. 
Logical, save :: InputValueforvtl =.False. 
Logical, save :: InputValueforvhr =.False. 
...
Complex(dp) :: etaLLINPUT
Complex(dp) :: etaLRINPUT
Complex(dp) :: etaRLINPUT
Complex(dp) :: etaRRINPUT
Complex(dp) :: etaRR1INPUT
Complex(dp) :: etaRR2INPUT
Complex(dp) :: lamLINPUT
Complex(dp) :: lamRINPUT
Complex(dp) :: lamLRINPUT
Complex(dp) :: betaLINPUT
Complex(dp) :: betaRINPUT
Complex(dp) :: alpINPUT
Complex(dp) :: xiRINPUT
...
! For HiggsBounds 
Real(dp) :: BR_tHb(6)
Real(dp) :: BR_Hcs(6), BR_Hcb(6), BR_Htaunu(6), BR_tWb
Real(dp) :: BRHHH(6,6), BRHAA(6,6) 
 Real(dp) :: BRAHH(6,6), BRAAA(6,6) 
 Real(dp) :: BRinvH(6), BRinvA(6) 
...
Real(dp) :: rHB_P_P_Fd(6,6),rHB_P_S_Fd(6,6),rHB_S_S_Fd(6,6),rHB_S_P_Fd(6,6)
Real(dp) :: rHB_P_VP(6),rHB_S_VP(6)
Real(dp) :: rHB_P_VZ(6),rHB_S_VZ(6)
Real(dp) :: rHB_P_VG(6),rHB_S_VG(6)
Real(dp) :: rHB_P_VWLm(6),rHB_S_VWLm(6)
Real(dp) :: rHB_P_P_Fv(6,6),rHB_P_S_Fv(6,6),rHB_S_S_Fv(6,6),rHB_S_P_Fv(6,6)
Complex(dp) :: CPL_A_H_Z(6,6) 
 Complex(dp) :: CPL_H_H_Z(6,6) 
 Complex(dp) :: CoupHPP(6), CoupHGG(6) 
Complex(dp) :: CPL_A_A_Z(6,6) 
 Complex(dp) :: CoupAPP(6), CoupAGG(6) 
Real(dp) :: HPPloopVWLm(6)
Real(dp) :: HPPloopVWRm(6)
Real(dp) :: HPPloopHpm(6,6)
Real(dp) :: HPPloopHppmm(2,6)
Real(dp) :: HPPloopFd(6,6)
...
etaLLINPUT=(0._dp,0._dp) 
etaLRINPUT=(0._dp,0._dp) 
etaRLINPUT=(0._dp,0._dp) 
etaRRINPUT=(0._dp,0._dp) 
etaRR1INPUT=(0._dp,0._dp) 
etaRR2INPUT=(0._dp,0._dp) 
lamLINPUT=(0._dp,0._dp) 
lamRINPUT=(0._dp,0._dp) 
lamLRINPUT=(0._dp,0._dp) 
betaLINPUT=(0._dp,0._dp) 
betaRINPUT=(0._dp,0._dp) 
