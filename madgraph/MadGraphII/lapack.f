...
! routines are mainly unmodified by the madgraph authors.
!  modif: modification in order to be gfortran compatible
!  modif: force the base of the computer to be set at 2 (the program fails sometimes to find this number)
!
