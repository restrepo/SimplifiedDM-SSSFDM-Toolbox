...
& Yh,Mu,M12,M112,M222,Mh,vd,vu,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(157), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG157(g1input,g2input,g3input,Lam6input,Lam5input,Lam7input,          & 
& Lam10input,Lam1input,Lam4input,Lam3input,Lam2input,Lam8input,Lam9input,Lamhinput,      & 
& epsUinput,Yuinput,Ydinput,Yeinput,epsDinput,epsEinput,Yhinput,Muinput,M12input,        & 
& M112input,M222input,Mhinput,vdinput,vuinput,g1D)

Call GToParameters157(g1D,g1,g2,g3,Lam6,Lam5,Lam7,Lam10,Lam1,Lam4,Lam3,               & 
