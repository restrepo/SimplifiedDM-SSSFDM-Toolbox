...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	...
	call GetOrderAs(iord)
        call Getlam4(imem,qcdl4)
        call Getlam5(imem,qcdl5)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
*
* $Id: wrapabfkwpi.f,v 1.1.1.1 2006/05/19 09:56:49 madgraph Exp $
*
* $Log: wrapabfkwpi.f,v $
* Revision 1.1.1.1  2006/05/19 09:56:49  madgraph
* Original version
*
...
*
*
      SUBROUTINE ABFKWxx(iset,DX,DQ,DUPV,DDNV,DUSEA,DDSEA,DSTR,DCHM,DGL)
      double precision
...
C
	 ...
	 lastmem = iset
      ...
      IF (ISTART.EQ.0) THEN
        ...
        DO 11 I=1,20
        DO 11 M=1,8
   11   CALCPIO(M,I,K) = CALCPI(M,I,K,iset)
           OWLAM=PARPI(1,iset)
           OWLAM2=OWLAM**2
           Q02PI=PARPI(39,iset)
           Q2MAX=PARPI(40,iset)
