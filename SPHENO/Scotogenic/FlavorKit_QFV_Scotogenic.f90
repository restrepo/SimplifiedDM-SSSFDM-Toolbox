...
Module FlavorKit_QFV_Scotogenic 
Use Control 
...
& Metp,Metp2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,           & 
...
Implicit None 
Real(dp),Intent(in) :: MAh,MAh2,MChi(3),MChi2(3),Metp,Metp2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),            & 
& MFu2(3),MFv(3),MFv2(3),Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2
...
& cpletphhcetp,cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3),cplFvFeVWpR(3,3),        & 
& cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplhhcHpVWp,cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,         & 
& cplhhHpcVWp,cplhhVZVZ,cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ
...
End if 
 ...
 ! Propagator: Ah, Loop particles: Chi,conj[etp], Internal fermion: bar[Fe]
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,3
    Do i3=1,3
If ((MChi2(i1).gt.mf_l2(3)).Or.(Metp2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplChiFeetpL(i1,gt3)
coup1R = cplChiFeetpR(i1,gt3)
coup2L = cplcFeChicetpL(i3,i1)
coup2R = cplcFeChicetpR(i3,i1)
coup3L = cplcFeFeAhL(gt4,i3)
coup3R = cplcFeFeAhR(gt4,i3)
coup4L = cplcFdFdAhL(gt2,gt1)
coup4R = cplcFdFdAhR(gt2,gt1)
...
End if 
 ...
 ! Propagator: Ah, Loop particles: conj[etp],Chi, Internal fermion: Fe
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
  Do i2=1,3
    Do i3=1,3
If ((Metp2.gt.mf_l2(3)).Or.(MChi2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup3L = cplcFeFeAhL(i3,gt3)
coup3R = cplcFeFeAhR(i3,gt3)
coup2L = cplChiFeetpL(i2,i3)
coup2R = cplChiFeetpR(i2,i3)
coup1L = cplcFeChicetpL(gt4,i2)
coup1R = cplcFeChicetpR(gt4,i2)
coup4L = cplcFdFdAhL(gt2,gt1)
coup4R = cplcFdFdAhR(gt2,gt1)
! Masses in loop
mS1 = Metp
...
End if 
 ...
 ! Propagator: hh, Loop particles: Chi,conj[etp], Internal fermion: bar[Fe]
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,3
    Do i3=1,3
...
End if 
 ...
 ! Propagator: hh, Loop particles: conj[etp],Chi, Internal fermion: Fe
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
  Do i2=1,3
    Do i3=1,3
...
End if 
 ...
 ! Propagator: hh, Loop particles: Chi,conj[etp],conj[etp]
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
If ((MChi2(i1).gt.mf_l2(3)).Or.(Metp2.gt.mf_l2(3)).Or.(Metp2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplChiFeetpL(i1,gt3)
coup1R = cplChiFeetpR(i1,gt3)
coup2L = cplcFeChicetpL(gt4,i1)
coup2R = cplcFeChicetpR(gt4,i1)
coup3 = cpletphhcetp
coup4L = cplcFdFdhhL(gt2,gt1)
coup4R = cplcFdFdhhR(gt2,gt1)
! Masses in loop
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Chi,conj[etp], Internal fermion: bar[Fe]
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,3
    Do i3=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: conj[etp],Chi, Internal fermion: Fe
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
  Do i2=1,3
    Do i3=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Chi,conj[etp],conj[etp]
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
If ((MChi2(i1).gt.mf_l2(3)).Or.(Metp2.gt.mf_l2(3)).Or.(Metp2.gt.mf_l2(3))) Then
...
& MetI,MetI2,MetR,MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,           & 
& MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,         & 
...
& cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,BOddvvVRR,BOddvvVLL,BOddvvVRL,BOddvvVLR)
...
Implicit None 
Real(dp),Intent(in) :: MAh,MAh2,MChi(3),MChi2(3),MetI,MetI2,MetR,MetR2,MFd(3),MFd2(3),MFe(3),MFe2(3),        & 
& MFu(3),MFu2(3),MFv(3),MFv2(3),Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2
...
& cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplChiFvetIL(3,3),& 
& cplChiFvetIR(3,3),cplChiFvetRL(3,3),cplChiFvetRR(3,3),cplcHpVWpVZ,cplcVWpVWpVZ,        & 
& cpletIetRVZ,cplFvFeHpL(3,3),cplFvFeHpR(3,3),cplFvFeVWpL(3,3),cplFvFeVWpR(3,3),         & 
& cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Chi,etI, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,3
    Do i3=1,3
...
If (.not.OnlySM) Then 
coup1L = cplChiFvetIL(i1,gt3)
coup1R = cplChiFvetIR(i1,gt3)
coup2L = cplChiFvetIL(i1,i3)
coup2R = cplChiFvetIR(i1,i3)
coup3L = cplFvFvVZL(gt4,i3)
coup3R = cplFvFvVZR(gt4,i3)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Chi,etR, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,3
    Do i3=1,3
If ((MChi2(i1).gt.mf_l2(3)).Or.(MetR2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplChiFvetRL(i1,gt3)
coup1R = cplChiFvetRR(i1,gt3)
coup2L = cplChiFvetRL(i1,i3)
coup2R = cplChiFvetRR(i1,i3)
coup3L = cplFvFvVZL(gt4,i3)
coup3R = cplFvFvVZR(gt4,i3)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
...
End if 
 ...
 ! Propagator: VZ, Loop particles: etI,Chi, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
  Do i2=1,3
    Do i3=1,3
...
coup3L = cplFvFvVZL(gt3,i3)
coup3R = cplFvFvVZR(gt3,i3)
coup2L = cplChiFvetIL(i2,i3)
coup2R = cplChiFvetIR(i2,i3)
coup1L = cplChiFvetIL(i2,gt4)
coup1R = cplChiFvetIR(i2,gt4)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
! Masses in loop
mS1 = MetI
...
End if 
 ...
 ! Propagator: VZ, Loop particles: etR,Chi, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
  Do i2=1,3
    Do i3=1,3
If ((MetR2.gt.mf_l2(3)).Or.(MChi2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup3L = cplFvFvVZL(gt3,i3)
coup3R = cplFvFvVZR(gt3,i3)
coup2L = cplChiFvetRL(i2,i3)
coup2R = cplChiFvetRR(i2,i3)
coup1L = cplChiFvetRL(i2,gt4)
coup1R = cplChiFvetRR(i2,gt4)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
! Masses in loop
mS1 = MetR
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Chi,etR,etI
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
If ((MChi2(i1).gt.mf_l2(3)).Or.(MetR2.gt.mf_l2(3)).Or.(MetI2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplChiFvetRL(i1,gt3)
coup1R = cplChiFvetRR(i1,gt3)
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Chi,etI,etR
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
If ((MChi2(i1).gt.mf_l2(3)).Or.(MetI2.gt.mf_l2(3)).Or.(MetR2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplChiFvetIL(i1,gt3)
coup1R = cplChiFvetIR(i1,gt3)
...
End Function C1C2 
End Module FlavorKit_QFV_Scotogenic 
