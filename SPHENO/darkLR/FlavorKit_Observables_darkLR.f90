...
Module FlavorKit_Observables_darkLR 
Use Control 
...
Implicit None 
Complex(dp) :: OH2lSL(3,3,6),OH2lSR(3,3,6)
...
& O4dTLR(3,3,3,3),O4dTRL(3,3,3,3),O4dTRR(3,3,3,3),OH2qSL(3,3,6),OH2qSR(3,3,6),           & 
& OAh2qSL(3,3,6),OAh2qSR(3,3,6)
...
End Function C1C2 
End Module FlavorKit_Observables_darkLR 
