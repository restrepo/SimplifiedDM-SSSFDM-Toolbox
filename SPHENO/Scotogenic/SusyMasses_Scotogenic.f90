...
Subroutine TreeMasses(MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,Metp2,MetR,MetR2,           & 
...
Real(dp),Intent(out) :: MAh,MAh2,MChi(3),MChi2(3),MetI,MetI2,Metp,Metp2,MetR,MetR2,MFd(3),MFd2(3),            & 
& MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(3),MFv2(3),Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,             & 
& MVZ,MVZ2,TW,ZZ(2,2)

Complex(dp),Intent(out) :: ZDR(3,3),ZER(3,3),ZUR(3,3),ZDL(3,3),ZEL(3,3),ZUL(3,3),UV(3,3),ZW(2,2),ZX(3,3)
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesScotogenic'
...
Subroutine TreeMassesEffPot(MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,Metp2,MetR,           & 
...
& lam5,Yn,Yu,Yd,Ye,Mn,mH2,mEt2,GenerationMixing,kont)
...
Subroutine CalculateMChi(Mn,ZX,MChi,kont)
...
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)-Mn(1,1)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)-Mn(1,2)/2._dp
mat(1,2) = mat(1,2)-Mn(2,1)/2._dp
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)-Mn(1,3)/2._dp
mat(1,3) = mat(1,3)-Mn(3,1)/2._dp
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)-Mn(2,2)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)-Mn(2,3)/2._dp
mat(2,3) = mat(2,3)-Mn(3,2)/2._dp
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)-Mn(3,3)
...
Subroutine CalculateMChiEffPot(Mn,ZX,MChi,kont)
...
Subroutine SortGoldstones(MAh,MAh2,MChi,MChi2,MetI,MetI2,Metp,Metp2,MetR,             & 
& MetR2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,            & 
& MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,UV,ZW,ZX,ZZ,kont)
...
End Module SusyMasses_Scotogenic 
