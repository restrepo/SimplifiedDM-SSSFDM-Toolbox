...
Module CouplingsForDecays_darkLR
...
Real(dp),Intent(in) :: gBLinput,g2input,gRinput,g3input,alpinput,RHO2input,RHO1input,ALP3input,              & 
& ALP1input,LAM1input,BETA2input,LAM3input,xiLRinput,xiRinput,MU12input,v1input,         & 
& v2input,vtlinput,vtrinput,vhlinput,vhrinput

Complex(dp),Intent(in) :: rh3input,etallinput,etalrinput,lamlinput,lamlrinput,betlinput,err2input,              & 
...
Real(dp),Intent(in) :: MAhinput(6),MAh2input(6),MFdinput(6),MFd2input(6),MFeinput(3),MFe2input(3),           & 
& MFuinput(3),MFu2input(3),MFvinput(6),MFv2input(6),Mhhinput(6),Mhh2input(6),            & 
& MHpminput(6),MHpm2input(6),MHppmminput(2),MHppmm2input(2),MVWLminput,MVWLm2input,      & 
& MVWRminput,MVWRm2input,MVZinput,MVZ2input,MVZRinput,MVZR2input,PhiWinput,              & 
& TWinput,UCinput(6,6),UCCinput(2,2),UPinput(6,6),ZHinput(6,6)

Complex(dp),Intent(in) :: UVinput(6,6),ZDRinput(6,6),ZERinput(3,3),ZURinput(3,3),ZDLinput(6,6),ZELinput(3,3),   & 
...
Complex(dp),Intent(out) :: cplcFuFuAhL(3,3,6),cplcFuFuAhR(3,3,6),cplcFuFdcHpmL(3,6,6),cplcFuFdcHpmR(3,6,6),      & 
...
& mudr2,MU12,mul2,mur2,.True.,kont)
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingcFuFdcHpmT(gt1,gt2,gt3,YQ2,yq3,YQ1,UC,ZDL,ZDR,ZUL,ZUR,cplcFuFdcHpmL(gt1,gt2,gt3)& 
...
& cplcFeFeVZRL,cplcFeFeVZRR,cplcFecFeHppmmL,cplcFecFeHppmmR,deltaM)
...
Complex(dp),Intent(out) :: cplcFeFeAhL(3,3,6),cplcFeFeAhR(3,3,6),cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),          & 
...
Complex(dp),Intent(out) :: cplcFdFdAhL(6,6,6),cplcFdFdAhR(6,6,6),cplcFdFdhhL(6,6,6),cplcFdFdhhR(6,6,6),          & 
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingcFdFdAhT(gt1,gt2,gt3,YQ2,yq3,YQ1,UP,ZDL,ZDR,cplcFdFdAhL(gt1,gt2,gt3)     & 
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingcFdFdhhT(gt1,gt2,gt3,YQ2,yq3,YQ1,ZH,ZDL,ZDR,cplcFdFdhhL(gt1,gt2,gt3)     & 
...
Do gt1 = 1, 6
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingcFdFuHpmT(gt1,gt2,gt3,YQ2,yq3,YQ1,UC,ZDL,ZDR,ZUL,ZUR,cplcFdFuHpmL(gt1,gt2,gt3)& 
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
Call CouplingcFdFdVZT(gt1,gt2,gBL,g2,gR,ZZ,ZDL,ZDR,cplcFdFdVZL(gt1,gt2)               & 
& ,cplcFdFdVZR(gt1,gt2))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
Call CouplingcFdFdVZRT(gt1,gt2,gBL,g2,gR,ZZ,ZDL,ZDR,cplcFdFdVZRL(gt1,gt2)             & 
& ,cplcFdFdVZRR(gt1,gt2))
...
Complex(dp) :: ratFd(6),ratFe(3),ratFu(3),ratHpm(6),ratHppmm(2),ratVWLm,ratVWRm

Complex(dp) :: ratPFd(6),ratPFe(3),ratPFu(3),ratPHpm(6),ratPHppmm(2),ratPVWLm,ratPVWRm
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingAhAhhhT(gt1,gt2,gt3,xiLR,xiR,alp,RHO1,rh3,ALP3,ALP1,LAM1,etall,          & 
& etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,betr,BETA2,LAM3,v1,v2,vtl,vtr,             & 
& vhl,vhr,ZH,UP,cplAhAhhh(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhhhhhT(gt1,gt2,gt3,xiLR,xiR,alp,RHO1,rh3,ALP3,ALP1,LAM1,etall,          & 
& etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,betr,BETA2,LAM3,v1,v2,vtl,vtr,             & 
& vhl,vhr,ZH,cplhhhhhh(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhHpmcHpmT(gt1,gt2,gt3,xiLR,xiR,alp,RHO1,rh3,ALP3,ALP1,LAM1,             & 
& etall,etalr,laml,lamlr,betl,err2,etarl,etarr,lamr,betr,err1,BETA2,LAM3,v1,             & 
& v2,vtl,vtr,vhl,vhr,ZH,UC,cplhhHpmcHpm(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 2
  Do gt3 = 1, 2
Call CouplinghhHppmmcHppmmT(gt1,gt2,gt3,RHO2,RHO1,rh3,ALP3,ALP1,etall,etalr,          & 
& etarl,etarr,err1,BETA2,v1,v2,vtl,vtr,vhl,vhr,ZH,UCC,cplhhHppmmcHppmm(gt1,gt2,gt3))
...
Do gt1 = 1, 6
Call CouplinghhcVWLmVWLmT(gt1,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZH,PhiW,cplhhcVWLmVWLm(gt1))
...
Do gt1 = 1, 6
Call CouplinghhcVWRmVWLmT(gt1,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZH,PhiW,cplhhcVWRmVWLm(gt1))
...
Do gt1 = 1, 6
Call CouplinghhcVWRmVWRmT(gt1,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZH,PhiW,cplhhcVWRmVWRm(gt1))
...
cplhhVZVZ = 0._dp 
Do gt1 = 1, 6
Call CouplinghhVZVZT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,ZH,cplhhVZVZ(gt1))
...
cplhhVZVZR = 0._dp 
Do gt1 = 1, 6
Call CouplinghhVZVZRT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,ZH,cplhhVZVZR(gt1))
...
cplhhVZRVZR = 0._dp 
Do gt1 = 1, 6
Call CouplinghhVZRVZRT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,ZH,cplhhVZRVZR(gt1))
...
Complex(dp),Intent(out) :: cplFvFvAhL(6,6,6),cplFvFvAhR(6,6,6),cplFvFvhhL(6,6,6),cplFvFvhhR(6,6,6),              & 
...
Complex(dp),Intent(out) :: cplAhhhVZ(6,6),cplcFdFdVZL(6,6),cplcFdFdVZR(6,6),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),   & 
...
cplHpmcVWLmVZ = 0._dp 
Do gt1 = 1, 6
Call CouplingHpmcVWLmVZT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,UC,PhiW,              & 
& cplHpmcVWLmVZ(gt1))
...
cplHpmcVWRmVZ = 0._dp 
Do gt1 = 1, 6
Call CouplingHpmcVWRmVZT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,UC,PhiW,              & 
& cplHpmcVWRmVZ(gt1))
...
Complex(dp),Intent(out) :: cplAhhhVZR(6,6),cplcFdFdVZRL(6,6),cplcFdFdVZRR(6,6),cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),& 
...
Do gt1 = 1, 6
Call CouplingHpmcVWLmVZRT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,UC,PhiW,             & 
& cplHpmcVWLmVZR(gt1))
...
Do gt1 = 1, 6
Call CouplingHpmcVWRmVZRT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,UC,PhiW,             & 
& cplHpmcVWRmVZR(gt1))
...
& yq3input,YDLinput,YQ1input,xiLRinput,xiRinput,mudl2input,mudr2input,MU12input,         & 
& mul2input,mur2input,v1input,v2input,vtlinput,vtrinput,vhlinput,vhrinput,               & 
& cplAhHppmmcHppmm,cplFeFecHppmmL,cplFeFecHppmmR,cplhhHppmmcHppmm,cplHpmHpmcHppmm,       & 
& cplHpmcHppmmVWLm,cplHpmcHppmmVWRm,cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplcHppmmVWLmVWLm,& 
& cplcHppmmVWLmVWRm,cplcHppmmVWRmVWRm,deltaM)
...
Complex(dp),Intent(out) :: cplAhHppmmcHppmm(6,2,2),cplFeFecHppmmL(3,3,2),cplFeFecHppmmR(3,3,2),cplhhHppmmcHppmm(6,2,2),& 
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 2
Call CouplingHpmHpmcHppmmT(gt1,gt2,gt3,xiR,alp,RHO2,ALP3,err2,err1,BETA2,             & 
& v1,v2,vtl,vtr,vhl,vhr,UC,UCC,cplHpmHpmcHppmm(gt1,gt2,gt3))
...
& yq3input,YDLinput,YQ1input,xiLRinput,xiRinput,mudl2input,mudr2input,MU12input,         & 
& mul2input,mur2input,v1input,v2input,vtlinput,vtrinput,vhlinput,vhrinput,               & 
& cplAhHpmcHpm,cplAhcHpmVWLm,cplAhcHpmVWRm,cplcFuFdcHpmL,cplcFuFdcHpmR,cplhhHpmcHpm,     & 
& cplhhcHpmVWLm,cplhhcHpmVWRm,cplHpmcHpmVZ,cplHpmcHpmVZR,cplHppmmcHpmcHpm,               & 
...
Complex(dp),Intent(out) :: cplAhHpmcHpm(6,6,6),cplAhcHpmVWLm(6,6),cplAhcHpmVWRm(6,6),cplcFuFdcHpmL(3,6,6),       & 
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingAhHpmcHpmT(gt1,gt2,gt3,xiLR,xiR,alp,ALP3,err2,err1,BETA2,LAM3,           & 
& v1,v2,vtl,vtr,vhl,vhr,UP,UC,cplAhHpmcHpm(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingHppmmcHpmcHpmT(gt1,gt2,gt3,xiR,alp,RHO2,ALP3,err2,err1,BETA2,            & 
& v1,v2,vtl,vtr,vhl,vhr,UC,UCC,cplHppmmcHpmcHpm(gt1,gt2,gt3))
...
cplcHpmVWLmVZ = 0._dp 
Do gt1 = 1, 6
Call CouplingcHpmVWLmVZT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,UC,PhiW,              & 
& cplcHpmVWLmVZ(gt1))
...
Do gt1 = 1, 6
Call CouplingcHpmVWLmVZRT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,UC,PhiW,             & 
& cplcHpmVWLmVZR(gt1))
...
cplcHpmVWRmVZ = 0._dp 
Do gt1 = 1, 6
Call CouplingcHpmVWRmVZT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,UC,PhiW,              & 
& cplcHpmVWRmVZ(gt1))
...
Do gt1 = 1, 6
Call CouplingcHpmVWRmVZRT(gt1,gBL,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZZ,UC,PhiW,             & 
& cplcHpmVWRmVZR(gt1))
...
& cplAhHpmcHpm,cplAhHpmcVWLm,cplAhHpmcVWRm,cplAhHppmmcHppmm,cplAhcVWRmVWLm,deltaM)
...
Complex(dp),Intent(out) :: cplPseudoHiggsPP(6),cplPseudoHiggsGG(6),cplAhAhhh(6,6,6),cplcFdFdAhL(6,6,6),          & 
...
& yq3input,YDLinput,YQ1input,xiLRinput,xiRinput,mudl2input,mudr2input,MU12input,         & 
& mul2input,mur2input,v1input,v2input,vtlinput,vtrinput,vhlinput,vhrinput,               & 
& cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplhhHpmcVWLm,              & 
& cplhhcVWLmVWLm,cplhhcVWLmVWRm,cplHpmcVWLmVZ,cplHpmcVWLmVZR,cplHppmmcHpmcVWLm,          & 
& cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,   & 
& cplcVWLmVWRmVZR,deltaM)
...
Complex(dp),Intent(out) :: cplAhHpmcVWLm(6,6),cplAhcVWLmVWRm(6),cplcFuFdcVWLmL(3,6),cplcFuFdcVWLmR(3,6),         & 
...
Do gt1 = 1, 6
Call CouplinghhcVWLmVWRmT(gt1,g2,gR,v1,v2,vtl,vtr,vhl,vhr,ZH,PhiW,cplhhcVWLmVWRm(gt1))
...
& yq3input,YDLinput,YQ1input,xiLRinput,xiRinput,mudl2input,mudr2input,MU12input,         & 
& mul2input,mur2input,v1input,v2input,vtlinput,vtrinput,vhlinput,vhrinput,               & 
& cplAhHpmcVWRm,cplAhcVWRmVWLm,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplhhHpmcVWRm,              & 
& cplhhcVWRmVWLm,cplhhcVWRmVWRm,cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplHppmmcHpmcVWRm,          & 
& cplHppmmcVWLmcVWRm,cplHppmmcVWRmcVWRm,cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,cplcVWRmVWRmVZ,   & 
& cplcVWRmVWRmVZR,deltaM)
...
Complex(dp),Intent(out) :: cplAhHpmcVWRm(6,6),cplAhcVWRmVWLm(6),cplcFuFdcVWRmL(3,6),cplcFuFdcVWRmR(3,6),         & 
...
& cplcFuFuVZRL,cplcFuFuVZRR,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFvAhL,cplFvFvAhR,         & 
...
Complex(dp),Intent(out) :: cplcFdFdAhL(6,6,6),cplcFdFdAhR(6,6,6),cplcFdFdhhL(6,6,6),cplcFdFdhhR(6,6,6),          & 
& cplcFdFdVZL(6,6),cplcFdFdVZR(6,6),cplcFdFdVZRL(6,6),cplcFdFdVZRR(6,6),cplcFecFeHppmmL(3,3,2),& 
& cplcFecFeHppmmR(3,3,2),cplcFeFeAhL(3,3,6),cplcFeFeAhR(3,3,6),cplcFeFehhL(3,3,6),       & 
& cplcFeFehhR(3,3,6),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),& 
...
& cplFeFecHppmmR(3,3,2),cplFvFvAhL(6,6,6),cplFvFvAhR(6,6,6),cplFvFvhhL(6,6,6),           & 
& cplFvFvhhR(6,6,6),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplFvFvVZRL(6,6),cplFvFvVZRR(6,6)
...
& cplcFeFeVZR(3,3),cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),cplcFuFuAhL(3,3,6),               & 
& cplcFuFuAhR(3,3,6),cplcFuFuhhL(3,3,6),cplcFuFuhhR(3,3,6),cplcFuFuVZL(3,3),             & 
& cplcFuFuVZR(3,3),cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3),cplFvFvAhL(6,6,6),cplFvFvAhR(6,6,6),& 
& cplFvFvhhL(6,6,6),cplFvFvhhR(6,6,6),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplFvFvVZRL(6,6),  & 
& cplFvFvVZRR(6,6)
...
End Module CouplingsForDecays_darkLR
