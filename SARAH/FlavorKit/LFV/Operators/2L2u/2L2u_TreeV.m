...
V, (* Vector penguins *) 
 Switch[top,  (* Check topology *) 
  1, 
	 	 ...
	 	 WriteStringFLB[file,"  TVOlluuVRR=TVOlluuVRR+ -157.91367041742973*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVRR= & "<> StringReplace["-16 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVLL=TVOlluuVLL+ -157.91367041742973*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVLL= & "<> StringReplace["-16 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVRL=TVOlluuVRL+ -157.91367041742973*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVRL= & "<> StringReplace["-16 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVLR=TVOlluuVLR+ -157.91367041742973*coup1L*coup2R*IMP2\n" ];
...
,
  2, 
	 	 ...
	 	 WriteStringFLB[file,"  TVOlluuSRR=TVOlluuSRR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuSRR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuSRL=TVOlluuSRL+ -315.82734083485946*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuSRL= & "<> StringReplace["-32 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuSLR=TVOlluuSLR+ -315.82734083485946*coup1R*coup2R*IMP2\n" ];
	 	 ...
	 	 WriteStringFLB[file,"  TVOlluuVRL=TVOlluuVRL+ -157.91367041742973*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuVRL= & "<> StringReplace["-16 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuVLR=TVOlluuVLR+ -157.91367041742973*coup1R*coup2L*IMP2\n" ];
...
,
  3, 
	 	 ...
	 	 WriteStringFLB[file,"  TVOlluuSRR=TVOlluuSRR+ 0.\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuSRR= & "<> StringReplace["0",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuSRL=TVOlluuSRL+ 315.82734083485946*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOlluuSRL= & "<> StringReplace["32 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOlluuSLR=TVOlluuSLR+ 315.82734083485946*coup1L*coup2R*IMP2\n" ];
