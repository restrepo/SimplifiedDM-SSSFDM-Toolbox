...
99	continue      
       ...
       call set_it(n,ivalue,value,name,56,bn,ymass,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,56,bn,ywidth,1d0)
       bn='mguser'
       call set_it(n,ivalue,value,name,1,bn,l_add ,4000d0)
       call set_it(n,ivalue,value,name,2,bn,NADD,4d0)
       call set_it(n,ivalue,value,name,3,bn,MGLOW,0.01d0)
       call set_it(n,ivalue,value,name,4,bn,MGUP,4000d0)
      return
      end
