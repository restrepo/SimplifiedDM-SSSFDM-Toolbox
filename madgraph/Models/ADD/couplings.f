...
c************************************
      ...
      GTV=dcmplx(-1.0d0/L_ADD,Zero)
      GTF=dcmplx(-1.0d0/4.0d0/L_ADD,Zero)
      GTS=dcmplx(-1.0d0/L_ADD,Zero)
      GTFV=dcmplx(-1.0d0/2.0d0/L_ADD,Zero)
      GTFV=dcmplx(-1.0d0/2.0d0/L_ADD,Zero)
       MMSS=L_ADD
      GTX(1)=dcmplx(NADD,L_ADD)
      GTX(2)=dcmplx(MGLOW,MGUP)
c----------------------------
