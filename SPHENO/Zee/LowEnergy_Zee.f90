...
& cplcFeFeAhL,cplcFeFeAhR,cplFvFeHmL,cplFvFeHmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,     & 
& cplcFeFeVPR,cplcFeFvcHmL,cplcFeFvcHmR,cplHmcHmVP,a_mu)

Real(dp),Intent(in)  :: MAh(2),MAh2(2),MFe(3),MFe2(3),MFv(3),MFv2(3),Mhh(2),Mhh2(2),MHm(3),MHm2(3)

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,2),cplcFeFeAhR(3,3,2),cplFvFeHmL(3,3,3),cplFvFeHmR(3,3,3),            & 
& cplcFeFehhL(3,3,2),cplcFeFehhR(3,3,2),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),               & 
& cplcFeFvcHmL(3,3,3),cplcFeFvcHmR(3,3,3),cplHmcHmVP(3,3)
...
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFeHmL,cplFvFeHmR,cplFvFecVWmL,        & 
& cplFvFecVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFeFvcHmL,cplcFeFvcHmR,cplHmcHmVP,            & 
& cplcVWmVPVWm,EDM)
...
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvVWmL(3,3), & 
& cplcFeFvVWmR(3,3),cplcFeFvcHmL(3,3,3),cplcFeFvcHmR(3,3,3),cplHmcHmVP(3,3),             & 
& cplcVWmVPVWm
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhcHmcVWm,cplAhhhVZ,        & 
...
Complex(dp),Intent(in)  :: cplAhAhcVWmVWm(2,2),cplAhAhVZVZ(2,2),cplAhcHmcVWm(2,3),cplAhhhVZ(2,2),cplcFdFdVZL(3,3),& 
...
& cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgZgWmcVWm,cplcHmcVWmVP(3),cplcHmcVWmVZ(3),           & 
...
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFvFecVWmL(3,3),cplFvFecVWmR(3,3),cplFvFvVZL(3,3),   & 
& cplFvFvVZR(3,3),cplhhcHmcVWm(2,3),cplhhcVWmVWm(2),cplhhhhcVWmVWm(2,2),cplhhhhVZVZ(2,2),& 
& cplhhVZVZ(2),cplHmcHmcVWmVWm(3,3),cplHmcHmVZ(3,3),cplHmcHmVZVZ(3,3),cplHmVWmVZ(3)
