...
C
      ...
      include 'TF_param.inc'     
        ...
        prov1=(p_jet_e_1+p_jet_e_2*dsqrt(pexp(0))+p_jet_e_3*pexp(0))
        prov2=(p_jet_e_4+p_jet_e_5*dsqrt(pexp(0))+p_jet_e_6*pexp(0))
        prov3=(p_jet_e_7+p_jet_e_8*dsqrt(pexp(0))+p_jet_e_9*pexp(0))
        prov4=(p_jet_e_10+p_jet_e_11*dsqrt(pexp(0))+p_jet_e_12*pexp(0))
        prov5=(p_jet_e_13+p_jet_e_14*dsqrt(pexp(0))+p_jet_e_15*pexp(0))
        tf_e_j=(exp(-(p(0)-pexp(0)-prov1)**2/2d0/prov2**2))                !first gaussian
        tf_e_j=tf_e_j+prov3*exp(-(p(0)-pexp(0)-prov4)**2/2d0/prov5**2) 
     &    !second gaussian
...
C
      ...
      include 'TF_param.inc'     
        ...
        prov1=(p_bjet_e_1+p_bjet_e_2*dsqrt(pexp(0))+p_bjet_e_3*pexp(0))
        prov2=(p_bjet_e_4+p_bjet_e_5*dsqrt(pexp(0))+p_bjet_e_6*pexp(0))
        prov3=(p_bjet_e_7+p_bjet_e_8*dsqrt(pexp(0))+p_bjet_e_9*pexp(0))
        prov4=(p_bjet_e_10+p_bjet_e_11*dsqrt(pexp(0))+p_bjet_e_12*pexp(0))
        prov5=(p_bjet_e_13+p_bjet_e_14*dsqrt(pexp(0))+p_bjet_e_15*pexp(0))
        tf_e_b=((1d0/dsqrt(2d0*pi))/(prov2+prov3*prov5)*(exp(-
     &(p(0)-pexp(0)-prov1)**2/2d0/prov2**2)+prov3*exp(-
     &(p(0)-pexp(0)-prov4)**2/2d0/prov5**2)))
...
C
      ...
      include 'TF_param.inc'     
        ...
        prov1=(p_gjet_e_1+p_gjet_e_2*dsqrt(pexp(0))+p_gjet_e_3*pexp(0))
        prov2=(p_gjet_e_4+p_gjet_e_5*dsqrt(pexp(0))+p_gjet_e_6*pexp(0))
        prov3=(p_gjet_e_7+p_gjet_e_8*dsqrt(pexp(0))+p_gjet_e_9*pexp(0))
        prov4=(p_gjet_e_10+p_gjet_e_11*dsqrt(pexp(0))+p_gjet_e_12*pexp(0))
        prov5=(p_gjet_e_13+p_gjet_e_14*dsqrt(pexp(0))+p_gjet_e_15*pexp(0))
        tf_e_g=((1d0/dsqrt(2d0*pi))/(prov2+prov3*prov5)*(exp(-
     &(p(0)-pexp(0)-prov1)**2/2d0/prov2**2)+prov3*exp(-
     &(p(0)-pexp(0)-prov4)**2/2d0/prov5**2)))
...
C
      ...
      include 'TF_param.inc'     
        ...
        sigma_e_b=(p_bjet_e_13+p_bjet_e_14*dsqrt(pexp(0))+p_bjet_e_15*pexp(0))
...
C
      ...
      include 'TF_param.inc'     
        ...
        sigma_e_g=(p_gjet_e_13+p_gjet_e_14*dsqrt(pexp(0))+p_gjet_e_15*pexp(0))
...
C-------------------------------------------------------
      include '../../nexternal.inc'
      integer num_inv,num_jet,num_bjet,num_e,num_ae,
     &num_mu,mum_amu,num_ta,num_ata   !number of jet,elec,muon, undetectable
      COMMON/num_part/num_inv,num_jet,num_bjet,num_e,
     &num_ae,num_mu,mum_amu,num_ta,num_ata !particle in the final state
