...
Implicit None 
Real(dp), Intent(in) :: mh(6)  
Complex(dp), Intent(in) :: ratPP(6), ratGG(6)  
Real(dp), Intent(in) :: ratZZ(6), ratWW(6), ratTT(6)  
Real(dp), Intent(Out) :: CS(2,6,5)  
