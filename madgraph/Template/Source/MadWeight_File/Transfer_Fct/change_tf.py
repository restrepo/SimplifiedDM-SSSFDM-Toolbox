...
class TF_in_SubProcesses:
    ...
    def text_transfer_fct(self):
        ...
        if self.TF_data.label_to_block.has_key('met'):
            ...
            text+=" double precision eta_init(nexternal-1),phi_init(nexternal-1),pt_init(nexternal-1),j_mass(nexternal-1),ntrk(nexternal-1),btag(nexternal-1),had_em(nexternal-1),dummy1(nexternal-1),dummy2(nexternal-1)\n"
