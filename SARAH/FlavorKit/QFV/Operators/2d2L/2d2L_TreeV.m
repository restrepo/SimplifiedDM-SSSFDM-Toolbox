...
V, (* Vector penguins *) 
 Switch[top,  (* Check topology *) 
  1, 
	 	 ...
	 	 WriteStringFLB[file,"  TVOddllVRR=TVOddllVRR+ -157.91367041742973*coup1R*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOddllVRR= & "<> StringReplace["-16 coup1R coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOddllVLL=TVOddllVLL+ -157.91367041742973*coup1L*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOddllVLL= & "<> StringReplace["-16 coup1L coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOddllVRL=TVOddllVRL+ -157.91367041742973*coup1R*coup2L*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOddllVRL= & "<> StringReplace["-16 coup1R coup2L IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOddllVLR=TVOddllVLR+ -157.91367041742973*coup1L*coup2R*IMP2\n" ];
...
,
  2, 
	 	 ...
	 	 WriteStringFLB[file,"  TVOddllVRL=TVOddllVRL+ -157.91367041742973*coup1L*coup2R*IMP2\n" ];
	 	 WriteString[sphenoTeX,"  TVOddllVRL= & "<> StringReplace["-16 coup1L coup2R IMP2 Pi^2",SA`SPhenoTeXSub]<>" \\\\ \n" ];
	 	 WriteStringFLB[file,"  TVOddllVLR=TVOddllVLR+ -157.91367041742973*coup1R*coup2L*IMP2\n" ];
